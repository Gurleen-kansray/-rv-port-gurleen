...
# 112 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
 ...
 for (i = 0 ; i < 90 ; i++)
 {
    ...
    if (!umfdi_valid_symbolic (Symbolic))
    {
 Info [0] = (-4) ;
 return ((-4)) ;
    }
...
)
{
 ...
 return ((0)) ;
    ...
    *NumericHandle = Numeric ;
    ...
    Numeric->D = (double *) umf_i_malloc (n_inner+1, sizeof (double)) ;
...
)
{
    ...
    Work->Wx = (double *) umf_i_malloc (maxnrows + 1, sizeof (double)) ;
    Work->Wy = (double *) umf_i_malloc (maxnrows + 1, sizeof (double)) ;
 ...
 Work->Diagonal_imap = (int *) 0 ;
    ...
    Work->Flublock = (double *) 0 ;
    Work->Flblock = (double *) 0 ;
    Work->Fublock = (double *) 0 ;
    Work->Fcblock = (double *) 0 ;
...
)
{
 ...
 Work->Wx = (double *) umf_i_free ((void *) Work->Wx) ;
 Work->Wy = (double *) umf_i_free ((void *) Work->Wy) ;
