...
# 97 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
 ...
 status = (0) ;
    ...
    Z2 = (double *) 0 ;
    B2 = (double *) 0 ;
# 165 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
    X = (double *) Xx ;
    if (irstep > 0)
    {
 if (!Ap || !Ai || !Ax)
 ...
 Z = (double *) (SolveWork + n) ;
 S = (double *) (SolveWork + 2*n) ;
...
# 267 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
  ...
  for (i = 0 ; i < n ; i++)
  {
     ...
     flops += umfdl_lsolve (Numeric, W, Pattern) ;
     flops += umfdl_usolve (Numeric, W, Pattern) ;
...
# 565 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
  ...
  for (i = 0 ; i < n ; i++)
  {
     ...
     flops += umfdl_uhsolve (Numeric, W, Pattern) ;
     flops += umfdl_lhsolve (Numeric, W, Pattern) ;
...
# 838 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
  ...
  for (i = 0 ; i < n ; i++)
  {
     ...
     flops += umfdl_utsolve (Numeric, W, Pattern) ;
     flops += umfdl_ltsolve (Numeric, W, Pattern) ;
 ...
 flops = umfdl_lsolve (Numeric, X, Pattern) ;
 status = (0) ;
 ...
 flops = umfdl_lhsolve (Numeric, X, Pattern) ;
 status = (0) ;
 ...
 flops = umfdl_ltsolve (Numeric, X, Pattern) ;
 status = (0) ;
 ...
 flops = umfdl_usolve (Numeric, X, Pattern) ;
 ...
 flops = umfdl_uhsolve (Numeric, X, Pattern) ;
 ...
 flops = umfdl_utsolve (Numeric, X, Pattern) ;
...
# 1221 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
    Info [84] = flops ;
    return (status) ;
}
