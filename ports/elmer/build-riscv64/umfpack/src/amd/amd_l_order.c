# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_order.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_order.c"
# 16 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_order.c"
...
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_order.c" 2
...
{
    long slen, *Len, *S, nz, nzaat, i, *Pinv, info ;
 ...
 Info [0] = 0 ;
    ...
    if (Ai == (long *) 0 || Ap == (long *) 0 || P == (long *) 0 || n < 0)
    {
 if (info) Info [0] = -2 ;
 return (-2) ;
    }
 ...
 return (-2) ;
    ...
    if ((2.4 * (double) nz + 8 * (double) n) > (double) 0x7fffffffffffffffL 
# 72 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_order.c"
                                                               / sizeof (long))
    {
 ...
 return (-1) ;
    ...
    nzaat = amd_l_aat (n, Ap, Ai, Len, P, Info) ;
    ;
    ;
 ...
 Info [7] = ((double) slen + n) * sizeof (long) ;
    }
    S = (long *) malloc (slen * sizeof (long)) ;
 ...
 return (-1) ;
    ...
    amd_l1 (n, Ap, Ai, P, Pinv, Len, slen, S, Control, Info) ;
