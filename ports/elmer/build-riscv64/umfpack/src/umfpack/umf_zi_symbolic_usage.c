# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_symbolic_usage.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_symbolic_usage.c"
# 13 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_symbolic_usage.c"
...
# 14 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_symbolic_usage.c" 2
...
)
{
 ...
 + 3 * (ceil ((sizeof (int) * ((double) nchains+1)) / sizeof (Unit)))
 + 4 * (ceil ((sizeof (int) * ((double) nfr+1)) / sizeof (Unit))) ;


    units += (ceil ((sizeof (int) * ((double) esize)) / sizeof (Unit))) ;


    if (prefer_diagonal)
    {
 units += (ceil ((sizeof (int) * ((double) n_col+1)) / sizeof (Unit))) ;
    }
