# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_preprocess.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_preprocess.c"
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_preprocess.c"
...
# 18 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_preprocess.c" 2
...
)
{
    ...
    if (!amd_l_preprocess_valid (n, Ap, Ai) || !Ri || !Rp)
    {
 return (-2) ;
    }
    ...
    W = (long *) malloc ((((n) > (1)) ? (n) : (1)) * sizeof (long)) ;
    if (!W)
    {
 return (-1) ;
    }
    Flag = (long *) malloc ((((n) > (1)) ? (n) : (1)) * sizeof (long)) ;
    if (!Flag)
    {
 free (W) ;
 return (-1) ;
    ...
    amd_l_wpreprocess (n, Ap, Ai, Rp, Ri, W, Flag) ;
...
# 87 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_preprocess.c"
 void amd_l_wpreprocess
(
    long n,
    const long Ap [ ],
...
# 174 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_preprocess.c"
}
# 184 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_preprocess.c"
 long amd_l_preprocess_valid
(
    long n,
    const long Ap [ ],
