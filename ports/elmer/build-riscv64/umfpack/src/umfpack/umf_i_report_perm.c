# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_report_perm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_report_perm.c"
# 11 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_report_perm.c"
...
# 12 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_report_perm.c" 2
...
)
{
    ...
    { if (user || prl >= 4) { (void) printf ("permutation vector, n = ""%d"". ", n) ; } ; } ;

    if (n <= 0)
    {
 { (void) printf ("ERROR: length of permutation is <= 0\n\n") ; } ;
 return ((-6)) ;
    }
 ...
 if (prl == 4 && k == 9 && n > 10)
 {
    ...
    { if (prl >= (4)) { { (void) printf ("    permutation vector ") ; } ; } } ;
    { if (user || prl >= 4) { (void) printf ("OK\n\n") ; } ; } ;
    return ((0)) ;
}
