 ...
 *Front_leftmostdesc, *Front_parent, done, status1, status2 ;
 ...
 { (void) printf ("\tn_row: ""%d"" n_col: ""%d""\n", n_row, n_col) ; } ;
 { (void) printf ("\tnumber of entries: ""%d""\n", nz) ; } ;
 { (void) printf ("    block size used for dense matrix kernels:   ""%d""\n", Symbolic->nb) ; }
                ;
 ...
 { (void) printf ("\tnumber of frontal chains: ""%d""\n", nchains) ; } ;
 { (void) printf ("\tnumber of frontal matrices: ""%d""\n", nfr) ; } ;
 { (void) printf ("\tlargest frontal matrix row dimension: ""%d""\n", maxnrows) ; } ;
 { (void) printf ("\tlargest frontal matrix column dimension: ""%d""\n",maxncols) ; };
    }
 ...
 { if (prl >= (4)) { { (void) printf ("\n    Frontal chain: ""%d"".  Frontal matrices ""%d"" to ""%d""\n", (chain), (frontid1), (frontid2)) ; } ; } }
                                                         ;
 { if (prl >= (4)) { { (void) printf ("\tLargest frontal matrix in Frontal chain: ""%d""-by-""%d""\n", Chain_maxrows [chain], Chain_maxcols [chain]) ; } ; } }
                                                    ;
 for (frontid = frontid1 ; frontid <= frontid2 ; frontid++)
 {
     kk = Front_npivcol [frontid] ;
     { if (prl >= (4)) { { (void) printf ("\tFront: ""%d""  pivot cols: ""%d"" (pivot columns ""%d"" to " "%d"")\n", (frontid), kk, (k), (k+kk-1)) ; } ; } }
                                                            ;
     { if (prl >= (4)) { { (void) printf ("\t    pivot row candidates: ""%d"" to ""%d""\n", (Front_1strow [Front_leftmostdesc [frontid]]), (Front_1strow [frontid+1]-1)) ; } ; } }

                                       ;
     { if (prl >= (4)) { { (void) printf ("\t    leftmost descendant: ""%d""\n", (Front_leftmostdesc [frontid])) ; } ; } }
                                         ;
     { if (prl >= (4)) { { (void) printf ("\t    1st new candidate row : ""%d""\n", (Front_1strow [frontid])) ; } ; } }
                                   ;
 ...
 {
     { if (prl >= (4)) { { (void) printf ("\tFront: ""%d"" placeholder for ""%d"" empty columns\n", (nfr), Front_npivcol [nfr]) ; } ; } }
                                     ;
 }
 if (done)
 {
    ...
    W = (int *) umf_i_malloc ((((n_row) > (n_col)) ? (n_row) : (n_col)), sizeof (int)) ;
    if (!W)
    {
 ...
 return ((-1)) ;
    ...
    status1 = umf_i_report_perm (n_col, Symbolic->Cperm_init, W, prl, 0) ;

    { if (prl >= (4)) { { (void) printf ("\nInitial row permutation, P1: ") ; } ; } } ;
    status2 = umf_i_report_perm (n_row, Symbolic->Rperm_init, W, prl, 0) ;
