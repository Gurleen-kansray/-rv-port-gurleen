# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_info.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_info.c"
# 16 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_info.c"
...
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_info.c" 2
# 33 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_info.c"
...
)
{
 ...
 return ;
    ...
    { (void) printf ("    %-27s", what) ; } ;
    if (estimate >= 0)
    {
 { (void) printf (format, estimate) ; } ;
    }
    else
    {
 { (void) printf ("                    -") ; } ;
...
)
{
 ...
 fsolve, ttot, ftot, twsym, twnum, twsolve, twtot, n2 ;
    long n_row, n_col, n_inner, prl, is_sym ;





    prl = ((Control != (double *) 0) ? (((Control [0]) != (Control [0])) ? 1 : Control [0]) : 1) ;
 ...
 return ;
    ...
    { (void) printf ("\n%s, Info:\n", "UMFPACK V4.4 (Jan. 28, 2005)") ; } ;
# 121 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_info.c"
    { (void) printf ("    matrix entry defined as:          double\n") ; } ;
    { (void) printf ("    Int (generic integer) defined as: long\n") ; } ;
# 137 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_info.c"
    { (void) printf ("    BLAS library used:                ") ; } ;


    { (void) printf ("none.  UMFPACK will be slow.\n") ; } ;
# 153 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_info.c"
    { (void) printf ("    MATLAB:                           ") ; } ;
    ...
    { (void) printf ("    CPU timer:                        ") ; } ;




    { (void) printf ("POSIX times ( ) routine.\n") ; } ;
# 183 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_info.c"
    n_row = (long) Info [1] ;
    n_col = (long) Info [16] ;
    n_inner = (((n_row) < (n_col)) ? (n_row) : (n_col)) ;

    { if (((n_row) != (n_row)) || (!((n_row) < 0.))) { { (void) printf ("    number of rows in matrix A:       ""%ld""\n", n_row) ; } ; } } ;
    { if (((n_col) != (n_col)) || (!((n_col) < 0.))) { { (void) printf ("    number of columns in matrix A:    ""%ld""\n", n_col) ; } ; } } ;
    { if ((((long) Info [2]) != ((long) Info [2])) || (!(((long) Info [2]) < 0.))) { { (void) printf ("    entries in matrix A:              ""%ld""\n", (long) Info [2]) ; } ; } }
                          ;
    { if ((((long) Info [3]) != ((long) Info [3])) || (!(((long) Info [3]) < 0.))) { { (void) printf ("    memory usage reported in:         ""%ld""-byte Units\n", (long) Info [3]) ; } ; } }
                                    ;

    { if ((((long) Info [4]) != ((long) Info [4])) || (!(((long) Info [4]) < 0.))) { { (void) printf ("    size of int:                      ""%ld"" bytes\n", (long) Info [4]) ; } ; } }
                                   ;
    { if ((((long) Info [5]) != ((long) Info [5])) || (!(((long) Info [5]) < 0.))) { { (void) printf ("    size of long:                     ""%ld"" bytes\n", (long) Info [5]) ; } ; } }
                                    ;
    { if ((((long) Info [6]) != ((long) Info [6])) || (!(((long) Info [6]) < 0.))) { { (void) printf ("    size of pointer:                  ""%ld"" bytes\n", (long) Info [6]) ; } ; } }
                                       ;
    { if ((((long) Info [7]) != ((long) Info [7])) || (!(((long) Info [7]) < 0.))) { { (void) printf ("    size of numerical entry:          ""%ld"" bytes\n", (long) Info [7]) ; } ; } }
                                     ;
 ...
 { (void) printf ("\n    strategy used:                    symmetric 2-by-2\n") ; };
    ...
    if (Info [19] == 1)
    {
 { (void) printf ("    ordering used:                    amd on A+A'\n") ; } ;
    }
    else if (Info [19] == 0)
    {
 { (void) printf ("    ordering used:                    colamd on A\n") ; } ;
    }
    else if (Info [19] == 2)
    {
 { (void) printf ("    ordering used:                    provided by user\n") ; } ;
    }

    if (Info [31] == 1)
    {
 { (void) printf ("    modify Q during factorization:    no\n") ; } ;
    }
    else if (Info [31] == 0)
    {
 { (void) printf ("    modify Q during factorization:    yes\n") ; } ;
    }

    if (Info [32] == 0)
    {
 { (void) printf ("    prefer diagonal pivoting:         no\n") ; } ;
    }
    else if (Info [32] == 1)
    {
 { (void) printf ("    prefer diagonal pivoting:         yes\n") ; } ;
    }
    ...
    { if (((Info [56] + Info [57]) != (Info [56] + Info [57])) || (!((Info [56] + Info [57]) < 0.))) { { (void) printf ("    pivots with zero Markowitz cost:               %0.f\n", Info [56] + Info [57]) ; } ; } }
                                                                ;
    { if (((Info [8]) != (Info [8])) || (!((Info [8]) < 0.))) { { (void) printf ("    submatrix S after removing zero-cost pivots:\n" "        number of \"dense\" rows:                    %.0f\n", Info [8]) ; } ; } }

                            ;
    { if (((Info [10]) != (Info [10])) || (!((Info [10]) < 0.))) { { (void) printf ("        number of \"dense\" columns:                 %.0f\n", Info [10]) ; } ; } }
                            ;
    { if (((Info [9]) != (Info [9])) || (!((Info [9]) < 0.))) { { (void) printf ("        number of empty rows:                      %.0f\n", Info [9]) ; } ; } }
                            ;
    { if (((Info [11]) != (Info [11])) || (!((Info [11]) < 0.))) { { (void) printf ("        number of empty columns                    %.0f\n", Info [11]) ; } ; } }
                            ;
    is_sym = Info [59] ;
    if (is_sym > 0)
    {
 { (void) printf ("        submatrix S square and diagonal preserved\n") ; } ;
    }
    else if (is_sym == 0)
    {
 { (void) printf ("        submatrix S not square or diagonal not preserved\n") ; };
    }
    ...
    if (n2 >= 0)
    {
 { (void) printf ("    pattern of square submatrix S:\n") ; } ;
    }
    { if (((n2) != (n2)) || (!((n2) < 0.))) { { (void) printf ("        number rows and columns                    %.0f\n", n2) ; } ; } }
     ;
    { if (((Info [33]) != (Info [33])) || (!((Info [33]) < 0.))) { { (void) printf ("        symmetry of nonzero pattern:               %.6f\n", Info [33]) ; } ; } }
                                  ;
    { if (((Info [34]) != (Info [34])) || (!((Info [34]) < 0.))) { { (void) printf ("        nz in S+S' (excl. diagonal):               %.0f\n", Info [34]) ; } ; } }
                              ;
    { if (((Info [35]) != (Info [35])) || (!((Info [35]) < 0.))) { { (void) printf ("        nz on diagonal of matrix S:                %.0f\n", Info [35]) ; } ; } }
                        ;
    if (Info [35] >= 0 && n2 > 0)
    {
 { (void) printf ("        fraction of nz on diagonal:                %.6f\n", Info [35] / n2) ; }
                              ;
    }
    ...
    { if (((Info [51]) != (Info [51])) || (!((Info [51]) < 0.))) { { (void) printf ("    2-by-2 pivoting to place large entries on diagonal:\n" "        # of small diagonal entries of S:          %.0f\n", Info [51]) ; } ; } }

                            ;
    { if (((Info [52]) != (Info [52])) || (!((Info [52]) < 0.))) { { (void) printf ("        # unmatched:                               %.0f\n", Info [52]) ; } ; } }
                                ;
    { if (((Info [53]) != (Info [53])) || (!((Info [53]) < 0.))) { { (void) printf ("        symmetry of P2*S:                          %.6f\n", Info [53]) ; } ; } }
                                       ;
    { if (((Info [54]) != (Info [54])) || (!((Info [54]) < 0.))) { { (void) printf ("        nz in P2*S+(P2*S)' (excl. diag.):          %.0f\n", Info [54]) ; } ; } }
                                     ;
    { if (((Info [55]) != (Info [55])) || (!((Info [55]) < 0.))) { { (void) printf ("        nz on diagonal of P2*S:                    %.0f\n", Info [55]) ; } ; } }
                             ;
    if (Info [55] >= 0 && n2 > 0)
    {
 { (void) printf ("        fraction of nz on diag of P2*S:            %.6f\n", Info [55] / n2) ; }
                                   ;
    }
    ...
    {
 double dmax = Info [39] ;
 { (void) printf ("    AMD statistics, for strict diagonal pivoting:\n") ; } ;
 { if (((Info [37]) != (Info [37])) || (!((Info [37]) < 0.))) { { (void) printf ("        est. flops for LU factorization:           %.5e\n", Info [37]) ; } ; } }
                                     ;
 { if (((Info [36]) != (Info [36])) || (!((Info [36]) < 0.))) { { (void) printf ("        est. nz in L+U (incl. diagonal):           %.0f\n", Info [36]) ; } ; } }
                                    ;
 { if (((dmax*dmax) != (dmax*dmax)) || (!((dmax*dmax) < 0.))) { { (void) printf ("        est. largest front (# entries):            %.0f\n", dmax*dmax) ; } ; } }
                ;
 { if (((dmax) != (dmax)) || (!((dmax) < 0.))) { { (void) printf ("        est. max nz in any column of L:            %.0f\n", dmax) ; } ; } }
           ;
 { if (((Info [38]) != (Info [38])) || (!((Info [38]) < 0.))) { { (void) printf ("        number of \"dense\" rows/columns in S+S':    %.0f\n", Info [38]) ; } ; } }
    ...
    { if (((Info [12]) != (Info [12])) || (!((Info [12]) < 0.))) { { (void) printf ("    symbolic factorization defragmentations:       %.0f\n", Info [12]) ; } ; } }
                                 ;
    { if (((Info [13]) != (Info [13])) || (!((Info [13]) < 0.))) { { (void) printf ("    symbolic memory usage (Units):                 %.0f\n", Info [13]) ; } ; } }
                                      ;
    { if ((((((Info [13]) * sizeof (Unit)) / 1048576.0)) != ((((Info [13]) * sizeof (Unit)) / 1048576.0))) || (!(((((Info [13]) * sizeof (Unit)) / 1048576.0)) < 0.))) { { (void) printf ("    symbolic memory usage (MBytes):                %.1f\n", (((Info [13]) * sizeof (Unit)) / 1048576.0)) ; } ; } }
                                               ;
    { if (((Info [14]) != (Info [14])) || (!((Info [14]) < 0.))) { { (void) printf ("    Symbolic size (Units):                         %.0f\n", Info [14]) ; } ; } }
                               ;
    { if ((((((Info [14]) * sizeof (Unit)) / 1048576.0)) != ((((Info [14]) * sizeof (Unit)) / 1048576.0))) || (!(((((Info [14]) * sizeof (Unit)) / 1048576.0)) < 0.))) { { (void) printf ("    Symbolic size (MBytes):                        %.0f\n", (((Info [14]) * sizeof (Unit)) / 1048576.0)) ; } ; } }
                                        ;
    { if (((tsym) != (tsym)) || (!((tsym) < 0.))) { { (void) printf ("    symbolic factorization CPU time (sec):         %.2f\n", tsym) ; } ; } }
       ;
    { if (((twsym) != (twsym)) || (!((twsym) < 0.))) { { (void) printf ("    symbolic factorization wallclock time(sec):    %.2f\n", twsym) ; } ; } }
        ;
 ...
 { (void) printf ("\n    matrix scaled: no\n") ; } ;
    ...
    {
 { (void) printf ("\n    matrix scaled: yes ") ; } ;
 { (void) printf ("(divided each row by sum of abs values in each row)\n") ; } ;
 { (void) printf ("    minimum sum (abs (rows of A)):              %.5e\n", Info [69]) ; }
                            ;
 { (void) printf ("    maximum sum (abs (rows of A)):              %.5e\n", Info [70]) ; }
                            ;
    }
    else if (Info [68] == 2)
    {
 { (void) printf ("\n    matrix scaled: yes ") ; } ;
 { (void) printf ("(divided each row by max abs value in each row)\n") ; } ;
 { (void) printf ("    minimum max (abs (rows of A)):              %.5e\n", Info [69]) ; }
                            ;
 { (void) printf ("    maximum max (abs (rows of A)):              %.5e\n", Info [70]) ; }
                            ;
    }
 ...
 { (void) printf ("               actual      %%\n") ; } ;
 { (void) printf ("    variable-sized part of Numeric object:\n") ; } ;
    }
 ...
 Info [50]) ;
    ...
    { if (((Info [73]) != (Info [73])) || (!((Info [73]) < 0.))) { { (void) printf ("\n    initial allocation ratio used:                 %0.3g\n", Info [73]) ; } ; } }
                                 ;
    { if (((Info [74]) != (Info [74])) || (!((Info [74]) < 0.))) { { (void) printf ("    # of forced updates due to frontal growth:     %.0f\n", Info [74]) ; } ; } }
                                ;
    { if (((Info [76]) != (Info [76])) || (!((Info [76]) < 0.))) { { (void) printf ("    number of off-diagonal pivots:                 %.0f\n", Info [76]) ; } ; } }
                           ;
    { if (((Info [77]) != (Info [77])) || (!((Info [77]) < 0.))) { { (void) printf ("    nz in L (incl diagonal), if none dropped       %.0f\n", Info [77]) ; } ; } }
                         ;
    { if (((Info [78]) != (Info [78])) || (!((Info [78]) < 0.))) { { (void) printf ("    nz in U (incl diagonal), if none dropped       %.0f\n", Info [78]) ; } ; } }
                         ;
    { if (((Info [79]) != (Info [79])) || (!((Info [79]) < 0.))) { { (void) printf ("    number of small entries dropped                %.0f\n", Info [79]) ; } ; } }
                           ;
    { if (((Info [66]) != (Info [66])) || (!((Info [66]) < 0.))) { { (void) printf ("    nonzeros on diagonal of U:                     %.0f\n", Info [66]) ; } ; } }
                          ;
    { if (((Info [71]) != (Info [71])) || (!((Info [71]) < 0.))) { { (void) printf ("    min abs. value on diagonal of U:               %.2e\n", Info [71]) ; } ; } }
                      ;
    { if (((Info [72]) != (Info [72])) || (!((Info [72]) < 0.))) { { (void) printf ("    max abs. value on diagonal of U:               %.2e\n", Info [72]) ; } ; } }
                      ;
    { if (((Info [67]) != (Info [67])) || (!((Info [67]) < 0.))) { { (void) printf ("    estimate of reciprocal of condition number:    %.2e\n", Info [67]) ; } ; } }
                       ;
    { if (((Info [63]) != (Info [63])) || (!((Info [63]) < 0.))) { { (void) printf ("    indices in compressed pattern:                 %.0f\n", Info [63]) ; } ; } }
                                    ;
    { if (((Info [64]) != (Info [64])) || (!((Info [64]) < 0.))) { { (void) printf ("    numerical values stored in Numeric object:     %.0f\n", Info [64]) ; } ; } }
                            ;
    { if (((Info [60]) != (Info [60])) || (!((Info [60]) < 0.))) { { (void) printf ("    numeric factorization defragmentations:        %.0f\n", Info [60]) ; } ; } }
                                ;
    { if (((Info [61]) != (Info [61])) || (!((Info [61]) < 0.))) { { (void) printf ("    numeric factorization reallocations:           %.0f\n", Info [61]) ; } ; } }
                                 ;
    { if (((Info [62]) != (Info [62])) || (!((Info [62]) < 0.))) { { (void) printf ("    costly numeric factorization reallocations:    %.0f\n", Info [62]) ; } ; } }
                                        ;
    { if (((tnum) != (tnum)) || (!((tnum) < 0.))) { { (void) printf ("    numeric factorization CPU time (sec):          %.2f\n", tnum) ; } ; } }
       ;
    { if (((twnum) != (twnum)) || (!((twnum) < 0.))) { { (void) printf ("    numeric factorization wallclock time (sec):    %.2f\n", twnum) ; } ; } }
        ;

    if (tnum > 0 && fnum > 0)
    {
 { if (((1e-6 * fnum / tnum) != (1e-6 * fnum / tnum)) || (!((1e-6 * fnum / tnum) < 0.))) { { (void) printf ("    numeric factorization mflops (CPU time):       %.2f\n", 1e-6 * fnum / tnum) ; } ; } }

                        ;
    }
    if (twnum > 0 && fnum > 0)
    {
 { if (((1e-6 * fnum / twnum) != (1e-6 * fnum / twnum)) || (!((1e-6 * fnum / twnum) < 0.))) { { (void) printf ("    numeric factorization mflops (wallclock):      %.2f\n", 1e-6 * fnum / twnum) ; } ; } }
    ...
    {
 ttot = tsym + tnum ;
 { if (((ttot) != (ttot)) || (!((ttot) < 0.))) { { (void) printf ("    symbolic + numeric CPU time (sec):             %.2f\n", ttot) ; } ; } }
           ;
 if (ftot > 0 && ttot > 0)
 {
     { if (((1e-6 * ftot / ttot) != (1e-6 * ftot / ttot)) || (!((1e-6 * ftot / ttot) < 0.))) { { (void) printf ("    symbolic + numeric mflops (CPU time):          %.2f\n", 1e-6 * ftot / ttot) ; } ; } }
    ...
    {
 twtot = twsym + twnum ;
 { if (((twtot) != (twtot)) || (!((twtot) < 0.))) { { (void) printf ("    symbolic + numeric wall clock time (sec):      %.2f\n", twtot) ; } ; } }
            ;
 if (ftot > 0 && twtot > 0)
 {
     { if (((1e-6 * ftot / twtot) != (1e-6 * ftot / twtot)) || (!((1e-6 * ftot / twtot) < 0.))) { { (void) printf ("    symbolic + numeric mflops (wall clock):        %.2f\n", 1e-6 * ftot / twtot) ; } ; } }
    ...
    { if (((fsolve) != (fsolve)) || (!((fsolve) < 0.))) { { (void) printf ("\n    solve flops:                                   %.5e\n", fsolve) ; } ; } }
         ;
    { if (((Info [80]) != (Info [80])) || (!((Info [80]) < 0.))) { { (void) printf ("    iterative refinement steps taken:              %.0f\n", Info [80]) ; } ; } }
                          ;
    { if (((Info [81]) != (Info [81])) || (!((Info [81]) < 0.))) { { (void) printf ("    iterative refinement steps attempted:          %.0f\n", Info [81]) ; } ; } }
                              ;
    { if (((Info [82]) != (Info [82])) || (!((Info [82]) < 0.))) { { (void) printf ("    sparse backward error omega1:                  %.2e\n", Info [82]) ; } ; } }
                        ;
    { if (((Info [83]) != (Info [83])) || (!((Info [83]) < 0.))) { { (void) printf ("    sparse backward error omega2:                  %.2e\n", Info [83]) ; } ; } }
                        ;
    { if (((tsolve) != (tsolve)) || (!((tsolve) < 0.))) { { (void) printf ("    solve CPU time (sec):                          %.2f\n", tsolve) ; } ; } }
         ;
    { if (((twsolve) != (twsolve)) || (!((twsolve) < 0.))) { { (void) printf ("    solve wall clock time (sec):                   %.2f\n", twsolve) ; } ; } }
          ;
    if (fsolve > 0 && tsolve > 0)
    {
 { if (((1e-6 * fsolve / tsolve) != (1e-6 * fsolve / tsolve)) || (!((1e-6 * fsolve / tsolve) < 0.))) { { (void) printf ("    solve mflops (CPU time):                       %.2f\n", 1e-6 * fsolve / tsolve) ; } ; } }

                             ;
    }
    if (fsolve > 0 && twsolve > 0)
    {
 { if (((1e-6 * fsolve / twsolve) != (1e-6 * fsolve / twsolve)) || (!((1e-6 * fsolve / twsolve) < 0.))) { { (void) printf ("    solve mflops (wall clock time):                %.2f\n", 1e-6 * fsolve / twsolve) ; } ; } }
 ...
 {
     ttot += tsolve ;
     { if (((ttot) != (ttot)) || (!((ttot) < 0.))) { { (void) printf ("    total symbolic + numeric + solve CPU time:     %.2f\n", ttot) ; } ; } }

        ;
     if (ftot > 0 && ttot > 0)
     {
  { if (((1e-6 * ftot / ttot) != (1e-6 * ftot / ttot)) || (!((1e-6 * ftot / ttot) < 0.))) { { (void) printf ("    total symbolic + numeric + solve mflops (CPU): %.2f\n", 1e-6 * ftot / ttot) ; } ; } }
 ...
 {
     twtot += tsolve ;
     { if (((twtot) != (twtot)) || (!((twtot) < 0.))) { { (void) printf ("    total symbolic+numeric+solve wall clock time:  %.2f\n", twtot) ; } ; } }

         ;
     if (ftot > 0 && twtot > 0)
     {
  { if (((1e-6 * ftot / twtot) != (1e-6 * ftot / twtot)) || (!((1e-6 * ftot / twtot) < 0.))) { { (void) printf ("    total symbolic+numeric+solve mflops(wallclock) %.2f\n", 1e-6 * ftot / twtot) ; } ; } }
