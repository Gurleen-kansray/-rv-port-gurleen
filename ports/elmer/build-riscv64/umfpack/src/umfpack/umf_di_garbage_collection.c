# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_garbage_collection.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_garbage_collection.c"
# 48 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_garbage_collection.c"
...
# 49 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_garbage_collection.c" 2
...
# 79 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_garbage_collection.c"
    ...
    n_row = Work->n_row ;
    n_col = Work->n_col ;
# 96 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_garbage_collection.c"
    Numeric->ngarbage++ ;
# 105 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_garbage_collection.c"
 ...
 if ((Col_degree [col] >= 0) && Col_tuples [col])
 {
    ...
    nel = Work->nel ;
    ;
# 155 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_garbage_collection.c"
    e2 = 0 ;
 ...
 if (E [e])
 {
  ...
  Work->prior_element = e2 ;
    ...
    Work->nel = e2 ;
    nel = Work->nel ;
# 198 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_garbage_collection.c"
 ...
 if (e == 0)
 {
  ...
  drnew++ ;
     ...
     pnext = pdest ;
# 284 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_garbage_collection.c"
     Fsrc = Work->Flblock ;
     Fdst = Work->Flblock ;
     ;
     gap1 = dr - r ;
...
# 359 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_garbage_collection.c"
     }
# 374 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_garbage_collection.c"
     Work->fnr_curr = drnew ;
     Work->fnc_curr = dcnew ;
     Work->fcurr_size = (drnew + nb) * (dcnew + nb) ;
     size = (((((sizeof (double) * (Work->fcurr_size))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
  ...
  for (i = k-1 ; i >= 0 ; i--)
  {
     ...
     Work->Flublock = (double *) (Numeric->Memory + E [0]) ;
     ;
...
# 487 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_garbage_collection.c"
 }
 else if (e > 0)
 {
# 508 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_garbage_collection.c"
     p = psrc + 1 ;
     { { { ; ; ; epsrc = (Element *) p ; p += (((((sizeof (Element) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ; Cols = (int *) p ; } ; ncols = epsrc->ncols ; Rows = Cols + ncols ; } ; nrows = epsrc->nrows ; p += (((((sizeof (int) * (ncols + nrows))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ; C = (double *) p ; } ;
     nrowsleft = epsrc->nrowsleft ;
     ncolsleft = epsrc->ncolsleft ;
     cdeg = epsrc->cdeg ;
     rdeg = epsrc->rdeg ;
# 529 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_garbage_collection.c"
     csize = nrowsleft * ncolsleft ;
     size2 = (((((sizeof (Element) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
    + (((((sizeof (int) * (nrowsleft + ncolsleft))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
    + (((((sizeof (double) * (csize))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
     ...
     p += (((((sizeof (int) * (nrowsleft + ncolsleft))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
     C2 = (double *) p ;
