# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_numeric.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_numeric.c"
# 21 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_numeric.c"
...
# 22 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_numeric.c" 2
...
# 23 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_numeric.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_report_perm.h" 1
...
# 24 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_numeric.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_report_vector.h" 1
...
# 25 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_numeric.c" 2
...
# 26 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_numeric.c" 2
...
# 27 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_numeric.c" 2
...
)
{
 ...
 return ((0)) ;
    ...
    { (void) printf ("Numeric object:  ") ; } ;

    Numeric = (NumericType *) NumericHandle ;
    if (!umfzi_valid_numeric (Numeric))
    {
 { (void) printf ("ERROR: LU factors invalid\n\n") ; } ;
 return ((-3)) ;
    }
 ...
 + (((((sizeof (int) * (n_row+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
 + (((((sizeof (int) * (n_col+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
 + 6 * (((((sizeof (int) * (npiv+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
 + ((Numeric->scale != 0) ?
 ...
 + (((((sizeof (int) * (Numeric->ulen))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 ...
 { (void) printf ("    relative pivot tolerance used:              %g\n", Numeric->relpt) ; }
                      ;
 { (void) printf ("    relative symmetric pivot tolerance used:    %g\n", Numeric->relpt2) ; }
                       ;

 { (void) printf ("    matrix scaled: ") ; } ;
 if (Numeric->scale == 0)
 {
     { (void) printf ("no") ; } ;
 }
 ...
 {
     { (void) printf ("yes (divided each row by sum abs value in each row)\n") ; } ;
     { (void) printf ("    minimum sum (abs (rows of A)):              %.5e\n", Numeric->rsmin) ; }
                   ;
     { (void) printf ("    maximum sum (abs (rows of A)):              %.5e", Numeric->rsmax) ; }
                   ;
 }
 else if (Numeric->scale == 2)
 {
     { (void) printf ("yes (divided each row by max abs value in each row)\n") ; } ;
     { (void) printf ("    minimum max (abs (rows of A)):              %.5e\n", Numeric->rsmin) ; }
                   ;
     { (void) printf ("    maximum max (abs (rows of A)):              %.5e", Numeric->rsmax) ; }
                   ;
 }
 { (void) printf ("\n") ; } ;

 { (void) printf ("    initial allocation parameter used:          %g\n", Numeric->alloc_init) ; }
                           ;
 { (void) printf ("    frontal matrix allocation parameter used:   %g\n", Numeric->front_alloc_init) ; }
                                 ;
 { (void) printf ("    final total size of Numeric object (Units): ""%d""\n", numeric_size) ; }
                    ;
 { (void) printf ("    final total size of Numeric object (MBytes): %.1f\n", (((numeric_size) * sizeof (Unit)) / 1048576.0)) ; }
                             ;
 { (void) printf ("    peak size of variable-size part (Units):    ""%d""\n", Numeric->max_usage) ; }
                          ;
 { (void) printf ("    peak size of variable-size part (MBytes):   %.1f\n", (((Numeric->max_usage) * sizeof (Unit)) / 1048576.0)) ; }
                                   ;
 { (void) printf ("    largest actual frontal matrix size:         ""%d""\n", Numeric->maxfrsize) ; }
                          ;
 { (void) printf ("    memory defragmentations:                    ""%d""\n", Numeric->ngarbage) ; }
                         ;
 { (void) printf ("    memory reallocations:                       ""%d""\n", Numeric->nrealloc) ; }
                         ;
 { (void) printf ("    costly memory reallocations:                ""%d""\n", Numeric->ncostly) ; }
                        ;
 { (void) printf ("    entries in compressed pattern (L and U):    ""%d""\n", Numeric->isize) ; }
                      ;
 { (void) printf ("    number of nonzeros in L (excl diag):        ""%d""\n", Numeric->lnz) ; }
                    ;
 { (void) printf ("    number of entries stored in L (excl diag):  ""%d""\n", Numeric->nLentries) ; }
                          ;
 { (void) printf ("    number of nonzeros in U (excl diag):        ""%d""\n", Numeric->unz) ; }
                    ;
 { (void) printf ("    number of entries stored in U (excl diag):  ""%d""\n", Numeric->nUentries) ; }
                          ;
 { (void) printf ("    factorization floating-point operations:    %g\n", Numeric->flops) ; }
                      ;
 { (void) printf ("    number of nonzeros on diagonal of U:        ""%d""\n", Numeric->nnzpiv) ; }
                       ;
 { (void) printf ("    min abs. value on diagonal of U:            %.5e\n", Numeric->min_udiag) ; }
                          ;
 { (void) printf ("    max abs. value on diagonal of U:            %.5e\n", Numeric->max_udiag) ; }
                          ;
 { (void) printf ("    reciprocal condition number estimate:       %.2e\n", Numeric->rcond) ; }
                      ;
    }

    W = (int *) umf_i_malloc (nn, sizeof (int)) ;
    if (!W)
    {
 { (void) printf (" ERROR: out of memory to check Numeric object\n\n") ; } ;
 return ((-1)) ;
    }
 ...
 { if (prl >= (4)) { { (void) printf ("Scale factors, Rs: ") ; } ; } } ;
 (void) umfzi_report_vector (n_row, Numeric->Rs, (double *) 0,
     prl, (0), (1)) ;
    }
    else
    {
 { if (prl >= (4)) { { (void) printf ("Scale factors, Rs: (not present)\n") ; } ; } } ;
    }

    { if (prl >= (4)) { { (void) printf ("\nP: row ") ; } ; } } ;
    if (umf_i_report_perm (n_row, Numeric->Rperm, W, prl, 0) != (0))
    {
 (void) umf_i_free ((void *) W) ;
 return ((-3)) ;
    }

    { if (prl >= (4)) { { (void) printf ("\nQ: column ") ; } ; } } ;
    if (umf_i_report_perm (n_col, Numeric->Cperm, W, prl, 0) != (0))
    {
 (void) umf_i_free ((void *) W) ;
 return ((-3)) ;
    }
    ...
    {
 (void) umf_i_free ((void *) W) ;
 { (void) printf (" ERROR: L factor invalid\n\n") ; } ;
 return ((-3)) ;
    }
    ...
    {
 (void) umf_i_free ((void *) W) ;
 { (void) printf (" ERROR: U factor invalid\n\n") ; } ;
 return ((-3)) ;
    }


    { if (prl >= (4)) { { (void) printf ("\ndiagonal of U: ") ; } ; } } ;
    (void) umfzi_report_vector (n_inner, (double *) Numeric->D, (double *) 0,
 prl, (0), (0)) ;

    (void) umf_i_free ((void *) W) ;

    { if (prl >= (4)) { { (void) printf ("    Numeric object:  ") ; } ; } } ;
    { (void) printf ("OK\n\n") ; } ;
    return ((0)) ;
}
 ...
 *Lip, newLchain, llen, prl1, pos, lp, p, npiv, n1, *Li ;
 ...
 lp += (((((sizeof (int) * (deg))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 ...
 { if (prl >= (4)) { { (void) printf ("\n    column ""%d"":", (k)) ; } ; } } ;
 { if (prl >= (4)) { { (void) printf ("  length ""%d"".\n", deg) ; } ; } } ;
 for (j = 0 ; j < deg ; j++)
 {
     row = Li [j] ;
     { if (prl >= (4)) { { (void) printf ("\trow ""%d"" : ", (row)) ; } ; } } ;
     if (prl >= 4) { if ((((Lval [j]).component [0]) != 0.)) { { (void) printf (" (%g", (Lval [j]).component [0]) ; } ; } else { { (void) printf (" (0") ; } ; } if ((((Lval [j]).component [1]) < 0.)) { { (void) printf (" - %gi)", -(Lval [j]).component [1]) ; } ; } else if ((((Lval [j]).component [1]) == 0.)) { { (void) printf (" + 0i)") ; } ; } else { { (void) printf (" + %gi)", (Lval [j]).component [1]) ; } ; } } ;
     if (row <= k || row >= n_row)
     {
  return ((0)) ;
     }
 ...
 if (pos != (-1))
 {
     { if (prl >= (4)) { { (void) printf ("  remove row ""%d"" at position ""%d"".", (Pattern [pos]), (pos)) ; } ; } }
                                       ;
 ...
 p = lp + (((((sizeof (int) * (llen))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 xp = (DoubleComplex *) (Numeric->Memory + p) ;
 if ((llen > 0 || deg > 0)
     && (p + (int) (((((sizeof (DoubleComplex) * (deg))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) > Numeric->size))
 {
     return ((0)) ;
 }
 if (llen > 0)
 {
     { if (prl >= (4)) { { (void) printf ("  add ""%d"" entries.", llen) ; } ; } } ;
 ...
 { if (prl >= (4)) { { (void) printf ("  length ""%d"".", deg) ; } ; } } ;
 if (newLchain)
 {
     { if (prl >= (4)) { { (void) printf ("  Start of Lchain.") ; } ; } } ;
 }
 { if (prl >= (4)) { { (void) printf ("\n") ; } ; } } ;
 ...
 for (j = 0 ; j < deg ; j++)
 {
     row = Pattern [j] ;
     { if (prl >= (4)) { { (void) printf ("\trow ""%d"" : ", (row)) ; } ; } } ;
     if (prl >= 4) { if ((((*xp).component [0]) != 0.)) { { (void) printf (" (%g", (*xp).component [0]) ; } ; } else { { (void) printf (" (0") ; } ; } if ((((*xp).component [1]) < 0.)) { { (void) printf (" - %gi)", -(*xp).component [1]) ; } ; } else if ((((*xp).component [1]) == 0.)) { { (void) printf (" + 0i)") ; } ; } else { { (void) printf (" + %gi)", (*xp).component [1]) ; } ; } } ;
     if (row <= k || row >= n_row)
     {
  return ((0)) ;
     }
 ...
 *Uip, n_col, ulen, p, newUchain, up, npiv, n1, *Ui ;
 ...
 {
     up = -up ;
     p = up + (((((sizeof (int) * (ulen))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 }
 else
 {
     p = up ;
 ...
 xp = (DoubleComplex *) (Numeric->Memory + p) ;
 if (deg > 0 && (p + (int) (((((sizeof (DoubleComplex) * (deg))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) > Numeric->size))
 {
     return ((0)) ;
 }
 for (j = 0 ; j < deg ; j++)
 {
     col = Pattern [j] ;
     { if (prl >= (4)) { { (void) printf ("\tcol ""%d"" :", (col)) ; } ; } } ;
     if (prl >= 4) { if ((((*xp).component [0]) != 0.)) { { (void) printf (" (%g", (*xp).component [0]) ; } ; } else { { (void) printf (" (0") ; } ; } if ((((*xp).component [1]) < 0.)) { { (void) printf (" - %gi)", -(*xp).component [1]) ; } ; } else if ((((*xp).component [1]) == 0.)) { { (void) printf (" + 0i)") ; } ; } else { { (void) printf (" + %gi)", (*xp).component [1]) ; } ; } } ;
     if (col <= k || col >= n_col)
     {
  return ((0)) ;
 ...
 if (newUchain)
 {
     ...
     {
  deg = ulen ;
  { if (prl >= (4)) { { (void) printf ("length ""%d"".  End of Uchain.\n", deg) ; } ; } } ;
  if (up + (int) (((((sizeof (int) * (ulen))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) > Numeric->size)
  {
      return ((0)) ;
  }
 ...
 else
 {
     if (ulen > 0)
     {
  { if (prl >= (4)) { { (void) printf ("remove ""%d"" entries.  ", ulen) ; } ; } } ;
     }
     deg -= ulen ;
     if (deg < 0)
     {
  ...
  { if (prl >= (4)) { { (void) printf ("add column ""%d"" at position ""%d"".  ", (k), (pos)) ; } ; } }
                               ;
  if (pos < 0 || pos > deg)
  {
      return ((0)) ;
 ...
 up += (((((sizeof (int) * (deg))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 ...
 for (j = 0 ; j < deg ; j++)
 {
     col = Ui [j] ;
     { if (prl >= (4)) { { (void) printf ("\tcol ""%d"" : ", (col)) ; } ; } } ;
     if (prl >= 4) { if ((((Uval [j]).component [0]) != 0.)) { { (void) printf (" (%g", (Uval [j]).component [0]) ; } ; } else { { (void) printf (" (0") ; } ; } if ((((Uval [j]).component [1]) < 0.)) { { (void) printf (" - %gi)", -(Uval [j]).component [1]) ; } ; } else if ((((Uval [j]).component [1]) == 0.)) { { (void) printf (" + 0i)") ; } ; } else { { (void) printf (" + %gi)", (Uval [j]).component [1]) ; } ; } } ;
     if (col <= k || col >= n_col)
     {
  return ((0)) ;
     }
