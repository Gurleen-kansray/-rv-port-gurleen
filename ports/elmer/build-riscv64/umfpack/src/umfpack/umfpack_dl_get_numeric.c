...
#pragma ivdep
 ...
 xp = (double *) (Numeric->Memory + lp + (((((sizeof (long) * (llen))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
...
# 720 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
 ...
 {
     up = -up ;
     xp = (double *) (Numeric->Memory + up + (((((sizeof (long) * (ulen))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
 }
 else
 {
