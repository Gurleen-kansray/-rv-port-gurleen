...
)
{
 ...
 return ((-17)) ;
    ...
    { ; if (fwrite (Symbolic->Cperm_init, sizeof (int), Symbolic->n_col+1, f) != Symbolic->n_col+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Rperm_init, sizeof (int), Symbolic->n_row+1, f) != Symbolic->n_row+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Front_npivcol, sizeof (int), Symbolic->nfr+1, f) != Symbolic->nfr+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Front_parent, sizeof (int), Symbolic->nfr+1, f) != Symbolic->nfr+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Front_1strow, sizeof (int), Symbolic->nfr+1, f) != Symbolic->nfr+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Front_leftmostdesc, sizeof (int), Symbolic->nfr+1, f) != Symbolic->nfr+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Chain_start, sizeof (int), Symbolic->nchains+1, f) != Symbolic->nchains+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Chain_maxrows, sizeof (int), Symbolic->nchains+1, f) != Symbolic->nchains+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Chain_maxcols, sizeof (int), Symbolic->nchains+1, f) != Symbolic->nchains+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Cdeg, sizeof (int), Symbolic->n_col+1, f) != Symbolic->n_col+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Rdeg, sizeof (int), Symbolic->n_row+1, f) != Symbolic->n_row+1) { fclose (f) ; return ((-17)) ; } } ;
    if (Symbolic->esize > 0)
    {

 { ; if (fwrite (Symbolic->Esize, sizeof (int), Symbolic->esize, f) != Symbolic->esize) { fclose (f) ; return ((-17)) ; } } ;
    }
    if (Symbolic->prefer_diagonal)
    {

 { ; if (fwrite (Symbolic->Diagonal_map, sizeof (int), Symbolic->n_col+1, f) != Symbolic->n_col+1) { fclose (f) ; return ((-17)) ; } } ;
    }
