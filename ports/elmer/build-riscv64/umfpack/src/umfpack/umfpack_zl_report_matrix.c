# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_matrix.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_matrix.c"
# 16 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_matrix.c"
...
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_matrix.c" 2
...
)
{
 ...
 n_i = n_col ;
    ...
    { (void) printf ("%s-form matrix, n_row ""%ld"" n_col ""%ld"", ", vector, n_row, n_col) ; } ;

    if (n_row <= 0 || n_col <= 0)
    {
 { (void) printf ("ERROR: n_row <= 0 or n_col <= 0\n\n") ; } ;
 return ((-6)) ;
    }

    if (!Ap)
    {
 { (void) printf ("ERROR: Ap missing\n\n") ; } ;
 return ((-5)) ;
    }

    nz = Ap [n] ;
    { (void) printf ("nz = ""%ld"". ", nz) ; } ;
    if (nz < 0)
    {
 { (void) printf ("ERROR: number of entries < 0\n\n") ; } ;
 return ((-8)) ;
    }

    if (Ap [0] != 0)
    {
 { (void) printf ("ERROR: Ap [""%ld""] = ""%ld"" must be ""%ld""\n\n", (long) (0), (Ap [0]), (long) (0)) ; }
                                                        ;
 return ((-8)) ;
    }
    ...
    if (!Ai)
    {
 { (void) printf ("ERROR: Ai missing\n\n") ; } ;
 return ((-5)) ;
    }

    do_values = Ax != (double *) 0 ;
 ...
 if (Ap [k] < 0)
 {
     { (void) printf ("ERROR: Ap [""%ld""] < 0\n\n", (k)) ; } ;
     return ((-8)) ;
 }
 if (Ap [k] > nz)
 {
     { (void) printf ("ERROR: Ap [""%ld""] > size of Ai\n\n", (k)) ; } ;
     return ((-8)) ;
 }
    }
 ...
 if (length < 0)
 {
     { (void) printf ("ERROR: # entries in %s ""%ld"" is < 0\n\n", vector, (k)) ; }
                      ;
     return ((-8)) ;
 }
    }
 ...
 p2 = Ap [k+1] ;
 length = p2 - p1 ;
 { if (prl >= (4)) { { (void) printf ("\n    %s ""%ld"": start: ""%ld"" end: ""%ld"" entries: ""%ld""\n", vector, (k), p1, p2-1, length) ; } ; } }
                                           ;
 ilast = (-1) ;
 for (p = p1 ; p < p2 ; p++)
 {
     i = Ai [p] ;
     { if (prl >= (4)) { { (void) printf ("\t%s ""%ld"" ", index, (i)) ; } ; } } ;
     if (do_values && prl >= 4)
     {
  { (void) printf (":") ; } ;
  { if (split) { (a).component [0] = (Ax)[p] ; (a).component [1] = (Az)[p] ; } else { (a) = ((DoubleComplex *)(Ax))[p] ; } } ;
  { if ((((a).component [0]) != 0.)) { { (void) printf (" (%g", (a).component [0]) ; } ; } else { { (void) printf (" (0") ; } ; } if ((((a).component [1]) < 0.)) { { (void) printf (" - %gi)", -(a).component [1]) ; } ; } else if ((((a).component [1]) == 0.)) { { (void) printf (" + 0i)") ; } ; } else { { (void) printf (" + %gi)", (a).component [1]) ; } ; } } ;
     }
     if (i < 0 || i >= n_i)
     {
  { (void) printf (" ERROR: %s index ""%ld"" out of range in %s ""%ld""\n\n", index, (i), vector, (k)) ; }
                                            ;
  return ((-8)) ;
     }
     if (i <= ilast)
     {
  { (void) printf (" ERROR: %s index ""%ld"" out of order (or duplicate) in " "%s ""%ld""\n\n", index, (i), vector, (k)) ; }
                                                           ;
  return ((-8)) ;
     }
     { if (prl >= (4)) { { (void) printf ("\n") ; } ; } } ;
 ...
 if (prl == 4 && k == 9 && n > 10)
 {
    ...
    { if (prl >= (4)) { { (void) printf ("    %s-form matrix ", vector) ; } ; } } ;
    { (void) printf ("OK\n\n") ; } ;
