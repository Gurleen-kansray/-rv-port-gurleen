# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
# 397 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
...
# 398 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c" 2
...
# 399 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_apply_order.h" 1
...
# 400 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_fsize.h" 1
...
# 401 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c" 2
# 438 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
...
# 628 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
 void umf_i_colamd_set_defaults
(
...
# 676 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
 int umf_i_colamd
(
...
)
{
    ...
    int max_deg ;
    int aggressive ;
# 730 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
...
# 746 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
    ;
 ...
 stats [i] = 0 ;
    ...
    stats [4] = -1 ;
    stats [5] = -1 ;
# 792 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
    ;
    ;
    ;
    ;
    ...
    nnz = p [n_col] ;
# 818 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
    ;
    ;
# 832 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
    ;
    ...
    Col_size = ((n_col + 1) * sizeof (Colamd_Col) / sizeof (int)) ;
    Row_size = ((n_row + 1) * sizeof (Colamd_Row) / sizeof (int)) ;
# 859 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
...
# 880 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
    ;
 ...
 , &nfr, aggressive, InFront
    ...
    umf_i_fsize (nfr, Front_size, Front_nrows, Front_ncols,
 ...
 Front_order, Front_child, Front_sibling, Front_stack) ;
    ...
    umf_i_apply_order (Front_npivcol, Front_order, A, nfr, nfr) ;
    umf_i_apply_order (Front_nrows, Front_order, A, nfr, nfr) ;
    umf_i_apply_order (Front_ncols, Front_order, A, nfr, nfr) ;
    umf_i_apply_order (Front_parent, Front_order, A, nfr, nfr) ;
    umf_i_apply_order (Front_cols, Front_order, A, nfr, nfr) ;
...
# 1062 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
static int init_rows_cols
(
...
# 1104 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
 ;
...
# 1130 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
    for (row = 0 ; row < n_row ; row++)
    {
 Row [row].length = 0 ;
 ...
 {
     row = *cp++ ;
# 1173 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
     ;
# 1192 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
     ;
...
# 1266 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
static void init_scoring
(
...
)
{
    ...
    int nnewlyempty_col ;
    int ne ;
# 1333 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
    dense_row_count =
 ((int) (((16.0) > ((knobs [0]) * 16.0 * sqrt ((double) (n_col)))) ? (16.0) : ((knobs [0]) * 16.0 * sqrt ((double) (n_col))))) ;
    dense_col_count =
 ((int) (((16.0) > ((knobs [1]) * 16.0 * sqrt ((double) (n_row)))) ? (16.0) : ((knobs [1]) * 16.0 * sqrt ((double) (n_row))))) ;
    ...
    nempty_row = 0 ;
    nnewlyempty_row = 0 ;
# 1415 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
    for (c = n_col-1 ; c >= 0 ; c--)
    {
# 1427 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
 ;
 ;
 ...
 else
 {
    ...
    ;
    ;
# 1504 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
    for (c = n_col-1 ; c >= 0 ; c--)
    {
 ...
 else
 {
     ...
     Col [c].shared2.score = score ;
                ...
                ;
# 1573 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
    for (c = 0 ; c <= n_col ; c++)
    {
 head [c] = (-1) ;
    }
...
# 1630 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
    *p_n_col2 = n_col2 ;
    *p_n_row2 = n_row2 ;
    *p_max_deg = max_deg ;
...
# 1656 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
static int find_ordering
(
...
)
{
    ...
    int next_col ;
    int ngarbage ;
# 1724 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
    ...
    max_mark = 0x7fffffff 
# 1731 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
              - (2*(n_col)+1) ;
 ...
 InFront [row] = (-1) ;
    ...
    for (k = 0 ; k < n_col2 ; )
    {
# 1765 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
 ;
 ;
 ;
# 1777 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
...
# 1892 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
     }
 }
# 1902 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
 Col [pivot_col].shared1.thickness = pivot_col_thickness ;
 max_deg = (((max_deg) > (pivot_row_degree)) ? (max_deg) : (pivot_row_degree)) ;
# 1913 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
 cp = &A [Col [pivot_col].start] ;
 cp_end = cp + Col [pivot_col].length ;
 while (cp < cp_end)
 {
 ...
 ;
# 1989 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
 ;
...
# 2102 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
 ;
...
# 2249 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
...
# 2269 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
 ;
 ;
...
# 2347 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
...
# 2408 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
 nfr++ ;
...
# 2461 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
static void detect_super_cols
(
# 2471 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
    Colamd_Col Col [],
    int A [],
    int head [],
    int row_start,
...
# 2633 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
static int garbage_collection
(
...
)
{
    ...
    int c ;
    int length ;
# 2663 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
    pdest = &A[0] ;
    for (c = 0 ; c < n_col ; c++)
    {
 if ((Col [c].start >= (0)))
 ...
 if ((Row [r].shared2.mark >= (0)))
 {
     if (Row [r].length == 0)
     {
# 2702 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
  ;
  { Row [r].shared2.mark = (-1) ; } ;
     }
     else
...
# 2774 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_colamd.c"
static int clear_mark
(
