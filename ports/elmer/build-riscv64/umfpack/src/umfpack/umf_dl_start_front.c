# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_start_front.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_start_front.c"
# 15 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_start_front.c"
...
# 16 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_start_front.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_grow_front.h" 1
...
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_start_front.c" 2
...
# 92 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_start_front.c"
 ...
 cdeg = 0 ;
    ...
    ;
    ;
# 146 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_start_front.c"
    overflow = ((!((maxbytes) * (1.0+1e-8) <= (double) 0x7fffffffffffffffL
# 146 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_start_front.c"
              )) || ((maxbytes) != (maxbytes))) ;
    if (overflow)
    {

 maxfrsize = 0x7fffffffffffffffL 
# 150 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_start_front.c"
                    / sizeof (double) ;
    }
    else
    {
 ...
 fsize = (((1) > (fsize)) ? (1) : (fsize)) ;
    ...
    {
 if (((!((Numeric->front_alloc_init * maxbytes) * (1.0+1e-8) <= (double) 0x7fffffffffffffffL
# 166 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_start_front.c"
    )) || ((Numeric->front_alloc_init * maxbytes) != (Numeric->front_alloc_init * maxbytes))))
 {

     fsize = 0x7fffffffffffffffL 
# 169 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_start_front.c"
                    / sizeof (double) ;
 }
 else
 {
 ...
 if (cdeg > 0)
 {
     ...
     if (((!((((double) cdeg * (double) cdeg) * sizeof (double)) * (1.0+1e-8) <= (double) 0x7fffffffffffffffL
# 184 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_start_front.c"
        )) || ((((double) cdeg * (double) cdeg) * sizeof (double)) != (((double) cdeg * (double) cdeg) * sizeof (double)))))
     {

  fsize2 = 0x7fffffffffffffffL 
# 187 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_start_front.c"
                  / sizeof (double) ;
     }
     else
     {
 ...
 ;
 Work->do_grow = (1) ;
 if (!umfdl_grow_front (Numeric, fnr2, fnc2, Work, -1))
 {
