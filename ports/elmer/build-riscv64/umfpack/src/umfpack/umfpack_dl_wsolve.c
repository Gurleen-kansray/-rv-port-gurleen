...
# 43 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_solve.c"
 long
...
# 91 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_solve.c"
    umfpack_tic (stats) ;
...
# 216 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_solve.c"
    status = umfdl_solve (sys, Ap, Ai, Ax, Xx, Bx,



 Numeric, irstep, Info, Pattern, W) ;
# 236 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_solve.c"
    Info [0] = status ;
    if (status >= 0)
    {
 umfpack_toc (stats) ;
