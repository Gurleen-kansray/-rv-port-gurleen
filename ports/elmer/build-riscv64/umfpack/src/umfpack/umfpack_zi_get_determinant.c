# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_determinant.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_determinant.c"
# 23 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_determinant.c"
...
# 24 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_determinant.c" 2
...
# 25 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_determinant.c" 2
...
# 26 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_determinant.c" 2
...
# 27 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_determinant.c" 2
...
static int rescale_determinant
(
...
)
{
    ...
    { double r, ar, ai ; ar = (((((*d_mantissa).component [0]) < 0.)) ? -((*d_mantissa).component [0]) : ((*d_mantissa).component [0])) ; ai = (((((*d_mantissa).component [1]) < 0.)) ? -((*d_mantissa).component [1]) : ((*d_mantissa).component [1])) ; if (ar >= ai) { if (ar + ai == ar) { (d_abs) = ar ; } else { r = ai / ar ; (d_abs) = ar * sqrt (1.0 + r*r) ; } } else { if (ai + ar == ai) { (d_abs) = ai ; } else { r = ar / ai ; (d_abs) = ai * sqrt (1.0 + r*r) ; } } } ;
...
)
{
 ...
 return ((-5)) ;
    ...
    Wi = (int *) umf_i_malloc (n, sizeof (int)) ;
 ...
 Mx [1] = d_sign * ((d_mantissa).component [1]) ;
    ...
    if (d_exponent + 1.0 > log10 (((double)1.79769313486231570814527423731704357e+308L)
# 297 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_determinant.c"
                                        ))
    {
 Info [0] = (3) ;
    }
    else if (d_exponent - 1.0 < log10 (((double)2.22507385850720138309023271733240406e-308L)
# 301 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_determinant.c"
                                             ))
    {
 Info [0] = (2) ;
    }
