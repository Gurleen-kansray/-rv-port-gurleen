...
# 52 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
    ...
    if (((!(((double) fnr_min * (double) fnc_min * sizeof (double)) * (1.0+1e-8) <= (double) 0x7fffffff
# 84 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
 ...
 return ((0)) ;
    ...
    if (((!((s * sizeof (double)) * (1.0+1e-8) <= (double) 0x7fffffff
...
# 115 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
 ...
 ;
 umfdi_mem_free_tail_block (Numeric, E [0]) ;
 E [0] = 0 ;
...
# 166 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
    ;
    eloc = umfdi_mem_alloc_tail_block (Numeric, (((((sizeof (double) * (newsize))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
 ...
 ;
 if (!umfdi_get_memory (Numeric, Work, 1 + (((((sizeof (double) * (newsize))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))),
