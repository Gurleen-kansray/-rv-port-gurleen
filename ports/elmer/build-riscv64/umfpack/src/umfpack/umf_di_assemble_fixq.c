# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_assemble.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_assemble.c"
# 15 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_assemble.c"
...
# 16 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_assemble.c" 2
...
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_assemble.c" 2
...
# 312 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_assemble.c"
}
# 322 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_assemble.c"
 ...
 *Fcpos,
 fnrows,
 fncols ;
# 373 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_assemble.c"
    fncols = Work->fncols ;
    fnrows = Work->fnrows ;
    Fcpos = Work->Fcpos ;
    Frpos = Work->Frpos ;
    ...
    rdeg0 = Work->rdeg0 ;
    cdeg0 = Work->cdeg0 ;
# 420 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_assemble.c"
    Fcblock = Work->Fcblock ;
 ...
 { { { ; ; ; ep = (Element *) p ; p += (((((sizeof (Element) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ; Cols = (int *) p ; } ; ncols = ep->ncols ; Rows = Cols + ncols ; } ; nrows = ep->nrows ; p += (((((sizeof (int) * (ncols + nrows))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ; S = (double *) p ; } ;
 nrowsleft = ep->nrowsleft ;
 ncolsleft = ep->ncolsleft ;
 next = ep->next ;
 ep->next = (-1) ;
...
#pragma ivdep
   ...
   S += nrows ;
     ...
     umfdi_mem_free_tail_block (Numeric, E [e]) ;
     E [e] = 0 ;
...
# 1034 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_assemble.c"
    if (Work->any_skip)
    {
...
# 1065 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_assemble.c"
    if (Work->any_skip)
    {
...
# 1215 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_assemble.c"
}
