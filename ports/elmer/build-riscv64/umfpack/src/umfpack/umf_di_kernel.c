...
# 105 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c"
 ...
 { if (! (umfdi_start_front (chain, Numeric, Work, Symbolic))) { return ((-1)) ; }} ;
 ...
 for (Work->frontid = f1 ; Work->frontid <= f2 ; Work->frontid++)
 {
  ...
  status = umfdi_local_search (Numeric, Work, Symbolic) ;
  if (status == (-11))
  {
  ...
  if (Work->do_update)
  {
      umfdi_blas3_update (Work) ;
      if (drop)
      {
   { if (! (umfdi_store_lu_drop (Numeric, Work))) { return ((-1)) ; }} ;
      }
      else
      {
   { if (! (umfdi_store_lu (Numeric, Work))) { return ((-1)) ; }} ;
      }
  }
  ...
  if (Work->do_extend)
  {
      ...
      { if (! (umfdi_extend_front (Numeric, Work))) { return ((-1)) ; }} ;
  }
  else
  {

      { if (! (umfdi_create_element (Numeric, Work, Symbolic))) { return ((-1)) ; }} ;
      { if (! (umfdi_init_front (Numeric, Work))) { return ((-1)) ; }} ;
  }
  ...
  if (fixQ)
  {
      umfdi_assemble_fixq (Numeric, Work) ;
  }
  else
  {
      umfdi_assemble (Numeric, Work) ;
  }
  ...
  umfdi_scale_column (Numeric, Work) ;
  ...
  if (evaporate)
  {
      ...
      (void) umfdi_create_element (Numeric, Work, Symbolic) ;
      Work->fnrows = 0 ;
      Work->fncols = 0 ;
  }
     }
...
# 270 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c"
 ...
 Work->fncols = 0 ;
    ...
    umfdi_kernel_wrapup (Numeric, Symbolic, Work) ;
