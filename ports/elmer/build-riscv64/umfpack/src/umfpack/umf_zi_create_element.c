# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_create_element.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_create_element.c"
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_create_element.c"
...
# 18 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_create_element.c" 2
...
# 19 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_create_element.c" 2
...
# 20 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_create_element.c" 2
...
# 21 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_create_element.c" 2
...
# 22 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_create_element.c" 2





static void copy_column (int len, DoubleComplex *X, DoubleComplex *Y)
{
    int i ;
#pragma ivdep
    for (i = 0 ; i < len ; i++)
...
# 69 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_create_element.c"
    ;
    ;
...
#pragma ivdep
 ...
 Row_degree [Frows [i]] += fncols ;
    ...
    E = Work->E ;
    max_mark = 0x7fffffff 
# 125 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_create_element.c"
              - (2*(nn)+1) ;
...
# 214 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_create_element.c"
    needunits = 0 ;
    got_memory = (0) ;
    eloc = umfzi_mem_alloc_element (Numeric, fnrows, fncols, &Rows, &Cols, &C,
 &needunits, &ep) ;
 ...
 ;
 if (!umfzi_get_memory (Numeric, Work, needunits, r2, c2, do_Fcpos))
 {
...
# 315 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_create_element.c"
 Fcol += fnr_curr ;
 C += fnrows ;
    }
 ...
 for (tuple.f = 0 ; tuple.f < fncols ; tuple.f++)
 {
  ...
  needunits = (((((sizeof (Tuple) * (len + 1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
     ...
     if (needunits > size)
     {
                               ...
                               ;
# 437 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_create_element.c"
  needunits = (((2*needunits) < ((int) (((((sizeof (Tuple) * (nn))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))))) ? (2*needunits) : ((int) (((((sizeof (Tuple) * (nn))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))))) ;
  t2 = umfzi_mem_alloc_tail_block (Numeric, needunits) ;
  if (!t2)
  {
      ...
      ;
      return (umfzi_get_memory (Numeric, Work, 0, r2, c2,do_Fcpos));
  }
  Col_tuples [col] = t2 ;
  tp2 = (Tuple *) (Memory + t2) ;
  if (t1)
   ...
   *tp2++ = *tp1++ ;
      ...
      umfzi_mem_free_tail_block (Numeric, t1) ;
  }
     }
 ...
 for (tuple.f = 0 ; tuple.f < fnrows ; tuple.f++)
 {
  ...
  needunits = (((((sizeof (Tuple) * (len + 1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
     ...
     if (needunits > size)
     {
                               ...
                               ;
# 540 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_create_element.c"
  needunits = (((2*needunits) < ((int) (((((sizeof (Tuple) * (nn))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))))) ? (2*needunits) : ((int) (((((sizeof (Tuple) * (nn))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))))) ;
  t2 = umfzi_mem_alloc_tail_block (Numeric, needunits) ;
  if (!t2)
  {
...
# 603 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_create_element.c"
    return ((1)) ;
}
