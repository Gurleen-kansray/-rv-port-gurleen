...
)
{
 ...
 Info [38] = 0 ;
    ...
    {
 amd_l1 (n, Ap, Ai, Q, Qinv, Sdeg, Clen, Ci, amd_Control, amd_Info) ;
...
# 485 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
 ...
 umfdl_symbolic_usage (n_row, n_col, n_col, n_col, n_col, (1)) ;

    if (((!((dClen * sizeof (long)) * (1.0+1e-8) <= (double) 0x7fffffffffffffffL
# 506 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
       )) || ((dClen * sizeof (long)) != (dClen * sizeof (long)))))
    {
...
# 742 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
 ...
 if (Quser != (long *) 0)
 {
     ...
     Rp = Ci ;
     Ri = Ci + (n_row) + 1 ;
     (void) umfdl_transpose (n2, n2, Sp, Si, (double *) 0,
  (long *) 0, (long *) 0, 0,
  Rp, Ri, (double *) 0, Wq, (0)
...
# 864 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
    ...
    {
 double sym2 ;
 long *Blen, *W, nz_papat, nzd2, nweak, unmatched, Clen3 ;
...
# 883 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
 SW->Rperm_2by2 = (long *) umf_l_malloc (nn, sizeof (long)) ;
 Rperm_2by2 = SW->Rperm_2by2 ;
 if (Rperm_2by2 == (long *) 0)
 {
     ;
     Info [0] = (-1) ;
     error (&Symbolic, SW) ;
 ...
 if (scale != 0)
 {
     SW->Rs = (double *) umf_l_malloc (nn, sizeof (double)) ;
     if (SW->Rs == (double *) 0)
     {
  ;
  Info [0] = (-1) ;
...
# 922 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
 ...
 (void) umfdl_transpose (n2, n2, Sp, Si, (double *) 0, Rperm_2by2,
     (long *) 0, 0, Rp, Ri, (double *) 0, W, (0)
...
# 954 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
 ...
 nz_papat = amd_l_aat (n2, Rp, Ri, Sdeg, Wq, amd_Info) ;
 sym2 = amd_Info [3] ;
 nzd2 = amd_Info [4] ;
...
# 1280 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
 ...
 long *W, *Bp, *Bi, *Cperm2, ok, *P, Clen2, bsize, Clen0 ;
...
# 1401 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
 ...
 (void) umfdl_transpose (n_row - n1, n_col - n1 - nempty_col,
     Sp, Si, (double *) 0,
     P, (long *) 0, 0, Bp, Bi, (double *) 0, W, (0)
...
# 1511 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
 ...
 = (max_rdeg > dense_row_threshold) ? (n_col - n1 - nempty_col) : 0 ;
    ...
    Info [14] = umfdl_symbolic_usage (n_row, n_col, nchains,
...
# 2060 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
    ...
    tail_usage += (((((sizeof (long *) * (n_row+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (double *) * (n_row+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + 2 ;
    dtail_usage += (ceil ((sizeof (long *) * ((double) n_row+1)) / sizeof (Unit))) + (ceil ((sizeof (double *) * ((double) n_row+1)) / sizeof (Unit))) + 2 ;
 ...
 dunz += unz ;
                                                   ...
                                                   ;
 head_usage += (((((sizeof (long) * (lnz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (double) * (lnz))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
      + (((((sizeof (long) * (unz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (double) * (unz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 dhead_usage += (ceil ((sizeof (long) * ((double) lnz)) / sizeof (Unit))) + (ceil ((sizeof (double) * ((double) lnz)) / sizeof (Unit)))
      + (ceil ((sizeof (long) * ((double) unz)) / sizeof (Unit))) + (ceil ((sizeof (double) * ((double) unz)) / sizeof (Unit))) ;
    }
    ;
 ...
 if (esize > 0)
 {
     tail_usage += ((((((sizeof (Element) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (long) * ((1) + (esize)))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (double) * ((1) * (esize)))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) + 1 ;
     dtail_usage += ((ceil ((sizeof (Element) * ((double) 1)) / sizeof (Unit))) + (ceil ((sizeof (long) * ((double) (1) + (esize))) / sizeof (Unit))) + (ceil ((sizeof (double) * ((double) (1) * (esize))) / sizeof (Unit)))) + 1 ;
 }
    }
 ...
 for (k = n1 ; k < n_row - nempty_row ; k++)
 {
     ...
     {
  tail_usage += ((((((sizeof (Element) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (long) * ((rdeg) + (1)))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (double) * ((rdeg) * (1)))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) + 1 ;
  dtail_usage += ((((((sizeof (Element) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (long) * ((rdeg) + (1)))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (double) * ((rdeg) * (1)))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) + 1 ;
  nrow_elements++ ;
     }
 }
 ...
 for (col = n1 ; col < n_col ; col++)
 {
    ...
    tail_usage -= (((((sizeof (long *) * (n_row+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (double *) * (n_row+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
    dtail_usage -= (ceil ((sizeof (long *) * ((double) n_row+1)) / sizeof (Unit))) + (ceil ((sizeof (double *) * ((double) n_row+1)) / sizeof (Unit))) ;
 ...
 for (i = f1 ; i <= f2 ; i++)
 {
  ...
  ;
  dtail_usage -= (((ceil ((sizeof (Element) * ((double) 1)) / sizeof (Unit))) + (ceil ((sizeof (long) * ((double) (cc) + (cr))) / sizeof (Unit))) + (ceil ((sizeof (double) * ((double) (cc) * (cr))) / sizeof (Unit)))) + 1 + (cr + cc) * (((((sizeof (Tuple) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
  ...
  dtail_usage += (((ceil ((sizeof (Element) * ((double) 1)) / sizeof (Unit))) + (ceil ((sizeof (long) * ((double) (c) + (r))) / sizeof (Unit))) + (ceil ((sizeof (double) * ((double) (c) * (r))) / sizeof (Unit)))) + 1 + (r + c) * (((((sizeof (Tuple) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
...
)
{
    if (SW)
    {
 SW->Rperm_2by2 = (long *) umf_l_free ((void *) SW->Rperm_2by2) ;
