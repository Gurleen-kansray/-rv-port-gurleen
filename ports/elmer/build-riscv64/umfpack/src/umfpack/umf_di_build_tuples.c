# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_build_tuples.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_build_tuples.c"
# 20 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_build_tuples.c"
...
# 21 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_build_tuples.c" 2
...
# 22 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_build_tuples.c" 2
 ...
 *Col_tuples, *Col_degree, *Col_tlen, n1 ;
    ...
    n1 = Work->n1 ;
                     ...
                     ;
# 67 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_build_tuples.c"
    for (row = n1 ; row < n_row ; row++)
    {
 if ((Row_degree [row] >= 0))
 {
     Row_tuples [row] = umfdi_mem_alloc_tail_block (Numeric,
 ...
 if ((Col_degree [col] >= 0))
 {
     Col_tuples [col] = umfdi_mem_alloc_tail_block (Numeric,
...
# 110 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_build_tuples.c"
    for (e = 1 ; e <= nel ; e++)
    {
 ;
 ;
 p = Numeric->Memory + E [e] ;
 { { ; ; ; ep = (Element *) p ; p += (((((sizeof (Element) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ; Cols = (int *) p ; } ; ncols = ep->ncols ; Rows = Cols + ncols ; } ;
 nrows = ep->nrows ;
 ;
 ;
 ;
...
# 157 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_build_tuples.c"
    ;
    return ((1)) ;
}
