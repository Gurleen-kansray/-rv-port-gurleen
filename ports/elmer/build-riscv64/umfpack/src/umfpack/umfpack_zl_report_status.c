# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_status.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_status.c"
# 16 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_status.c"
...
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_status.c" 2
...
)
{
 ...
 case (1):
     { (void) printf ("WARNING: matrix is singular\n") ; } ;
     break ;
 ...
 case (-3):
     { (void) printf ("ERROR: Numeric object is invalid\n") ; } ;
     break ;

 case (-4):
     { (void) printf ("ERROR: Symbolic object is invalid\n") ; } ;
     break ;

 case (-5):
     { (void) printf ("ERROR: required argument(s) missing\n") ; } ;
     break ;

 case (-6):
     { (void) printf ("ERROR: dimension (n_row or n_col) must be > 0\n") ; } ;
     break ;

 case (-8):
     { (void) printf ("ERROR: input matrix is invalid\n") ; } ;
     break ;

 case (-13):
     { (void) printf ("ERROR: system argument invalid\n") ; } ;
     break ;

 case (-15):
     { (void) printf ("ERROR: invalid permutation\n") ; } ;
     break ;

 case (-11):
     { (void) printf ("ERROR: pattern of matrix (Ap and/or Ai) has changed\n") ; } ;
     break ;
 ...
 default:
     { (void) printf ("ERROR: Unrecognized error code: ""%ld""\n", status) ; } ;
