...
# 128 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_triplet_to_col.c"
 Rx = (double *) umf_i_malloc (nz+1, sizeof (double)) ;
 ...
 if (!Rx)
 {
    ...
    {
 ;
 Map2 = (int *) umf_i_malloc (nz+1, sizeof (int)) ;
 if (!Map2)
 {
     ;
     (void) umf_i_free ((void *) Rx) ;
     ;
     return ((-1)) ;
 }
    }

    Rj = (int *) umf_i_malloc (nz+1, sizeof (int)) ;
    Rp = (int *) umf_i_malloc (n_row+1, sizeof (int)) ;
    RowCount = (int *) umf_i_malloc (n_row, sizeof (int)) ;
    W = (int *) umf_i_malloc (nn, sizeof (int)) ;
    if (!Rj || !Rp || !RowCount || !W)
    {
 ;
 (void) umf_i_free ((void *) Rx) ;
 (void) umf_i_free ((void *) Map2) ;
 (void) umf_i_free ((void *) Rp) ;
 (void) umf_i_free ((void *) Rj) ;
 (void) umf_i_free ((void *) RowCount) ;
 ...
 if (do_values)
 {
     status = umfdi_triplet_map_x (n_row, n_col, nz, Ti, Tj, Ap, Ai, Rp,
 ...
 {
     status = umfdi_triplet_map_nox (n_row, n_col, nz, Ti, Tj, Ap, Ai, Rp,
 ...
 if (do_values)
 {
     status = umfdi_triplet_nomap_x (n_row, n_col, nz, Ti, Tj, Ap, Ai, Rp,
  Rj, W, RowCount , Tx, Ax, Rx
 ...
 {
     status = umfdi_triplet_nomap_nox (n_row, n_col, nz, Ti, Tj, Ap, Ai,
  Rp, Rj, W, RowCount) ;
 }
    }
