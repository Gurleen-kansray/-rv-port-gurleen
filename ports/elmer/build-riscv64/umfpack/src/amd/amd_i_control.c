# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_control.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_control.c"
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_control.c"
...
# 18 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_control.c" 2
...
)
{
 ...
 aggressive = 1 ;
    ...
    if (alpha < 0)
    {
 { (void) printf ("    no rows treated as dense\n") ; } ;
    }
    else
    {
 { (void) printf ( "    (rows with more than max (%g * sqrt (n), 16) entries are\n" "    considered \"dense\", and placed last in output permutation)\n", alpha) ; }
    ...
    if (aggressive)
    {
 { (void) printf ("    aggressive absorption:  yes\n\n") ; } ;
    }
    else
    {
 { (void) printf ("    aggressive absorption:  no\n\n") ; } ;
    }
}
