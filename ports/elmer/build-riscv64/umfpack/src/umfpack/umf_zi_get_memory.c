...
# 50 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_get_memory.c"
 ...
 if ((Col_degree [col] >= 0))
 {
    ...
    needunits += umfzi_tuple_lengths (Numeric, Work, &tsize) ;
    nsize += tsize ;
    needunits += 2 ;
...
# 98 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_get_memory.c"
 ...
 umfzi_mem_free_tail_block (Numeric, i) ;
 ...
 if (costly)
 {
    ...
    umfzi_garbage_collection (Numeric, Work, r2, c2, do_Fcpos) ;





    return (umfzi_build_tuples (Numeric, Work)) ;
}
