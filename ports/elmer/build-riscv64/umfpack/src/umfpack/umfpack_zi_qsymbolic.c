...
# 485 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
 ...
 umfzi_symbolic_usage (n_row, n_col, n_col, n_col, n_col, (1)) ;
...
# 742 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
 ...
 if (Quser != (int *) 0)
 {
     ...
     Rp = Ci ;
     Ri = Ci + (n_row) + 1 ;
     (void) umfzi_transpose (n2, n2, Sp, Si, (double *) 0,
  (int *) 0, (int *) 0, 0,
  Rp, Ri, (double *) 0, Wq, (0)
...
# 922 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
 ...
 (void) umfzi_transpose (n2, n2, Sp, Si, (double *) 0, Rperm_2by2,
...
# 1401 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
 ...
 (void) umfzi_transpose (n_row - n1, n_col - n1 - nempty_col,
     Sp, Si, (double *) 0,
...
# 1511 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
 ...
 = (max_rdeg > dense_row_threshold) ? (n_col - n1 - nempty_col) : 0 ;
    ...
    Info [14] = umfzi_symbolic_usage (n_row, n_col, nchains,
...
# 2060 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_qsymbolic.c"
    ...
    tail_usage += (((((sizeof (int *) * (n_row+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (DoubleComplex *) * (n_row+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + 2 ;
    dtail_usage += (ceil ((sizeof (int *) * ((double) n_row+1)) / sizeof (Unit))) + (ceil ((sizeof (DoubleComplex *) * ((double) n_row+1)) / sizeof (Unit))) + 2 ;
 ...
 dunz += unz ;
                                                   ...
                                                   ;
 head_usage += (((((sizeof (int) * (lnz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (DoubleComplex) * (lnz))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
      + (((((sizeof (int) * (unz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (DoubleComplex) * (unz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 dhead_usage += (ceil ((sizeof (int) * ((double) lnz)) / sizeof (Unit))) + (ceil ((sizeof (DoubleComplex) * ((double) lnz)) / sizeof (Unit)))
      + (ceil ((sizeof (int) * ((double) unz)) / sizeof (Unit))) + (ceil ((sizeof (DoubleComplex) * ((double) unz)) / sizeof (Unit))) ;
    }
    ;
 ...
 if (esize > 0)
 {
     tail_usage += ((((((sizeof (Element) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (int) * ((1) + (esize)))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (DoubleComplex) * ((1) * (esize)))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) + 1 ;
     dtail_usage += ((ceil ((sizeof (Element) * ((double) 1)) / sizeof (Unit))) + (ceil ((sizeof (int) * ((double) (1) + (esize))) / sizeof (Unit))) + (ceil ((sizeof (DoubleComplex) * ((double) (1) * (esize))) / sizeof (Unit)))) + 1 ;
 }
    }
 ...
 for (k = n1 ; k < n_row - nempty_row ; k++)
 {
     ...
     {
  tail_usage += ((((((sizeof (Element) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (int) * ((rdeg) + (1)))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (DoubleComplex) * ((rdeg) * (1)))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) + 1 ;
  dtail_usage += ((((((sizeof (Element) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (int) * ((rdeg) + (1)))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (DoubleComplex) * ((rdeg) * (1)))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) + 1 ;
  nrow_elements++ ;
     }
 }
 ...
 for (col = n1 ; col < n_col ; col++)
 {
    ...
    tail_usage -= (((((sizeof (int *) * (n_row+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (DoubleComplex *) * (n_row+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
    dtail_usage -= (ceil ((sizeof (int *) * ((double) n_row+1)) / sizeof (Unit))) + (ceil ((sizeof (DoubleComplex *) * ((double) n_row+1)) / sizeof (Unit))) ;
 ...
 for (i = f1 ; i <= f2 ; i++)
 {
  ...
  ;
  dtail_usage -= (((ceil ((sizeof (Element) * ((double) 1)) / sizeof (Unit))) + (ceil ((sizeof (int) * ((double) (cc) + (cr))) / sizeof (Unit))) + (ceil ((sizeof (DoubleComplex) * ((double) (cc) * (cr))) / sizeof (Unit)))) + 1 + (cr + cc) * (((((sizeof (Tuple) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
  ...
  dtail_usage += (((ceil ((sizeof (Element) * ((double) 1)) / sizeof (Unit))) + (ceil ((sizeof (int) * ((double) (c) + (r))) / sizeof (Unit))) + (ceil ((sizeof (DoubleComplex) * ((double) (c) * (r))) / sizeof (Unit)))) + 1 + (r + c) * (((((sizeof (Tuple) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
