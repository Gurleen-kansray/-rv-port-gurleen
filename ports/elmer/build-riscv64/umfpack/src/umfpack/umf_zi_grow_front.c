# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
# 13 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
...
# 14 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c" 2
...
# 15 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c" 2
...
# 16 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c" 2
...
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c" 2

 int umfzi_grow_front
(
    NumericType *Numeric,
    int fnr2,
    int fnc2,
...
# 52 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
    Fcols = Work->Fcols ;
    Fcpos = Work->Fcpos ;
    E = Work->E ;
    ...
    if (((!(((double) fnr_min * (double) fnc_min * sizeof (DoubleComplex)) * (1.0+1e-8) <= (double) 0x7fffffff
# 84 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
       )) || (((double) fnr_min * (double) fnc_min * sizeof (DoubleComplex)) != ((double) fnr_min * (double) fnc_min * sizeof (DoubleComplex)))))
    {
 ...
 return ((0)) ;
    ...
    if (((!((s * sizeof (DoubleComplex)) * (1.0+1e-8) <= (double) 0x7fffffff
# 110 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
       )) || ((s * sizeof (DoubleComplex)) != (s * sizeof (DoubleComplex)))))
    {



 double a = 0.9 * sqrt ((0x7fffffff 
# 115 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
                                / sizeof (DoubleComplex)) / s) ;
 ...
 ;
 umfzi_mem_free_tail_block (Numeric, E [0]) ;
 E [0] = 0 ;
...
# 166 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
    ;
    eloc = umfzi_mem_alloc_tail_block (Numeric, (((((sizeof (DoubleComplex) * (newsize))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
 ...
 ;
 if (!umfzi_get_memory (Numeric, Work, 1 + (((((sizeof (DoubleComplex) * (newsize))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))),
