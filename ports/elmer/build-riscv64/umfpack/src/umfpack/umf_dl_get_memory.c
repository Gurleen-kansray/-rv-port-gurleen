...
# 50 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_get_memory.c"
 ...
 if ((Col_degree [col] >= 0))
 {
    ...
    needunits += umfdl_tuple_lengths (Numeric, Work, &tsize) ;
    nsize += tsize ;
    needunits += 2 ;
...
# 98 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_get_memory.c"
 ...
 umfdl_mem_free_tail_block (Numeric, i) ;
 ...
 if (costly)
 {
    ...
    umfdl_garbage_collection (Numeric, Work, r2, c2, do_Fcpos) ;





    return (umfdl_build_tuples (Numeric, Work)) ;
}
