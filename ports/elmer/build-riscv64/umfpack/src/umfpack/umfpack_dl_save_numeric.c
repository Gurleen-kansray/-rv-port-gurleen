# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_save_numeric.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_save_numeric.c"
# 16 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_save_numeric.c"
...
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_save_numeric.c" 2
...
# 18 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_save_numeric.c" 2
# 33 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_save_numeric.c"
 long umfpack_dl_save_numeric
(
    void *NumericHandle,
    char *user_filename
)
{
 ...
 return ((-17)) ;
    ...
    { ; if (fwrite (Numeric, sizeof (NumericType), 1, f) != 1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->D, sizeof (double), (((Numeric->n_row) < (Numeric->n_col)) ? (Numeric->n_row) : (Numeric->n_col))+1, f) != (((Numeric->n_row) < (Numeric->n_col)) ? (Numeric->n_row) : (Numeric->n_col))+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->Rperm, sizeof (long), Numeric->n_row+1, f) != Numeric->n_row+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->Cperm, sizeof (long), Numeric->n_col+1, f) != Numeric->n_col+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->Lpos, sizeof (long), Numeric->npiv+1, f) != Numeric->npiv+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->Lilen, sizeof (long), Numeric->npiv+1, f) != Numeric->npiv+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->Lip, sizeof (long), Numeric->npiv+1, f) != Numeric->npiv+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->Upos, sizeof (long), Numeric->npiv+1, f) != Numeric->npiv+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->Uilen, sizeof (long), Numeric->npiv+1, f) != Numeric->npiv+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->Uip, sizeof (long), Numeric->npiv+1, f) != Numeric->npiv+1) { fclose (f) ; return ((-17)) ; } } ;
    if (Numeric->scale != 0)
    {
 { ; if (fwrite (Numeric->Rs, sizeof (double), Numeric->n_row, f) != Numeric->n_row) { fclose (f) ; return ((-17)) ; } } ;
    }
    if (Numeric->ulen > 0)
    {
 { ; if (fwrite (Numeric->Upattern, sizeof (long), Numeric->ulen+1, f) != Numeric->ulen+1) { fclose (f) ; return ((-17)) ; } } ;
    }
    { ; if (fwrite (Numeric->Memory, sizeof (Unit), Numeric->size, f) != Numeric->size) { fclose (f) ; return ((-17)) ; } } ;
