...
)
{
    ...
    double relax1 ;
    double *Flblock, *Fublock, *Fs, *Fcblock, *C, *Wx, *Wy, *Fu, *Flublock,
 *Flu ;
...
# 510 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_local_search.c"
 for (j = 0 ; j < fnpiv ; j++)
 {
     double Fuj, *Flub = Flblock + j * fnr_curr ;
     Fuj = Flu [j] ;
     if (((Fuj) != 0.))
     {
#pragma ivdep
...
# 721 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_local_search.c"
 status = umfdi_row_search (Numeric, Work, Symbolic,
...
# 1081 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_local_search.c"
 ...
 if (status == (1))
 {
     ...
     ;
     Col_tlen [pivcol [1]] = 0 ;
     umfdi_mem_free_tail_block (Numeric, Col_tuples [pivcol [1]]) ;
