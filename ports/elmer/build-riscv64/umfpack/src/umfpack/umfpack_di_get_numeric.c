# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
# 26 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
...
# 27 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c" 2
...
# 28 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c" 2
...
# 29 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c" 2
...
# 30 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c" 2
...
)
{
 ...
 return ((-3)) ;
    ...
    if (getL || getU)
    {
 Wi = (int *) umf_i_malloc (nn, sizeof (int)) ;
 Pattern = (int *) umf_i_malloc (nn, sizeof (int)) ;
 if (!Wi || !Pattern)
 {
     (void) umf_i_free ((void *) Wi) ;
     (void) umf_i_free ((void *) Pattern) ;
     ;
     ;
     return ((-1)) ;
 }
 ...
 get_U (Up, Ui, Ux,
    ...
    {
 D = Numeric->D ;
# 206 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
 {
     D = Numeric->D ;
     for (k = 0 ; k < n_inner ; k++)
     {
...
# 323 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
static void get_L
(
    int Lp [ ],
    int Lj [ ],
...
# 352 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
    ;
    n_row = Numeric->n_row ;
    n_col = Numeric->n_col ;
    n_inner = (((n_row) < (n_col)) ? (n_row) : (n_col)) ;
...
#pragma ivdep
 ...
 xp = (double *) (Numeric->Memory + lp + (((((sizeof (int) * (llen))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
 ...
 if (deg > 0)
 {
  ...
  if (((value) != 0.))
  {
      p = Wi [row]++ ;
      Lj [p] = k ;
# 512 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
      Lx [p] = value ;
 ...
 for (j = 0 ; j < deg ; j++)
 {
  ...
  p = Wi [row]++ ;
  Lj [p] = k ;
# 585 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
  Lx [p] = value ;
 ...
 p = Wi [row]++ ;
 Lj [p] = row ;
# 609 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
 Lx [p] = 1. ;


 ;
    }
# 624 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
    ;
}
# 688 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
static void get_U
(
    int Up [ ],
    int Ui [ ],
...
# 720 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
    ;
    n_col = Numeric->n_col ;
    n1 = Numeric->n1 ;
    npiv = Numeric->npiv ;
 ...
 {
     up = -up ;
     xp = (double *) (Numeric->Memory + up + (((((sizeof (int) * (ulen))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
 }
 else
 {
 ...
 if (((D [col]) != 0.))
 {
     p = --(Wi [col]) ;
     Ui [p] = col ;
# 903 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
     Ux [p] = D [col] ;
 ...
 for (j = deg-1 ; j >= 0 ; j--)
 {
  ...
  p = --(Wi [col]) ;
  Ui [p] = k ;
# 966 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
  Ux [p] = value ;
 ...
 if (deg > 0)
 {
  ...
  if (((value) != 0.))
  {
      p = --(Wi [col]) ;
      Ui [p] = k ;
# 1041 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
      Ux [p] = value ;
...
# 1057 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
}
