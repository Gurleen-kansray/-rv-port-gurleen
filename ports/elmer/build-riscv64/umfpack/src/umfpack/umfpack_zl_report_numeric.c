...
)
{
 ...
 { (void) printf ("    frontal matrix allocation parameter used:   %g\n", Numeric->front_alloc_init) ; }
                                 ;
 { (void) printf ("    final total size of Numeric object (Units): ""%ld""\n", numeric_size) ; }
                    ;
 { (void) printf ("    final total size of Numeric object (MBytes): %.1f\n", (((numeric_size) * sizeof (Unit)) / 1048576.0)) ; }
                             ;
 { (void) printf ("    peak size of variable-size part (Units):    ""%ld""\n", Numeric->max_usage) ; }
                          ;
 { (void) printf ("    peak size of variable-size part (MBytes):   %.1f\n", (((Numeric->max_usage) * sizeof (Unit)) / 1048576.0)) ; }
                                   ;
 { (void) printf ("    largest actual frontal matrix size:         ""%ld""\n", Numeric->maxfrsize) ; }
                          ;
 { (void) printf ("    memory defragmentations:                    ""%ld""\n", Numeric->ngarbage) ; }
                         ;
 { (void) printf ("    memory reallocations:                       ""%ld""\n", Numeric->nrealloc) ; }
                         ;
 { (void) printf ("    costly memory reallocations:                ""%ld""\n", Numeric->ncostly) ; }
                        ;
 { (void) printf ("    entries in compressed pattern (L and U):    ""%ld""\n", Numeric->isize) ; }
                      ;
 { (void) printf ("    number of nonzeros in L (excl diag):        ""%ld""\n", Numeric->lnz) ; }
                    ;
 { (void) printf ("    number of entries stored in L (excl diag):  ""%ld""\n", Numeric->nLentries) ; }
                          ;
 { (void) printf ("    number of nonzeros in U (excl diag):        ""%ld""\n", Numeric->unz) ; }
                    ;
 { (void) printf ("    number of entries stored in U (excl diag):  ""%ld""\n", Numeric->nUentries) ; }
                          ;
 { (void) printf ("    factorization floating-point operations:    %g\n", Numeric->flops) ; }
                      ;
 { (void) printf ("    number of nonzeros on diagonal of U:        ""%ld""\n", Numeric->nnzpiv) ; }
                       ;
 ...
 (void) umfzl_report_vector (n_row, Numeric->Rs, (double *) 0,
     prl, (0), (1)) ;
    }
    else
    {
 ...
 return ((-3)) ;
    ...
    { if (prl >= (4)) { { (void) printf ("\ndiagonal of U: ") ; } ; } } ;
    (void) umfzl_report_vector (n_inner, (double *) Numeric->D, (double *) 0,
 prl, (0), (0)) ;
 ...
 *Lip, newLchain, llen, prl1, pos, lp, p, npiv, n1, *Li ;
 ...
 { if (prl >= (4)) { { (void) printf ("\n    column ""%ld"":", (k)) ; } ; } } ;
 { if (prl >= (4)) { { (void) printf ("  length ""%ld"".\n", deg) ; } ; } } ;
 for (j = 0 ; j < deg ; j++)
 {
     row = Li [j] ;
     { if (prl >= (4)) { { (void) printf ("\trow ""%ld"" : ", (row)) ; } ; } } ;
 ...
 if (pos != (-1))
 {
     { if (prl >= (4)) { { (void) printf ("  remove row ""%ld"" at position ""%ld"".", (Pattern [pos]), (pos)) ; } ; } }
                                       ;
 ...
 if (llen > 0)
 {
     { if (prl >= (4)) { { (void) printf ("  add ""%ld"" entries.", llen) ; } ; } } ;
 ...
 { if (prl >= (4)) { { (void) printf ("  length ""%ld"".", deg) ; } ; } } ;
 if (newLchain)
 {
 ...
 *Uip, n_col, ulen, p, newUchain, up, npiv, n1, *Ui ;
 ...
 {
     col = Pattern [j] ;
     { if (prl >= (4)) { { (void) printf ("\tcol ""%ld"" :", (col)) ; } ; } } ;
     if (prl >= 4) { if ((((*xp).component [0]) != 0.)) { { (void) printf (" (%g", (*xp).component [0]) ; } ; } else { { (void) printf (" (0") ; } ; } if ((((*xp).component [1]) < 0.)) { { (void) printf (" - %gi)", -(*xp).component [1]) ; } ; } else if ((((*xp).component [1]) == 0.)) { { (void) printf (" + 0i)") ; } ; } else { { (void) printf (" + %gi)", (*xp).component [1]) ; } ; } } ;
     if (col <= k || col >= n_col)
     {
  return ((0)) ;
 ...
 if (newUchain)
 {
     ...
     {
  deg = ulen ;
  { if (prl >= (4)) { { (void) printf ("length ""%ld"".  End of Uchain.\n", deg) ; } ; } } ;
 ...
 else
 {
     if (ulen > 0)
     {
  { if (prl >= (4)) { { (void) printf ("remove ""%ld"" entries.  ", ulen) ; } ; } } ;
     }
     deg -= ulen ;
     if (deg < 0)
     {
  ...
  { if (prl >= (4)) { { (void) printf ("add column ""%ld"" at position ""%ld"".  ", (k), (pos)) ; } ; } }
                               ;
  if (pos < 0 || pos > deg)
  {
      return ((0)) ;
