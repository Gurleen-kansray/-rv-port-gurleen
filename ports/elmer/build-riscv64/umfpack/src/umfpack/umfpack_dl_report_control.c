...
# 49 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_control.c"
...
# 65 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_control.c"
    ...
    { (void) printf ("    ""%ld"": dense row parameter:    %g\n", (long) (1), drow) ; }
                                         ;
    { (void) printf ("        \"dense\" rows have    > max (16, (%g)*16*sqrt(n_col)" " entries)\n", drow) ; }
                       ;
    { (void) printf ("    ""%ld"": dense column parameter: %g\n", (long) (2), dcol) ; }
                                         ;
    ...
    { (void) printf ("    ""%ld"": pivot tolerance: %g\n", (long) (3), relpt) ; }
                                                ;
    ...
    nb = (((1) > (nb)) ? (1) : (nb)) ;
    { (void) printf ("    ""%ld"": block size for dense matrix kernels: ""%ld""\n", (long) (4), nb) ; }
                                        ;
 ...
 strategy = 0 ;
    ...
    { (void) printf ("    ""%ld"": strategy: ""%ld", (long) (5), strategy) ; }
                                            ;
 ...
 { (void) printf (" (auto)\n") ; } ;
    ...
    if (alloc_init >= 0)
    {
 { (void) printf ("    ""%ld"": initial allocation ratio: %g\n", (long) (6), alloc_init) ; }
                                                ;
    }
    else
    {
 s = -alloc_init ;
 s = (((1) > (s)) ? (1) : (s)) ;
 { (void) printf ("    ""%ld"": initial allocation (in Units): ""%ld""\n", (long) (6), s) ; }
                                       ;
    }
    ...
    { (void) printf ("    ""%ld"": max iterative refinement steps: ""%ld""\n", (long) (7), irstep) ; }
                                        ;
    ...
    { (void) printf ("    ""%ld"": 2-by-2 pivot tolerance: %g\n", (long) (12), tol) ; }
                                             ;
    ...
    { (void) printf ("    ""%ld"": Q fixed during numerical factorization: %g ", (long) (13), force_fixQ) ; }
                                          ;
    if (force_fixQ > 0)
    {
 { (void) printf ("(yes)\n") ; } ;
 ...
 { (void) printf ("(auto)\n") ; } ;
    ...
    { (void) printf ("    ""%ld"": AMD dense row/col parameter:    %g\n", (long) (14), amd_alpha) ; }
                                              ;
    if (amd_alpha < 0)
    {
 ...
 { (void) printf ("       \"dense\" rows/columns have > max (16, (%g)*sqrt(n))" " entries\n", amd_alpha) ; }
    ...
    { (void) printf ("    ""%ld"": diagonal pivot tolerance: %g\n" "        Only used if diagonal pivoting is attempted.\n", (long) (15), relpt2) ; }
 ...
 scale = 1 ;
    ...
    { (void) printf ("    ""%ld"": scaling: ""%ld", (long) (16), scale) ; } ;
    if (scale == 0)
    {
 { (void) printf (" (no)") ; } ;
    }
 ...
 { (void) printf (" (divide each row by max. abs. value in each row)") ; } ;
    ...
    {
 { (void) printf ("    ""%ld"": frontal matrix allocation ratio: %g\n", (long) (17), front_alloc_init) ; }
                                                            ;
    }
    else
    {
 s = -front_alloc_init ;
 s = (((1) > (s)) ? (1) : (s)) ;
 { (void) printf ("    ""%ld"": initial frontal matrix size (# of Entry's): ""%ld""\n", (long) (17), s) ; }
                                             ;
    }
    ...
    { (void) printf ("    ""%ld"": drop tolerance: %g\n", (long) (18), droptol) ; }
                                          ;
    ...
    { (void) printf ("    ""%ld"": AMD and COLAMD aggressive absorption: %g", (long) (19), aggr) ; }
                                          ;
    if (aggr != 0.0)
    {
 { (void) printf (" (yes)\n") ; } ;
