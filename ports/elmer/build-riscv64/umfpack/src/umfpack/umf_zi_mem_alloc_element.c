# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_mem_alloc_element.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_mem_alloc_element.c"
# 16 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_mem_alloc_element.c"
...
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_mem_alloc_element.c" 2
...
# 18 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_mem_alloc_element.c" 2
...
)
{
    ...
    *size = ((((((sizeof (Element) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (int) * ((ncols) + (nrows)))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (DoubleComplex) * ((ncols) * (nrows)))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
    if (((!((((ceil ((sizeof (Element) * ((double) 1)) / sizeof (Unit))) + (ceil ((sizeof (int) * ((double) (ncols) + (nrows))) / sizeof (Unit))) + (ceil ((sizeof (DoubleComplex) * ((double) (ncols) * (nrows))) / sizeof (Unit)))) + 1) * (1.0+1e-8) <= (double) 0x7fffffff
# 40 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_mem_alloc_element.c"
       )) || ((((ceil ((sizeof (Element) * ((double) 1)) / sizeof (Unit))) + (ceil ((sizeof (int) * ((double) (ncols) + (nrows))) / sizeof (Unit))) + (ceil ((sizeof (DoubleComplex) * ((double) (ncols) * (nrows))) / sizeof (Unit)))) + 1) != (((ceil ((sizeof (Element) * ((double) 1)) / sizeof (Unit))) + (ceil ((sizeof (int) * ((double) (ncols) + (nrows))) / sizeof (Unit))) + (ceil ((sizeof (DoubleComplex) * ((double) (ncols) * (nrows))) / sizeof (Unit)))) + 1))))
    {

 return (0) ;
    }

    i = umfzi_mem_alloc_tail_block (Numeric, *size) ;
    (*size)++ ;
    if (!i)
    {
 ;
 return (0) ;
    ...
    *Cols = (int *) p ;
    *Rows = *Cols + ncols ;
    p += (((((sizeof (int) * (ncols + nrows))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
    *C = (DoubleComplex *) p ;
