...
# 214 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
    }
...
#pragma ivdep
 ...
 xp = (DoubleComplex *) (Numeric->Memory + lp + (((((sizeof (int) * (llen))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
...
# 720 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_get_numeric.c"
 ...
 {
     up = -up ;
     xp = (DoubleComplex *) (Numeric->Memory + up + (((((sizeof (int) * (ulen))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
 }
 else
 {
