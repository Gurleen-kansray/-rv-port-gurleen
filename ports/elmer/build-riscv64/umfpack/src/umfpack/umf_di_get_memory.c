# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_get_memory.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_get_memory.c"
# 19 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_get_memory.c"
...
# 20 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_get_memory.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_garbage_collection.h" 1
...
# 21 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_get_memory.c" 2
...
# 22 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_get_memory.c" 2
...
# 23 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_get_memory.c" 2
...
# 24 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_get_memory.c" 2
...
# 25 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_get_memory.c" 2
...
)
{
 ...
 n_row, n_col, *Row_degree, *Col_degree ;
    Unit *mnew, *p ;
# 50 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_get_memory.c"
    n_row = Work->n_row ;
    n_col = Work->n_col ;
 ...
 if ((Col_degree [col] >= 0))
 {
    ...
    needunits += umfdi_tuple_lengths (Numeric, Work, &tsize) ;
    nsize += tsize ;
    needunits += 2 ;
# 93 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_get_memory.c"
    ;
...
# 98 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_get_memory.c"
                            ) / sizeof (Unit) - 1 ;

    newsize = (int) ((1.2) * ((double) minsize)) ;
    nsize *= (1.2) ;
    nsize += 1 ;
 ...
 if (!mnew)
 {
  ...
  newsize = (int) ((0.95) * ((double) newsize)) ;
 ...
 dr = Work->fnr_curr ;
 dc = Work->fnc_curr ;
 Work->Flublock = (double *) (Numeric->Memory + Work->E [0]) ;
 ...
 umfdi_mem_free_tail_block (Numeric, i) ;
 ...
 if (costly)
 {
    ...
    umfdi_garbage_collection (Numeric, Work, r2, c2, do_Fcpos) ;





    return (umfdi_build_tuples (Numeric, Work)) ;
}
