...
# 267 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
  ...
  for (i = 0 ; i < n ; i++)
  {
     ...
     flops += umfdi_lsolve (Numeric, W, Pattern) ;
     flops += umfdi_usolve (Numeric, W, Pattern) ;
...
# 565 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
  ...
  for (i = 0 ; i < n ; i++)
  {
     ...
     flops += umfdi_uhsolve (Numeric, W, Pattern) ;
     flops += umfdi_lhsolve (Numeric, W, Pattern) ;
...
# 838 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
  ...
  for (i = 0 ; i < n ; i++)
  {
     ...
     flops += umfdi_utsolve (Numeric, W, Pattern) ;
     flops += umfdi_ltsolve (Numeric, W, Pattern) ;
 ...
 flops = umfdi_lsolve (Numeric, X, Pattern) ;
 status = (0) ;
 ...
 flops = umfdi_lhsolve (Numeric, X, Pattern) ;
 status = (0) ;
 ...
 flops = umfdi_ltsolve (Numeric, X, Pattern) ;
 status = (0) ;
 ...
 flops = umfdi_usolve (Numeric, X, Pattern) ;
 ...
 flops = umfdi_uhsolve (Numeric, X, Pattern) ;
 ...
 flops = umfdi_utsolve (Numeric, X, Pattern) ;
