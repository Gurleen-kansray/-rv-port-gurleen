# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_info.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_info.c"
# 16 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_info.c"
...
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_info.c" 2
...
)
{
 ...
 { (void) printf ("unknown\n") ; } ;
    ...
    { if (n >= 0) { { (void) printf ("    n, dimension of A:                                  %.20g\n", n) ; } ; }};
    { if (Info [2] >= 0) { { (void) printf ("    nz, number of nonzeros in A:                        %.20g\n", Info [2]) ; } ; }}
                ;
    { if (Info [3] >= 0) { { (void) printf ("    symmetry of A:                                      %.4f\n", Info [3]) ; } ; }}
                      ;
    { if (Info [4] >= 0) { { (void) printf ("    number of nonzeros on diagonal:                     %.20g\n", Info [4]) ; } ; }}
                    ;
    { if (Info [5] >= 0) { { (void) printf ("    nonzeros in pattern of A+A' (excl. diagonal):       %.20g\n", Info [5]) ; } ; }}
                          ;
    { if (Info [6] >= 0) { { (void) printf ("    # dense rows/columns of A+A':                       %.20g\n", Info [6]) ; } ; }}
                    ;


    { if (Info [7] >= 0) { { (void) printf ("    memory used, in bytes:                              %.20g\n", Info [7]) ; } ; }}
                    ;
    { if (Info [8] >= 0) { { (void) printf ("    # of memory compactions:                            %.20g\n", Info [8]) ; } ; }}
                   ;
    ...
    { if (lnz >= 0) { { (void) printf ("    nonzeros in L (excluding diagonal):                 %.20g\n", lnz) ; } ; }}
      ;
    { if (lnzd >= 0) { { (void) printf ("    nonzeros in L (including diagonal):                 %.20g\n", lnzd) ; } ; }}
       ;
    { if (ndiv >= 0) { { (void) printf ("    # divide operations for LDL' or LU:                 %.20g\n", ndiv) ; } ; }}
       ;
    { if (nmultsubs_ldl >= 0) { { (void) printf ("    # multiply-subtract operations for LDL':            %.20g\n", nmultsubs_ldl) ; } ; }}
                ;
    { if (nmultsubs_lu >= 0) { { (void) printf ("    # multiply-subtract operations for LU:              %.20g\n", nmultsubs_lu) ; } ; }}
               ;
    { if (Info [13] >= 0) { { (void) printf ("    max nz. in any column of L (incl. diagonal):        %.20g\n", Info [13]) ; } ; }}
                  ;
...
# 113 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/amd/amd_info.c"
                             ;
    }
}
