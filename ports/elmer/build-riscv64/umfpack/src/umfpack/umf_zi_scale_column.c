...
static void shift_pivot_row (DoubleComplex *Fd, DoubleComplex *Fs, DoubleComplex *Fe, int len, int d)
{
    int j ;
#pragma ivdep
    for (j = 0 ; j < len ; j++)
...
# 373 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_scale_column.c"
    ...
    umfzi_scale (fnrows, pivot_value, Fcol) ;





    umfzi_mem_free_tail_block (Numeric, Row_tuples [pivrow]) ;
    umfzi_mem_free_tail_block (Numeric, Col_tuples [pivcol]) ;
