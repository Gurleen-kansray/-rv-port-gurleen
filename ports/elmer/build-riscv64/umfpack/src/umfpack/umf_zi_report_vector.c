# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_report_vector.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_report_vector.c"
# 11 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_report_vector.c"
...
# 12 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_report_vector.c" 2
...
)
{
    ...
    if (scalar)
    {
 { if (((Xx [i]) != 0.)) { { (void) printf (" (%g)", (Xx [i])) ; } ; } else { { (void) printf (" (0)") ; } ; } } ;
    }
    else
    {
 { if (((Xz) != (double *) 0)) { (xi).component [0] = (Xx)[i] ; (xi).component [1] = (Xz)[i] ; } else { (xi) = ((DoubleComplex *)(Xx))[i] ; } } ;
 { if ((((xi).component [0]) != 0.)) { { (void) printf (" (%g", (xi).component [0]) ; } ; } else { { (void) printf (" (0") ; } ; } if ((((xi).component [1]) < 0.)) { { (void) printf (" - %gi)", -(xi).component [1]) ; } ; } else if ((((xi).component [1]) == 0.)) { { (void) printf (" + 0i)") ; } ; } else { { (void) printf (" + %gi)", (xi).component [1]) ; } ; } } ;
    }
    { (void) printf ("\n") ; } ;
}
...
)
{
    ...
    if (user || prl >= 4)
    {
 { (void) printf ("dense vector, n = ""%d"". ", n) ; } ;
    }
 ...
 if (!Xx)
 {
     { (void) printf ("ERROR: vector not present\n\n") ; } ;
     return ((-5)) ;
 }
 if (n < 0)
 {
     { (void) printf ("ERROR: length of vector is < 0\n\n") ; } ;
     return ((-6)) ;
 }
    }
 ...
 for (i = 0 ; i < n ; i++)
 {
    ...
    { if (prl >= (4)) { { (void) printf ("    dense vector ") ; } ; } } ;
    if (user || prl >= 4)
    {
 { (void) printf ("OK\n\n") ; } ;
    }
