...
# 169 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_start_front.c"
 ...
 if (cdeg > 0)
 {
     ...
     if (((!((((double) cdeg * (double) cdeg) * sizeof (DoubleComplex)) * (1.0+1e-8) <= (double) 0x7fffffffffffffffL
# 184 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_start_front.c"
        )) || ((((double) cdeg * (double) cdeg) * sizeof (DoubleComplex)) != (((double) cdeg * (double) cdeg) * sizeof (DoubleComplex)))))
     {
