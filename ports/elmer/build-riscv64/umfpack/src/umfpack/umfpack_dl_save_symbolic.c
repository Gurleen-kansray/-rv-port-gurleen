# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_save_symbolic.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_save_symbolic.c"
# 16 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_save_symbolic.c"
...
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_save_symbolic.c" 2
...
# 18 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_save_symbolic.c" 2
# 33 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_save_symbolic.c"
 long umfpack_dl_save_symbolic
(
    void *SymbolicHandle,
    char *user_filename
)
{
 ...
 return ((-17)) ;
    ...
    { ; if (fwrite (Symbolic, sizeof (SymbolicType), 1, f) != 1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Cperm_init, sizeof (long), Symbolic->n_col+1, f) != Symbolic->n_col+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Rperm_init, sizeof (long), Symbolic->n_row+1, f) != Symbolic->n_row+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Front_npivcol, sizeof (long), Symbolic->nfr+1, f) != Symbolic->nfr+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Front_parent, sizeof (long), Symbolic->nfr+1, f) != Symbolic->nfr+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Front_1strow, sizeof (long), Symbolic->nfr+1, f) != Symbolic->nfr+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Front_leftmostdesc, sizeof (long), Symbolic->nfr+1, f) != Symbolic->nfr+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Chain_start, sizeof (long), Symbolic->nchains+1, f) != Symbolic->nchains+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Chain_maxrows, sizeof (long), Symbolic->nchains+1, f) != Symbolic->nchains+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Chain_maxcols, sizeof (long), Symbolic->nchains+1, f) != Symbolic->nchains+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Cdeg, sizeof (long), Symbolic->n_col+1, f) != Symbolic->n_col+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Symbolic->Rdeg, sizeof (long), Symbolic->n_row+1, f) != Symbolic->n_row+1) { fclose (f) ; return ((-17)) ; } } ;
    if (Symbolic->esize > 0)
    {

 { ; if (fwrite (Symbolic->Esize, sizeof (long), Symbolic->esize, f) != Symbolic->esize) { fclose (f) ; return ((-17)) ; } } ;
    }
    if (Symbolic->prefer_diagonal)
    {

 { ; if (fwrite (Symbolic->Diagonal_map, sizeof (long), Symbolic->n_col+1, f) != Symbolic->n_col+1) { fclose (f) ; return ((-17)) ; } } ;
    }
