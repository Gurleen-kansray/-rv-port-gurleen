# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_wrapup.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_wrapup.c"
# 13 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_wrapup.c"
...
# 14 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_wrapup.c" 2
 ...
 *Wc, *Wp, *Frpos, *Fcpos, *Row_degree, *Col_degree, *Rperm_init,
 n_row, n_col, n_inner, zero_pivot, nan_pivot, n1 ;
    ...
    {
 pivot_value = D [k] ;
 { double r, ar, ai ; ar = (((((pivot_value).component [0]) < 0.)) ? -((pivot_value).component [0]) : ((pivot_value).component [0])) ; ai = (((((pivot_value).component [1]) < 0.)) ? -((pivot_value).component [1]) : ((pivot_value).component [1])) ; if (ar >= ai) { if (ar + ai == ar) { (d) = ar ; } else { r = ai / ar ; (d) = ar * sqrt (1.0 + r*r) ; } } else { if (ai + ar == ai) { (d) = ai ; } else { r = ar / ai ; (d) = ai * sqrt (1.0 + r*r) ; } } } ;
 zero_pivot = ((d) == 0.) ;
 nan_pivot = ((d) != (d)) ;
...
# 278 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_wrapup.c"
    for (k = 0 ; k < npiv ; k++)
    {
 pivrow = Rperm [k] ;
 Wr [k] = Uilen [pivrow] ;
