...
# 105 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c"
 ...
 { if (! (umfzi_start_front (chain, Numeric, Work, Symbolic))) { return ((-1)) ; }} ;
 ...
 for (Work->frontid = f1 ; Work->frontid <= f2 ; Work->frontid++)
 {
  ...
  status = umfzi_local_search (Numeric, Work, Symbolic) ;
  if (status == (-11))
  {
  ...
  if (Work->do_update)
  {
      umfzi_blas3_update (Work) ;
      if (drop)
      {
   { if (! (umfzi_store_lu_drop (Numeric, Work))) { return ((-1)) ; }} ;
      }
      else
      {
   { if (! (umfzi_store_lu (Numeric, Work))) { return ((-1)) ; }} ;
      }
  }
  ...
  if (Work->do_extend)
  {
      ...
      { if (! (umfzi_extend_front (Numeric, Work))) { return ((-1)) ; }} ;
  }
  else
  {

      { if (! (umfzi_create_element (Numeric, Work, Symbolic))) { return ((-1)) ; }} ;
      { if (! (umfzi_init_front (Numeric, Work))) { return ((-1)) ; }} ;
  }
  ...
  if (fixQ)
  {
      umfzi_assemble_fixq (Numeric, Work) ;
  }
  else
  {
      umfzi_assemble (Numeric, Work) ;
  }
  ...
  umfzi_scale_column (Numeric, Work) ;
  ...
  if (evaporate)
  {
      ...
      (void) umfzi_create_element (Numeric, Work, Symbolic) ;
      Work->fnrows = 0 ;
      Work->fncols = 0 ;
  }
     }
...
# 270 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c"
 ...
 Work->fncols = 0 ;
    ...
    umfzi_kernel_wrapup (Numeric, Symbolic, Work) ;
