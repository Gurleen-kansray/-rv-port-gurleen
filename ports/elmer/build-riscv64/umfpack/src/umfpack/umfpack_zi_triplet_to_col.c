...
# 89 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_triplet_to_col.c"
 ...
 Rx = (double *) umf_i_malloc (2*nz+2, sizeof (double)) ;
 split = ((Tz) != (double *) 0) && ((Az) != (double *) 0) ;
 if (split)
 {
     Rz = Rx + nz ;
 }
 ...
 if (do_values)
 {
     status = umfzi_triplet_map_x (n_row, n_col, nz, Ti, Tj, Ap, Ai, Rp,
 ...
 {
     status = umfzi_triplet_map_nox (n_row, n_col, nz, Ti, Tj, Ap, Ai, Rp,
 ...
 if (do_values)
 {
     status = umfzi_triplet_nomap_x (n_row, n_col, nz, Ti, Tj, Ap, Ai, Rp,
  Rj, W, RowCount , Tx, Ax, Rx
 ...
 {
     status = umfzi_triplet_nomap_nox (n_row, n_col, nz, Ti, Tj, Ap, Ai,
  Rp, Rj, W, RowCount) ;
 }
    }
