# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_set_stats.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_set_stats.c"
# 19 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_set_stats.c"
...
# 20 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_set_stats.c" 2
...
# 21 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_set_stats.c" 2
...
)
{
 ...
 num_On_size2, num_usage, sym_maxncols, sym_maxnrows, elen, n1 ;
    ...
    sym_size = umfdi_symbolic_usage (Symbolic->n_row, Symbolic->n_col,
 ...
 + (ceil ((sizeof (double) * ((double) n_inner+1)) / sizeof (Unit)))
 + 4 * (ceil ((sizeof (int) * ((double) n_row+1)) / sizeof (Unit)))
 + 4 * (ceil ((sizeof (int) * ((double) n_col+1)) / sizeof (Unit)))
 + (scale ? (ceil ((sizeof (double) * ((double) n_row)) / sizeof (Unit))) : 0) ;
 ...
 (ceil ((sizeof (NumericType) * ((double) 1)) / sizeof (Unit)))
 + (ceil ((sizeof (double) * ((double) n_inner+1)) / sizeof (Unit)))
 + (ceil ((sizeof (int) * ((double) n_row+1)) / sizeof (Unit)))
 + (ceil ((sizeof (int) * ((double) n_col+1)) / sizeof (Unit)))
 + 6 * (ceil ((sizeof (int) * ((double) npiv+1)) / sizeof (Unit)))
 + (scale ? (ceil ((sizeof (double) * ((double) n_row)) / sizeof (Unit))) : 0) ;
 ...
 num_On_size2
 + num_mem_size
 + (ceil ((sizeof (int) * ((double) ulen+1)) / sizeof (Unit))) ;
 ...
 2 * (ceil ((sizeof (double) * ((double) sym_maxnrows + 1)) / sizeof (Unit)))
 + 2 * (ceil ((sizeof (int) * ((double) n_row+1)) / sizeof (Unit)))
 + 2 * (ceil ((sizeof (int) * ((double) n_col+1)) / sizeof (Unit)))
 + (ceil ((sizeof (int) * ((double) nn + 1)) / sizeof (Unit)))
 + (ceil ((sizeof (int) * ((double) (((n_col) > (sym_maxnrows)) ? (n_col) : (sym_maxnrows)) + 1)) / sizeof (Unit)))
 + 2 * (ceil ((sizeof (int) * ((double) sym_maxnrows + 1)) / sizeof (Unit)))
 + 3 * (ceil ((sizeof (int) * ((double) sym_maxncols + 1)) / sizeof (Unit)))
 + (ceil ((sizeof (int) * ((double) (((sym_maxnrows) > (sym_maxncols)) ? (sym_maxnrows) : (sym_maxncols)) + 1)) / sizeof (Unit)))
 + (ceil ((sizeof (int) * ((double) elen)) / sizeof (Unit)))
 + (ceil ((sizeof (int) * ((double) Symbolic->nfr + 1)) / sizeof (Unit)))
 + ((n_row == n_col) ? (2 * (ceil ((sizeof (int) * ((double) nn)) / sizeof (Unit)))) : 0) ;
