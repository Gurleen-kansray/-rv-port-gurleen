...
)
{
 ...
 n_i = n_col ;
    ...
    { (void) printf ("%s-form matrix, n_row ""%d"" n_col ""%d"", ", vector, n_row, n_col) ; } ;
 ...
 return ((-8)) ;
    ...
    if (Ap [0] != 0)
    {
 { (void) printf ("ERROR: Ap [""%d""] = ""%d"" must be ""%d""\n\n", (int) (0), (Ap [0]), (int) (0)) ; }
                                                        ;
 return ((-8)) ;
    }
 ...
 if (Ap [k] < 0)
 {
     { (void) printf ("ERROR: Ap [""%d""] < 0\n\n", (k)) ; } ;
     return ((-8)) ;
 }
 if (Ap [k] > nz)
 {
     { (void) printf ("ERROR: Ap [""%d""] > size of Ai\n\n", (k)) ; } ;
     return ((-8)) ;
 }
    }
 ...
 if (length < 0)
 {
     { (void) printf ("ERROR: # entries in %s ""%d"" is < 0\n\n", vector, (k)) ; }
                      ;
     return ((-8)) ;
 }
    }
 ...
 p2 = Ap [k+1] ;
 length = p2 - p1 ;
 { if (prl >= (4)) { { (void) printf ("\n    %s ""%d"": start: ""%d"" end: ""%d"" entries: ""%d""\n", vector, (k), p1, p2-1, length) ; } ; } }
                                           ;
 ilast = (-1) ;
 for (p = p1 ; p < p2 ; p++)
 {
     i = Ai [p] ;
     { if (prl >= (4)) { { (void) printf ("\t%s ""%d"" ", index, (i)) ; } ; } } ;
     if (do_values && prl >= 4)
     {
  { (void) printf (":") ; } ;
  ...
  { if ((((a).component [0]) != 0.)) { { (void) printf (" (%g", (a).component [0]) ; } ; } else { { (void) printf (" (0") ; } ; } if ((((a).component [1]) < 0.)) { { (void) printf (" - %gi)", -(a).component [1]) ; } ; } else if ((((a).component [1]) == 0.)) { { (void) printf (" + 0i)") ; } ; } else { { (void) printf (" + %gi)", (a).component [1]) ; } ; } } ;
     ...
     if (i < 0 || i >= n_i)
     {
  { (void) printf (" ERROR: %s index ""%d"" out of range in %s ""%d""\n\n", index, (i), vector, (k)) ; }
                                            ;
  return ((-8)) ;
     }
     if (i <= ilast)
     {
  { (void) printf (" ERROR: %s index ""%d"" out of order (or duplicate) in " "%s ""%d""\n\n", index, (i), vector, (k)) ; }
                                                           ;
  return ((-8)) ;
     }
     { if (prl >= (4)) { { (void) printf ("\n") ; } ; } } ;
