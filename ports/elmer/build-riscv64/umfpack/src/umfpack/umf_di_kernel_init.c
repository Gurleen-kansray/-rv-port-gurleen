# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c"
# 22 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c"
...
# 23 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_tuple_lengths.h" 1
 ...
 int umfdi_tuple_lengths
(
    NumericType *Numeric,
    WorkType *Work,
    double *dusage
) ;
# 24 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_build_tuples.h" 1
 ...
 int umfdi_build_tuples
(
    NumericType *Numeric,
    WorkType *Work
) ;
# 25 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_mem_init_memoryspace.h" 1
 ...
 void umfdi_mem_init_memoryspace
(
    NumericType *Numeric
) ;
# 26 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_mem_alloc_element.h" 1
...
# 27 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_mem_alloc_head_block.h" 1
 ...
 int umfdi_mem_alloc_head_block
(
    NumericType *Numeric,
    int nunits
) ;
# 28 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_mem_alloc_tail_block.h" 1
 ...
 int umfdi_mem_alloc_tail_block
(
    NumericType *Numeric,
    int nunits
) ;
# 29 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_mem_free_tail_block.h" 1
 ...
 void umfdi_mem_free_tail_block
(
    NumericType *Numeric,
    int i
) ;
# 30 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_scale.h" 1
...
# 31 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c" 2
...
)
{
    ...
    p = *p_p ;
    len = *p_len ;
    Bi = (int *) (Memory + p) ; p += (((((sizeof (int) * (len))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
    Bx = (double *) (Memory + p) ; p += (((((sizeof (double) * (len))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
    ;
 ...
 len_new++ ;
    ...
    ;
# 104 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c"
    *p_p = pnew ;
    *p_len = len_new ;
    Bi2 = (int *) (Memory + pnew) ; pnew += (((((sizeof (int) * (len_new))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
    Bx2 = (double *) (Memory + pnew) ; pnew += (((((sizeof (double) * (len_new))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
    ;
...
# 131 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c"
    return (pnew) ;
}
 ...
 **Rpi, nempty_row, dense_row_threshold, empty_elements, rpi, rpx ;
 ...
 return ((0)) ;
    ...
    umfdi_mem_init_memoryspace (Numeric) ;
    ;
...
# 306 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c"
    Work->cdeg0 = 1 ;
    Work->rdeg0 = 1 ;
    ...
    drop = (droptol > 0) ;
# 354 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c"
...
# 470 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c"
    ;
 ...
 for (k = n1 ; k < nn - nempty ; k++)
 {
    ...
    rpi = umfdi_mem_alloc_tail_block (Numeric, (((((sizeof (int *) * (n_row+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
    rpx = umfdi_mem_alloc_tail_block (Numeric, (((((sizeof (double *) * (n_row+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
    if (!rpi || !rpx)
    {
 ...
 size = (((((sizeof (int) * (lnz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (double) * (lnz))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
      + (((((sizeof (int) * (unz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (double) * (unz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 p = umfdi_mem_alloc_head_block (Numeric, size) ;
 ;
 if (!p)
 {
 ...
 lip = p ;
 p += (((((sizeof (int) * (lnz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 p += (((((sizeof (double) * (lnz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;


 uip = p ;
 Rpi [k] = (int *) (Memory + p) ;
 p += (((((sizeof (int) * (unz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 Rpx [k] = (double *) (Memory + p) ;
 ...
 if (esize > 0)
 {
     ...
     E [e] = umfdi_mem_alloc_element (Numeric, esize, 1, &Rows, &Cols, &C,
  &size, &ep) ;
     if (E [e] <= 0)
     {
 ...
 for (k = n1 ; k < n_row - nempty_row ; k++)
 {
  ...
  e++ ;
  ;
  E [e] = umfdi_mem_alloc_element (Numeric, 1, rdeg, &Rows, &Cols,
      &C, &size, &ep) ;
  if (E [e] <= 0)
  {
 ...
 Li = (int *) (Memory + p) ;
 lilen = Lilen [k] ;
 p += (((((sizeof (int) * (lilen))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 Lval = (double *) (Memory + p) ;
 ...
 {
     pivot_value = D [k] ;
     umfdi_scale (llen, pivot_value, Lval) ;
 }
 ...
 if (k < n_col - nempty_col)
 {
  ...
  Unit *pp ;
  pp = Memory + E [e] ;
  { { { ; ; ; ep = (Element *) pp ; pp += (((((sizeof (Element) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ; Cols = (int *) pp ; } ; ncols = ep->ncols ; Rows = Cols + ncols ; } ; nrows = ep->nrows ; pp += (((((sizeof (int) * (ncols + nrows))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ; C = (double *) pp ; } ;
  ;
  ;
  ;
     }
  ...
  *(Rpx [newrow]++) = x ;
  ...
  C [clen] = x ;
  clen++ ;
# 853 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c"
     }
 }
 ...
 if (clen != esize)
 {
    ...
    umfdi_mem_free_tail_block (Numeric, rpi) ;
    umfdi_mem_free_tail_block (Numeric, rpx) ;
...
# 970 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c"
    Col_degree [n_col] = 0 ;
 ...
 Wp [i] = (-1) ;
    ...
    (void) umfdi_tuple_lengths (Numeric, Work, &unused) ;
    if (!umfdi_build_tuples (Numeric, Work))
    {
...
# 1055 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel_init.c"
    return ((1)) ;
}
