...
# 125 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_info.c"
    { (void) printf ("    matrix entry defined as:          double complex\n") ; } ;
    { (void) printf ("    Int (generic integer) defined as: int\n") ; } ;
...
# 183 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_info.c"
    ...
    { if (((n_row) != (n_row)) || (!((n_row) < 0.))) { { (void) printf ("    number of rows in matrix A:       ""%d""\n", n_row) ; } ; } } ;
    { if (((n_col) != (n_col)) || (!((n_col) < 0.))) { { (void) printf ("    number of columns in matrix A:    ""%d""\n", n_col) ; } ; } } ;
    { if ((((int) Info [2]) != ((int) Info [2])) || (!(((int) Info [2]) < 0.))) { { (void) printf ("    entries in matrix A:              ""%d""\n", (int) Info [2]) ; } ; } }
                          ;
    { if ((((int) Info [3]) != ((int) Info [3])) || (!(((int) Info [3]) < 0.))) { { (void) printf ("    memory usage reported in:         ""%d""-byte Units\n", (int) Info [3]) ; } ; } }
                                    ;

    { if ((((int) Info [4]) != ((int) Info [4])) || (!(((int) Info [4]) < 0.))) { { (void) printf ("    size of int:                      ""%d"" bytes\n", (int) Info [4]) ; } ; } }
                                   ;
    { if ((((int) Info [5]) != ((int) Info [5])) || (!(((int) Info [5]) < 0.))) { { (void) printf ("    size of long:                     ""%d"" bytes\n", (int) Info [5]) ; } ; } }
                                    ;
    { if ((((int) Info [6]) != ((int) Info [6])) || (!(((int) Info [6]) < 0.))) { { (void) printf ("    size of pointer:                  ""%d"" bytes\n", (int) Info [6]) ; } ; } }
                                       ;
    { if ((((int) Info [7]) != ((int) Info [7])) || (!(((int) Info [7]) < 0.))) { { (void) printf ("    size of numerical entry:          ""%d"" bytes\n", (int) Info [7]) ; } ; } }
                                     ;
