...
# 45 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_control.c"
...
# 376 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_control.c"
    ...
    { (void) printf ("    size of int: %g long: %g Int: %g pointer: %g" " double: %g Entry: %g (in bytes)\n\n", (double) sizeof (int), (double) sizeof (long), (double) sizeof (int), (double) sizeof (void *), (double) sizeof (double), (double) sizeof (double)) ; }
