...
)
{
 ...
 return ((-17)) ;
    ...
    if (Symbolic->valid != 41937 || Symbolic->n_row <= 0 ||
 ...
 return ((-4)) ;
    ...
    { Symbolic->Cperm_init = (int *) umf_i_malloc (Symbolic->n_col+1, sizeof (int)) ; if (Symbolic->Cperm_init == (int *) 0) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Cperm_init, sizeof (int), Symbolic->n_col+1, f) != Symbolic->n_col+1) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Rperm_init = (int *) umf_i_malloc (Symbolic->n_row+1, sizeof (int)) ; if (Symbolic->Rperm_init == (int *) 0) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Rperm_init, sizeof (int), Symbolic->n_row+1, f) != Symbolic->n_row+1) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Front_npivcol = (int *) umf_i_malloc (Symbolic->nfr+1, sizeof (int)) ; if (Symbolic->Front_npivcol == (int *) 0) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Front_npivcol, sizeof (int), Symbolic->nfr+1, f) != Symbolic->nfr+1) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Front_parent = (int *) umf_i_malloc (Symbolic->nfr+1, sizeof (int)) ; if (Symbolic->Front_parent == (int *) 0) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Front_parent, sizeof (int), Symbolic->nfr+1, f) != Symbolic->nfr+1) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Front_1strow = (int *) umf_i_malloc (Symbolic->nfr+1, sizeof (int)) ; if (Symbolic->Front_1strow == (int *) 0) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Front_1strow, sizeof (int), Symbolic->nfr+1, f) != Symbolic->nfr+1) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Front_leftmostdesc = (int *) umf_i_malloc (Symbolic->nfr+1, sizeof (int)) ; if (Symbolic->Front_leftmostdesc == (int *) 0) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Front_leftmostdesc, sizeof (int), Symbolic->nfr+1, f) != Symbolic->nfr+1) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Chain_start = (int *) umf_i_malloc (Symbolic->nchains+1, sizeof (int)) ; if (Symbolic->Chain_start == (int *) 0) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Chain_start, sizeof (int), Symbolic->nchains+1, f) != Symbolic->nchains+1) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Chain_maxrows = (int *) umf_i_malloc (Symbolic->nchains+1, sizeof (int)) ; if (Symbolic->Chain_maxrows == (int *) 0) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Chain_maxrows, sizeof (int), Symbolic->nchains+1, f) != Symbolic->nchains+1) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Chain_maxcols = (int *) umf_i_malloc (Symbolic->nchains+1, sizeof (int)) ; if (Symbolic->Chain_maxcols == (int *) 0) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Chain_maxcols, sizeof (int), Symbolic->nchains+1, f) != Symbolic->nchains+1) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Cdeg = (int *) umf_i_malloc (Symbolic->n_col+1, sizeof (int)) ; if (Symbolic->Cdeg == (int *) 0) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Cdeg, sizeof (int), Symbolic->n_col+1, f) != Symbolic->n_col+1) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Rdeg = (int *) umf_i_malloc (Symbolic->n_row+1, sizeof (int)) ; if (Symbolic->Rdeg == (int *) 0) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Rdeg, sizeof (int), Symbolic->n_row+1, f) != Symbolic->n_row+1) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    if (Symbolic->esize > 0)
    {

 { Symbolic->Esize = (int *) umf_i_malloc (Symbolic->esize, sizeof (int)) ; if (Symbolic->Esize == (int *) 0) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Esize, sizeof (int), Symbolic->esize, f) != Symbolic->esize) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    }
    if (Symbolic->prefer_diagonal)
    {

 { Symbolic->Diagonal_map = (int *) umf_i_malloc (Symbolic->n_col+1, sizeof (int)) ; if (Symbolic->Diagonal_map == (int *) 0) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Diagonal_map, sizeof (int), Symbolic->n_col+1, f) != Symbolic->n_col+1) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    }
