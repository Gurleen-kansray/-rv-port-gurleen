# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_scale.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_scale.c"
# 13 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_scale.c"
...
# 14 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_scale.c" 2
...
)
{
 ...
 for (i = 0 ; i < n ; i++)
 {
     ...
     {
  { double r, den, ar, ai, br, bi ; br = (pivot).component [0] ; bi = (pivot).component [1] ; ar = (x).component [0] ; ai = (x).component [1] ; if (((((br) < 0.)) ? -(br) : (br)) >= ((((bi) < 0.)) ? -(bi) : (bi))) { r = bi / br ; den = br + r * bi ; (X [i]).component [0] = (ar + ai * r) / den ; (X [i]).component [1] = (ai - ar * r) / den ; } else { r = br / bi ; den = r * br + bi ; (X [i]).component [0] = (ar * r + ai) / den ; (X [i]).component [1] = (ai * r - ar) / den ; } } ;
     }
# 59 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_scale.c"
 }

    }
    else
    {
# 117 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_scale.c"
     for (i = 0 ; i < n ; i++)
     {
