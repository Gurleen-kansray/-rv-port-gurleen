# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_triplet.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_triplet.c"
# 16 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_triplet.c"
...
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_triplet.c" 2
...
{
    DoubleComplex t ;
    long prl, prl1, k, i, j, do_values ;

    long split = ((Tz) != (double *) 0) ;
 ...
 return ((0)) ;
    ...
    { (void) printf ("triplet-form matrix, n_row = ""%ld"", n_col = ""%ld"" nz = ""%ld"". ", n_row, n_col, nz) ; }
                    ;

    if (!Ti || !Tj)
    {
 { (void) printf ("ERROR: indices not present\n\n") ; } ;
 return ((-5)) ;
    }

    if (n_row <= 0 || n_col <= 0)
    {
 { (void) printf ("ERROR: n_row or n_col is <= 0\n\n") ; } ;
 return ((-6)) ;
    }

    if (nz < 0)
    {
 { (void) printf ("ERROR: nz is < 0\n\n") ; } ;
 return ((-8)) ;
    }

    { if (prl >= (4)) { { (void) printf ("\n") ; } ; } } ;

    do_values = Tx != (double *) 0 ;
 ...
 i = Ti [k] ;
 j = Tj [k] ;
 { if (prl >= (4)) { { (void) printf ("    ""%ld"" : ""%ld"" ""%ld"" ", (k), (i), (j)) ; } ; } } ;
 if (do_values && prl >= 4)
 {
     { if (split) { (t).component [0] = (Tx)[k] ; (t).component [1] = (Tz)[k] ; } else { (t) = ((DoubleComplex *)(Tx))[k] ; } } ;
     { if ((((t).component [0]) != 0.)) { { (void) printf (" (%g", (t).component [0]) ; } ; } else { { (void) printf (" (0") ; } ; } if ((((t).component [1]) < 0.)) { { (void) printf (" - %gi)", -(t).component [1]) ; } ; } else if ((((t).component [1]) == 0.)) { { (void) printf (" + 0i)") ; } ; } else { { (void) printf (" + %gi)", (t).component [1]) ; } ; } } ;
 }
 { if (prl >= (4)) { { (void) printf ("\n") ; } ; } } ;
 if (i < 0 || i >= n_row || j < 0 || j >= n_col)
 {

     { (void) printf ("ERROR: invalid triplet\n\n") ; } ;
     return ((-8)) ;
 }
 if (prl == 4 && k == 9 && nz > 10)
 {
    ...
    { if (prl >= (4)) { { (void) printf ("    triplet-form matrix ") ; } ; } } ;
    { (void) printf ("OK\n\n") ; } ;
    return ((0)) ;
}
