# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_utsolve.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_utsolve.c"
# 15 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_utsolve.c"
...
# 16 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_utsolve.c" 2
 ...
 *Uip, n, uhead, ulen, pos, npiv, n1, *Ui ;
    ...
    kend = 0 ;
    n1 = Numeric->n1 ;
# 66 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_utsolve.c"
    for (k = 0 ; k < n1 ; k++)
    {
 ;
# 77 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_utsolve.c"
 { double r, den, ar, ai, br, bi ; br = (D [k]).component [0] ; bi = (D [k]).component [1] ; ar = (X [k]).component [0] ; ai = (X [k]).component [1] ; if (((((br) < 0.)) ? -(br) : (br)) >= ((((bi) < 0.)) ? -(bi) : (bi))) { r = bi / br ; den = br + r * bi ; (xk).component [0] = (ar + ai * r) / den ; (xk).component [1] = (ai - ar * r) / den ; } else { r = br / bi ; den = r * br + bi ; (xk).component [0] = (ar * r + ai) / den ; (xk).component [1] = (ai * r - ar) / den ; } } ;
# 93 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_utsolve.c"
 X [k] = xk ;
 deg = Uilen [k] ;
...
# 260 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_utsolve.c"
     { double r, den, ar, ai, br, bi ; br = (D [k]).component [0] ; bi = (D [k]).component [1] ; ar = (X [k]).component [0] ; ai = (X [k]).component [1] ; if (((((br) < 0.)) ? -(br) : (br)) >= ((((bi) < 0.)) ? -(bi) : (bi))) { r = bi / br ; den = br + r * bi ; (xk).component [0] = (ar + ai * r) / den ; (xk).component [1] = (ai - ar * r) / den ; } else { r = br / bi ; den = r * br + bi ; (xk).component [0] = (ar * r + ai) / den ; (xk).component [1] = (ai * r - ar) / den ; } } ;
# 276 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_utsolve.c"
     X [k] = xk ;
...
# 330 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_utsolve.c"
