# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_symbolic.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_symbolic.c"
# 21 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_symbolic.c"
...
# 22 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_symbolic.c" 2
...
# 23 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_symbolic.c" 2
...
# 24 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_symbolic.c" 2
...
# 25 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_symbolic.c" 2
...
# 26 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_symbolic.c" 2
...
{
    long n_row, n_col, nz, nchains, nfr, maxnrows, maxncols, prl,
 ...
 *Front_leftmostdesc, *Front_parent, done, status1, status2 ;
 ...
 { (void) printf ("\tn_row: ""%ld"" n_col: ""%ld""\n", n_row, n_col) ; } ;
 { (void) printf ("\tnumber of entries: ""%ld""\n", nz) ; } ;
 { (void) printf ("    block size used for dense matrix kernels:   ""%ld""\n", Symbolic->nb) ; }
                ;

 { (void) printf ("    strategy used:                              ") ; } ;

 if (Symbolic->strategy == 3)
 {
     { (void) printf ("symmetric") ; } ;
 }
 else if (Symbolic->strategy == 1)
 {
     { (void) printf ("unsymmetric") ; } ;
 }
 else if (Symbolic->strategy == 2)
 {
     { (void) printf ("symmetric 2-by-2") ; } ;
 }
 { (void) printf ("\n") ; } ;

 { (void) printf ("    ordering used:                              ") ; } ;
 if (Symbolic->ordering == 0)
 {
     { (void) printf ("colamd on A\n") ; } ;
 }
 else if (Symbolic->ordering == 1)
 {
     { (void) printf ("amd on A+A'\n") ; } ;
 }
 else if (Symbolic->ordering == 2)
 {
     { (void) printf ("provided by user") ; } ;
 }
 { (void) printf ("\n") ; } ;

 { (void) printf ("    performn column etree postorder:            ") ; } ;
 if (Symbolic->fixQ)
 {
     { (void) printf ("no\n") ; } ;
 }
 ...
 { (void) printf ("    prefer diagonal pivoting (attempt P=Q):     ") ; } ;
 ...
 { (void) printf ("    variable-size part of Numeric object:\n") ; } ;
 { (void) printf ("\tminimum initial size (Units): %.20g  (MBytes): %.1f\n", Symbolic->dnum_mem_init_usage, (((Symbolic->dnum_mem_init_usage) * sizeof (Unit)) / 1048576.0)) ; }

                                              ;
 { (void) printf ("\testimated peak size (Units):  %.20g  (MBytes): %.1f\n", Symbolic->num_mem_usage_est, (((Symbolic->num_mem_usage_est) * sizeof (Unit)) / 1048576.0)) ; }

                                            ;
 { (void) printf ("\testimated final size (Units): %.20g  (MBytes): %.1f\n", Symbolic->num_mem_size_est, (((Symbolic->num_mem_size_est) * sizeof (Unit)) / 1048576.0)) ; }

                                           ;
 { (void) printf ("    symbolic factorization memory usage (Units):" " %.20g  (MBytes): %.1f\n", Symbolic->peak_sym_usage, (((Symbolic->peak_sym_usage) * sizeof (Unit)) / 1048576.0)) ; }


                                         ;
 { (void) printf ("    frontal matrices / supercolumns:\n") ; } ;
 { (void) printf ("\tnumber of frontal chains: ""%ld""\n", nchains) ; } ;
 { (void) printf ("\tnumber of frontal matrices: ""%ld""\n", nfr) ; } ;
 { (void) printf ("\tlargest frontal matrix row dimension: ""%ld""\n", maxnrows) ; } ;
 { (void) printf ("\tlargest frontal matrix column dimension: ""%ld""\n",maxncols) ; };
    }
 ...
 { if (prl >= (4)) { { (void) printf ("\n    Frontal chain: ""%ld"".  Frontal matrices ""%ld"" to ""%ld""\n", (chain), (frontid1), (frontid2)) ; } ; } }
                                                         ;
 { if (prl >= (4)) { { (void) printf ("\tLargest frontal matrix in Frontal chain: ""%ld""-by-""%ld""\n", Chain_maxrows [chain], Chain_maxcols [chain]) ; } ; } }
                                                    ;
 for (frontid = frontid1 ; frontid <= frontid2 ; frontid++)
 {
     kk = Front_npivcol [frontid] ;
     { if (prl >= (4)) { { (void) printf ("\tFront: ""%ld""  pivot cols: ""%ld"" (pivot columns ""%ld"" to " "%ld"")\n", (frontid), kk, (k), (k+kk-1)) ; } ; } }
                                                            ;
     { if (prl >= (4)) { { (void) printf ("\t    pivot row candidates: ""%ld"" to ""%ld""\n", (Front_1strow [Front_leftmostdesc [frontid]]), (Front_1strow [frontid+1]-1)) ; } ; } }

                                       ;
     { if (prl >= (4)) { { (void) printf ("\t    leftmost descendant: ""%ld""\n", (Front_leftmostdesc [frontid])) ; } ; } }
                                         ;
     { if (prl >= (4)) { { (void) printf ("\t    1st new candidate row : ""%ld""\n", (Front_1strow [frontid])) ; } ; } }
                                   ;
     { if (prl >= (4)) { { (void) printf ("\t    parent:") ; } ; } } ;
     if (Front_parent [frontid] == (-1))
     {
  { if (prl >= (4)) { { (void) printf (" (none)\n") ; } ; } } ;
     }
     else
     {
  { if (prl >= (4)) { { (void) printf (" ""%ld""\n", (Front_parent [frontid])) ; } ; } } ;
     }
 ...
 {
     { if (prl >= (4)) { { (void) printf ("\tFront: ""%ld"" placeholder for ""%ld"" empty columns\n", (nfr), Front_npivcol [nfr]) ; } ; } }
                                     ;
 }
 if (done)
 {
    ...
    W = (long *) umf_l_malloc ((((n_row) > (n_col)) ? (n_row) : (n_col)), sizeof (long)) ;
    if (!W)
    {
 { (void) printf ("ERROR: out of memory to check Symbolic object\n\n") ; } ;
 return ((-1)) ;
    }

    { if (prl >= (4)) { { (void) printf ("\nInitial column permutation, Q1: ") ; } ; } } ;
    status1 = umf_l_report_perm (n_col, Symbolic->Cperm_init, W, prl, 0) ;

    { if (prl >= (4)) { { (void) printf ("\nInitial row permutation, P1: ") ; } ; } } ;
    status2 = umf_l_report_perm (n_row, Symbolic->Rperm_init, W, prl, 0) ;
 ...
 return ((-4)) ;
    ...
    { if (prl >= (4)) { { (void) printf ("    Symbolic object:  ") ; } ; } } ;
    { (void) printf ("OK\n\n") ; } ;
    return ((0)) ;
}
