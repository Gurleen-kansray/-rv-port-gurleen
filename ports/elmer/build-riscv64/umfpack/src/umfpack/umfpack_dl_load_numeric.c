...
)
{
 ...
 return ((-17)) ;
    ...
    if (Numeric->valid != 399789720 || Numeric->n_row <= 0 ||
 ...
 return ((-3)) ;
    ...
    Numeric->D = (double *) 0 ;
    Numeric->Rperm = (long *) 0 ;
    Numeric->Cperm = (long *) 0 ;
    Numeric->Lpos = (long *) 0 ;
    Numeric->Lilen = (long *) 0 ;
    Numeric->Lip = (long *) 0 ;
    Numeric->Upos = (long *) 0 ;
    Numeric->Uilen = (long *) 0 ;
    Numeric->Uip = (long *) 0 ;
    Numeric->Rs = (double *) 0 ;
    Numeric->Memory = (Unit *) 0 ;
    Numeric->Upattern = (long *) 0 ;
    ...
    { Numeric->D = (double *) umf_l_malloc ((((Numeric->n_row) < (Numeric->n_col)) ? (Numeric->n_row) : (Numeric->n_col))+1, sizeof (double)) ; if (Numeric->D == (double *) 0) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->D, sizeof (double), (((Numeric->n_row) < (Numeric->n_col)) ? (Numeric->n_row) : (Numeric->n_col))+1, f) != (((Numeric->n_row) < (Numeric->n_col)) ? (Numeric->n_row) : (Numeric->n_col))+1) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Rperm = (long *) umf_l_malloc (Numeric->n_row+1, sizeof (long)) ; if (Numeric->Rperm == (long *) 0) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Rperm, sizeof (long), Numeric->n_row+1, f) != Numeric->n_row+1) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Cperm = (long *) umf_l_malloc (Numeric->n_col+1, sizeof (long)) ; if (Numeric->Cperm == (long *) 0) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Cperm, sizeof (long), Numeric->n_col+1, f) != Numeric->n_col+1) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Lpos = (long *) umf_l_malloc (Numeric->npiv+1, sizeof (long)) ; if (Numeric->Lpos == (long *) 0) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Lpos, sizeof (long), Numeric->npiv+1, f) != Numeric->npiv+1) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Lilen = (long *) umf_l_malloc (Numeric->npiv+1, sizeof (long)) ; if (Numeric->Lilen == (long *) 0) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Lilen, sizeof (long), Numeric->npiv+1, f) != Numeric->npiv+1) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Lip = (long *) umf_l_malloc (Numeric->npiv+1, sizeof (long)) ; if (Numeric->Lip == (long *) 0) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Lip, sizeof (long), Numeric->npiv+1, f) != Numeric->npiv+1) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Upos = (long *) umf_l_malloc (Numeric->npiv+1, sizeof (long)) ; if (Numeric->Upos == (long *) 0) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Upos, sizeof (long), Numeric->npiv+1, f) != Numeric->npiv+1) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Uilen = (long *) umf_l_malloc (Numeric->npiv+1, sizeof (long)) ; if (Numeric->Uilen == (long *) 0) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Uilen, sizeof (long), Numeric->npiv+1, f) != Numeric->npiv+1) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Uip = (long *) umf_l_malloc (Numeric->npiv+1, sizeof (long)) ; if (Numeric->Uip == (long *) 0) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Uip, sizeof (long), Numeric->npiv+1, f) != Numeric->npiv+1) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    if (Numeric->scale != 0)
    {
 { Numeric->Rs = (double *) umf_l_malloc (Numeric->n_row, sizeof (double)) ; if (Numeric->Rs == (double *) 0) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Rs, sizeof (double), Numeric->n_row, f) != Numeric->n_row) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    }
    if (Numeric->ulen > 0)
    {
 { Numeric->Upattern = (long *) umf_l_malloc (Numeric->ulen+1, sizeof (long)) ; if (Numeric->Upattern == (long *) 0) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Upattern, sizeof (long), Numeric->ulen+1, f) != Numeric->ulen+1) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    }
    { Numeric->Memory = (Unit *) umf_l_malloc (Numeric->size, sizeof (Unit)) ; if (Numeric->Memory == (Unit *) 0) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Memory, sizeof (Unit), Numeric->size, f) != Numeric->size) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_dl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;


    fclose (f) ;


    if (!umfdl_valid_numeric (Numeric))
    {
