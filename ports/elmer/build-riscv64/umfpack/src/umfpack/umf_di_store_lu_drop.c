...
)
{
    ...
    double *D, *Lval, *Uval, *Fl1, *Fl2, *Fu1, *Fu2,
...
# 258 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_store_lu.c"
 lnz2x += lnz2i ;
 ...
 else
 {
     newLchain =
      ...
      (((((sizeof (double) * (lnz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (int) * (lnz))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
  <=

      (((((sizeof (double) * (lnz2x))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (int) * (lnz2i))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 }
 ...
 size = (((((sizeof (int) * (lnzi))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (double) * (lnzx))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
# 320 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_store_lu.c"
 ...
 if (!p)
 {
  ...
  c2 = (((fncols) > (Work->fncols_new + 1)) ? (fncols) : (Work->fncols_new + 1)) ;
     ...
     ;
     if (!umfdi_get_memory (Numeric, Work, size, r2, c2, (1)))
     {
  ;
  return ((0)) ;
     }
 ...
 p += (((((sizeof (int) * (lnzi))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 Lval = (double *) (Numeric->Memory + p) ;
 p += (((((sizeof (double) * (lnzx))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
...
# 452 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_store_lu.c"
 }
 else
 {
     ;
...
# 539 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_store_lu.c"
 }
 ;
 ;
 ;
 ;
     ...
     Lnz [kk] = all_lnz ;
# 560 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_store_lu.c"
...
# 690 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_store_lu.c"
 unz2x += unz2i ;
 ...
 else
 {
     newUchain =
      ...
      (((((sizeof (double) * (unz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (int) * (unz))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
  <=

      (((((sizeof (double) * (unz2x))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (int) * (unz2i))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 ...
 if (newUchain)
 {
     ...
     size += (((((sizeof (int) * (ulen))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
     unzx = unz ;
 }
 else
 {
 ...
 size += (((((sizeof (double) * (unzx))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
# 744 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_store_lu.c"
 ...
 if (newUchain)
 {
     ...
     Numeric->isize += ulen ;
     p += (((((sizeof (int) * (ulen))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
     for (i = 0 ; i < ulen ; i++)
     {
  col = Upattern [i] ;
  ;
...
# 923 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_store_lu.c"
 }
 else
 {
...
# 1009 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_store_lu.c"
 }
 ...
 ;
     ...
     Numeric->flops += 1. * Lnz [kk]
  + 2. * (Lnz [kk] * all_unz) ;
# 1034 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_store_lu.c"
