...
)
{
 ...
 return ((-17)) ;
    ...
    if (Numeric->valid != 15977 || Numeric->n_row <= 0 ||
 ...
 return ((-3)) ;
    ...
    { Numeric->D = (double *) umf_i_malloc ((((Numeric->n_row) < (Numeric->n_col)) ? (Numeric->n_row) : (Numeric->n_col))+1, sizeof (double)) ; if (Numeric->D == (double *) 0) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->D, sizeof (double), (((Numeric->n_row) < (Numeric->n_col)) ? (Numeric->n_row) : (Numeric->n_col))+1, f) != (((Numeric->n_row) < (Numeric->n_col)) ? (Numeric->n_row) : (Numeric->n_col))+1) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Rperm = (int *) umf_i_malloc (Numeric->n_row+1, sizeof (int)) ; if (Numeric->Rperm == (int *) 0) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Rperm, sizeof (int), Numeric->n_row+1, f) != Numeric->n_row+1) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Cperm = (int *) umf_i_malloc (Numeric->n_col+1, sizeof (int)) ; if (Numeric->Cperm == (int *) 0) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Cperm, sizeof (int), Numeric->n_col+1, f) != Numeric->n_col+1) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Lpos = (int *) umf_i_malloc (Numeric->npiv+1, sizeof (int)) ; if (Numeric->Lpos == (int *) 0) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Lpos, sizeof (int), Numeric->npiv+1, f) != Numeric->npiv+1) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Lilen = (int *) umf_i_malloc (Numeric->npiv+1, sizeof (int)) ; if (Numeric->Lilen == (int *) 0) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Lilen, sizeof (int), Numeric->npiv+1, f) != Numeric->npiv+1) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Lip = (int *) umf_i_malloc (Numeric->npiv+1, sizeof (int)) ; if (Numeric->Lip == (int *) 0) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Lip, sizeof (int), Numeric->npiv+1, f) != Numeric->npiv+1) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Upos = (int *) umf_i_malloc (Numeric->npiv+1, sizeof (int)) ; if (Numeric->Upos == (int *) 0) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Upos, sizeof (int), Numeric->npiv+1, f) != Numeric->npiv+1) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Uilen = (int *) umf_i_malloc (Numeric->npiv+1, sizeof (int)) ; if (Numeric->Uilen == (int *) 0) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Uilen, sizeof (int), Numeric->npiv+1, f) != Numeric->npiv+1) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Uip = (int *) umf_i_malloc (Numeric->npiv+1, sizeof (int)) ; if (Numeric->Uip == (int *) 0) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Uip, sizeof (int), Numeric->npiv+1, f) != Numeric->npiv+1) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    if (Numeric->scale != 0)
    {
 { Numeric->Rs = (double *) umf_i_malloc (Numeric->n_row, sizeof (double)) ; if (Numeric->Rs == (double *) 0) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Rs, sizeof (double), Numeric->n_row, f) != Numeric->n_row) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    }
    if (Numeric->ulen > 0)
    {
 { Numeric->Upattern = (int *) umf_i_malloc (Numeric->ulen+1, sizeof (int)) ; if (Numeric->Upattern == (int *) 0) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Upattern, sizeof (int), Numeric->ulen+1, f) != Numeric->ulen+1) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    }
    { Numeric->Memory = (Unit *) umf_i_malloc (Numeric->size, sizeof (Unit)) ; if (Numeric->Memory == (Unit *) 0) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Memory, sizeof (Unit), Numeric->size, f) != Numeric->size) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_di_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;


    fclose (f) ;


    if (!umfdi_valid_numeric (Numeric))
    {
