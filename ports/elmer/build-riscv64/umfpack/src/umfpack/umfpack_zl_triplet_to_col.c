...
# 89 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_triplet_to_col.c"
 ...
 Rx = (double *) umf_l_malloc (2*nz+2, sizeof (double)) ;
 ...
 if (do_values)
 {
     status = umfzl_triplet_map_x (n_row, n_col, nz, Ti, Tj, Ap, Ai, Rp,
 ...
 {
     status = umfzl_triplet_map_nox (n_row, n_col, nz, Ti, Tj, Ap, Ai, Rp,
 ...
 if (do_values)
 {
     status = umfzl_triplet_nomap_x (n_row, n_col, nz, Ti, Tj, Ap, Ai, Rp,
  Rj, W, RowCount , Tx, Ax, Rx
 ...
 {
     status = umfzl_triplet_nomap_nox (n_row, n_col, nz, Ti, Tj, Ap, Ai,
  Rp, Rj, W, RowCount) ;
 }
    }
