...
)
{
 ...
 return ((-17)) ;
    ...
    { ; if (fwrite (Numeric->D, sizeof (DoubleComplex), (((Numeric->n_row) < (Numeric->n_col)) ? (Numeric->n_row) : (Numeric->n_col))+1, f) != (((Numeric->n_row) < (Numeric->n_col)) ? (Numeric->n_row) : (Numeric->n_col))+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->Rperm, sizeof (int), Numeric->n_row+1, f) != Numeric->n_row+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->Cperm, sizeof (int), Numeric->n_col+1, f) != Numeric->n_col+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->Lpos, sizeof (int), Numeric->npiv+1, f) != Numeric->npiv+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->Lilen, sizeof (int), Numeric->npiv+1, f) != Numeric->npiv+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->Lip, sizeof (int), Numeric->npiv+1, f) != Numeric->npiv+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->Upos, sizeof (int), Numeric->npiv+1, f) != Numeric->npiv+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->Uilen, sizeof (int), Numeric->npiv+1, f) != Numeric->npiv+1) { fclose (f) ; return ((-17)) ; } } ;
    { ; if (fwrite (Numeric->Uip, sizeof (int), Numeric->npiv+1, f) != Numeric->npiv+1) { fclose (f) ; return ((-17)) ; } } ;
    if (Numeric->scale != 0)
    {
 { ; if (fwrite (Numeric->Rs, sizeof (double), Numeric->n_row, f) != Numeric->n_row) { fclose (f) ; return ((-17)) ; } } ;
    ...
    if (Numeric->ulen > 0)
    {
 { ; if (fwrite (Numeric->Upattern, sizeof (int), Numeric->ulen+1, f) != Numeric->ulen+1) { fclose (f) ; return ((-17)) ; } } ;
    }
