# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_load_symbolic.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_load_symbolic.c"
# 16 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_load_symbolic.c"
...
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_load_symbolic.c" 2
...
# 18 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_load_symbolic.c" 2
...
# 19 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_load_symbolic.c" 2
...
# 20 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_load_symbolic.c" 2
# 48 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_load_symbolic.c"
 long umfpack_zl_load_symbolic
(
    void **SymbolicHandle,
    char *user_filename
)
{
 ...
 return ((-4)) ;
    ...
    Symbolic->Cperm_init = (long *) 0 ;
    Symbolic->Rperm_init = (long *) 0 ;
    Symbolic->Front_npivcol = (long *) 0 ;
    Symbolic->Front_parent = (long *) 0 ;
    Symbolic->Front_1strow = (long *) 0 ;
    Symbolic->Front_leftmostdesc = (long *) 0 ;
    Symbolic->Chain_start = (long *) 0 ;
    Symbolic->Chain_maxrows = (long *) 0 ;
    Symbolic->Chain_maxcols = (long *) 0 ;
    Symbolic->Cdeg = (long *) 0 ;
    Symbolic->Rdeg = (long *) 0 ;
    Symbolic->Esize = (long *) 0 ;
    Symbolic->Diagonal_map = (long *) 0 ;
    ...
    { Symbolic->Cperm_init = (long *) umf_l_malloc (Symbolic->n_col+1, sizeof (long)) ; if (Symbolic->Cperm_init == (long *) 0) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Cperm_init, sizeof (long), Symbolic->n_col+1, f) != Symbolic->n_col+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Rperm_init = (long *) umf_l_malloc (Symbolic->n_row+1, sizeof (long)) ; if (Symbolic->Rperm_init == (long *) 0) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Rperm_init, sizeof (long), Symbolic->n_row+1, f) != Symbolic->n_row+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Front_npivcol = (long *) umf_l_malloc (Symbolic->nfr+1, sizeof (long)) ; if (Symbolic->Front_npivcol == (long *) 0) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Front_npivcol, sizeof (long), Symbolic->nfr+1, f) != Symbolic->nfr+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Front_parent = (long *) umf_l_malloc (Symbolic->nfr+1, sizeof (long)) ; if (Symbolic->Front_parent == (long *) 0) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Front_parent, sizeof (long), Symbolic->nfr+1, f) != Symbolic->nfr+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Front_1strow = (long *) umf_l_malloc (Symbolic->nfr+1, sizeof (long)) ; if (Symbolic->Front_1strow == (long *) 0) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Front_1strow, sizeof (long), Symbolic->nfr+1, f) != Symbolic->nfr+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Front_leftmostdesc = (long *) umf_l_malloc (Symbolic->nfr+1, sizeof (long)) ; if (Symbolic->Front_leftmostdesc == (long *) 0) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Front_leftmostdesc, sizeof (long), Symbolic->nfr+1, f) != Symbolic->nfr+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Chain_start = (long *) umf_l_malloc (Symbolic->nchains+1, sizeof (long)) ; if (Symbolic->Chain_start == (long *) 0) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Chain_start, sizeof (long), Symbolic->nchains+1, f) != Symbolic->nchains+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Chain_maxrows = (long *) umf_l_malloc (Symbolic->nchains+1, sizeof (long)) ; if (Symbolic->Chain_maxrows == (long *) 0) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Chain_maxrows, sizeof (long), Symbolic->nchains+1, f) != Symbolic->nchains+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Chain_maxcols = (long *) umf_l_malloc (Symbolic->nchains+1, sizeof (long)) ; if (Symbolic->Chain_maxcols == (long *) 0) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Chain_maxcols, sizeof (long), Symbolic->nchains+1, f) != Symbolic->nchains+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Cdeg = (long *) umf_l_malloc (Symbolic->n_col+1, sizeof (long)) ; if (Symbolic->Cdeg == (long *) 0) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Cdeg, sizeof (long), Symbolic->n_col+1, f) != Symbolic->n_col+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Rdeg = (long *) umf_l_malloc (Symbolic->n_row+1, sizeof (long)) ; if (Symbolic->Rdeg == (long *) 0) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Rdeg, sizeof (long), Symbolic->n_row+1, f) != Symbolic->n_row+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    if (Symbolic->esize > 0)
    {

 { Symbolic->Esize = (long *) umf_l_malloc (Symbolic->esize, sizeof (long)) ; if (Symbolic->Esize == (long *) 0) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Esize, sizeof (long), Symbolic->esize, f) != Symbolic->esize) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    }
    if (Symbolic->prefer_diagonal)
    {

 { Symbolic->Diagonal_map = (long *) umf_l_malloc (Symbolic->n_col+1, sizeof (long)) ; if (Symbolic->Diagonal_map == (long *) 0) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Diagonal_map, sizeof (long), Symbolic->n_col+1, f) != Symbolic->n_col+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    }
