...
# 52 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
    ...
    if (((!(((double) fnr_min * (double) fnc_min * sizeof (DoubleComplex)) * (1.0+1e-8) <= (double) 0x7fffffffffffffffL
# 84 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
 ...
 return ((0)) ;
    ...
    if (((!((s * sizeof (DoubleComplex)) * (1.0+1e-8) <= (double) 0x7fffffffffffffffL
