# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_triplet_to_col.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_triplet_to_col.c"
# 37 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_triplet_to_col.c"
...
# 38 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_triplet_to_col.c" 2
...
# 39 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_triplet_to_col.c" 2
...
# 40 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_triplet_to_col.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_triplet.h" 1
...
# 41 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_triplet_to_col.c" 2
...
)
{
    ...
    long *RowCount, *Rp, *Rj, *W, nn, do_values, do_map, *Map2, status ;
    double *Rx ;
# 89 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_triplet_to_col.c"
    if (!Ai || !Ap || !Ti || !Tj)
    {
 return ((-5)) ;
    }
 ...
 return ((-8)) ;
    ...
    if (do_values)
    {
# 128 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_triplet_to_col.c"
 Rx = (double *) umf_l_malloc (nz+1, sizeof (double)) ;
 ...
 if (!Rx)
 {
    ...
    {
 ;
 Map2 = (long *) umf_l_malloc (nz+1, sizeof (long)) ;
 if (!Map2)
 {
     ;
     (void) umf_l_free ((void *) Rx) ;
     ;
     return ((-1)) ;
 }
    }

    Rj = (long *) umf_l_malloc (nz+1, sizeof (long)) ;
    Rp = (long *) umf_l_malloc (n_row+1, sizeof (long)) ;
    RowCount = (long *) umf_l_malloc (n_row, sizeof (long)) ;
    W = (long *) umf_l_malloc (nn, sizeof (long)) ;
    if (!Rj || !Rp || !RowCount || !W)
    {
 ;
 (void) umf_l_free ((void *) Rx) ;
 (void) umf_l_free ((void *) Map2) ;
 (void) umf_l_free ((void *) Rp) ;
 (void) umf_l_free ((void *) Rj) ;
 (void) umf_l_free ((void *) RowCount) ;
 ...
 if (do_values)
 {
     status = umfdl_triplet_map_x (n_row, n_col, nz, Ti, Tj, Ap, Ai, Rp,
 ...
 {
     status = umfdl_triplet_map_nox (n_row, n_col, nz, Ti, Tj, Ap, Ai, Rp,
 ...
 if (do_values)
 {
     status = umfdl_triplet_nomap_x (n_row, n_col, nz, Ti, Tj, Ap, Ai, Rp,
  Rj, W, RowCount , Tx, Ax, Rx
 ...
 {
     status = umfdl_triplet_nomap_nox (n_row, n_col, nz, Ti, Tj, Ap, Ai,
  Rp, Rj, W, RowCount) ;
 }
    }
