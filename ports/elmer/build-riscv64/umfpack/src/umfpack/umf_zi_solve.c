# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
# 26 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
...
# 27 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_lsolve.h" 1
...
# 28 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_usolve.h" 1
...
# 29 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_ltsolve.h" 1
...
(
 ...
 double umfzi_lhsolve
(
    NumericType *Numeric,
    DoubleComplex X [ ],
    int Pattern [ ]
) ;
# 30 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_utsolve.h" 1
...
(
 ...
 double umfzi_uhsolve
(
    NumericType *Numeric,
    DoubleComplex X [ ],
    int Pattern [ ]
) ;
# 31 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c" 2
...
# 32 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c" 2
...
# 97 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
    nz = 0 ;
    omega [0] = 0. ;
    omega [1] = 0. ;
    omega [2] = 0. ;
 ...
 split = ((Az) != (double *) 0) && ((Bz) != (double *) 0) && ((Xz) != (double *) 0) ;
...
# 184 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
    if (sys == (0))
    {
 ...
 if (irstep > 0)
 {
  ...
  { double r, ar, ai ; ar = (((((aij).component [0]) < 0.)) ? -((aij).component [0]) : ((aij).component [0])) ; ai = (((((aij).component [1]) < 0.)) ? -((aij).component [1]) : ((aij).component [1])) ; if (ar >= ai) { if (ar + ai == ar) { (d) = ar ; } else { r = ai / ar ; (d) = ar * sqrt (1.0 + r*r) ; } } else { if (ai + ar == ai) { (d) = ai ; } else { r = ar / ai ; (d) = ai * sqrt (1.0 + r*r) ; } } } ;
  Y [Ai [p]] += d ;
     }
  ...
  { if (split) { (bi).component [0] = (Bx)[i] ; (bi).component [1] = (Bz)[i] ; } else { (bi) = ((DoubleComplex *)(Bx))[i] ; } } ;
  { double r, ar, ai ; ar = (((((bi).component [0]) < 0.)) ? -((bi).component [0]) : ((bi).component [0])) ; ai = (((((bi).component [1]) < 0.)) ? -((bi).component [1]) : ((bi).component [1])) ; if (ar >= ai) { if (ar + ai == ar) { (B2 [i]) = ar ; } else { r = ai / ar ; (B2 [i]) = ar * sqrt (1.0 + r*r) ; } } else { if (ai + ar == ai) { (B2 [i]) = ai ; } else { r = ar / ai ; (B2 [i]) = ai * sqrt (1.0 + r*r) ; } } } ;
     }
 ...
 {
# 267 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
     if (step == 0)
     {
  if (do_scale)
  {
   ...
   for (i = 0 ; i < n ; i++)
   {
       { if (split) { (X [i]).component [0] = (Bx)[i] ; (X [i]).component [1] = (Bz)[i] ; } else { (X [i]) = ((DoubleComplex *)(Bx))[i] ; } } ;
  ...
  else
  {
   ...
   { if (split) { (W [i]).component [0] = (Bx)[Rperm [i]] ; (W [i]).component [1] = (Bz)[Rperm [i]] ; } else { (W [i]) = ((DoubleComplex *)(Bx))[Rperm [i]] ; } } ;
      }
  }
     }
     else
  ...
  for (i = 0 ; i < n ; i++)
  {
      ...
      { if (split) { (Z [i]).component [0] = (Bx)[i] ; (Z [i]).component [1] = (Bz)[i] ; } else { (Z [i]) = ((DoubleComplex *)(Bx))[i] ; } } ;
  }
  flops += 8. * nz ;
  for (i = 0 ; i < n ; i++)
  {
  ...
  for (i = 0 ; i < n ; i++)
  {
     ...
     flops += umfzi_lsolve (Numeric, W, Pattern) ;
     flops += umfzi_usolve (Numeric, W, Pattern) ;
  ...
  for (i = 0 ; i < n ; i++)
  {
      ...
      { if (split) { (W [i]).component [0] = (Bx)[i] ; (W [i]).component [1] = (Bz)[i] ; } else { (W [i]) = ((DoubleComplex *)(Bx))[i] ; } } ;
      Z2 [i] = 0. ;
  }
  flops += (6. + 2. + 6. + 1) * nz ;
  for (j = 0 ; j < n ; j++)
  {
   ...
   { double r, ar, ai ; ar = (((((axx).component [0]) < 0.)) ? -((axx).component [0]) : ((axx).component [0])) ; ai = (((((axx).component [1]) < 0.)) ? -((axx).component [1]) : ((axx).component [1])) ; if (ar >= ai) { if (ar + ai == ar) { (d) = ar ; } else { r = ai / ar ; (d) = ar * sqrt (1.0 + r*r) ; } } else { if (ai + ar == ai) { (d) = ai ; } else { r = ar / ai ; (d) = ai * sqrt (1.0 + r*r) ; } } } ;
   Z2 [i] += d ;
      }
  }
 ...
 for (step = 0 ; step <= irstep ; step++)
 {
# 565 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
     if (step == 0)
     {
  ...
  for (i = 0 ; i < n ; i++)
  {
      ...
      { if (split) { (W [i]).component [0] = (Bx)[Cperm [i]] ; (W [i]).component [1] = (Bz)[Cperm [i]] ; } else { (W [i]) = ((DoubleComplex *)(Bx))[Cperm [i]] ; } } ;
  }
     }
     else
     {
  ...
  for (i = 0 ; i < n ; i++)
  {
     ...
     flops += umfzi_uhsolve (Numeric, W, Pattern) ;
     flops += umfzi_lhsolve (Numeric, W, Pattern) ;
  ...
  for (i = 0 ; i < n ; i++)
  {
      ...
      { if (split) { (wi).component [0] = (Bx)[i] ; (wi).component [1] = (Bz)[i] ; } else { (wi) = ((DoubleComplex *)(Bx))[i] ; } } ;
      z2i = 0. ;
      p2 = Ap [i+1] ;
      for (p = Ap [i] ; p < p2 ; p++)
      {
 ...
 for (step = 0 ; step <= irstep ; step++)
 {
# 838 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
     if (step == 0)
     {
  ...
  for (i = 0 ; i < n ; i++)
  {
     ...
     flops += umfzi_utsolve (Numeric, W, Pattern) ;
     flops += umfzi_ltsolve (Numeric, W, Pattern) ;
 ...
 for (i = 0 ; i < n ; i++)
 {
     ...
     { if (split) { (X [i]).component [0] = (Bx)[Rperm [i]] ; (X [i]).component [1] = (Bz)[Rperm [i]] ; } else { (X [i]) = ((DoubleComplex *)(Bx))[Rperm [i]] ; } } ;
 }
 flops = umfzi_lsolve (Numeric, X, Pattern) ;
 status = (0) ;
 ...
 flops = umfzi_lhsolve (Numeric, X, Pattern) ;
 status = (0) ;
 ...
 flops = umfzi_ltsolve (Numeric, X, Pattern) ;
 status = (0) ;
 ...
 flops = umfzi_usolve (Numeric, X, Pattern) ;
 ...
 for (i = 0 ; i < n ; i++)
 {
     ...
     { if (split) { (X [i]).component [0] = (Bx)[Cperm [i]] ; (X [i]).component [1] = (Bz)[Cperm [i]] ; } else { (X [i]) = ((DoubleComplex *)(Bx))[Cperm [i]] ; } } ;
 }
 flops = umfzi_uhsolve (Numeric, X, Pattern) ;
 ...
 flops = umfzi_utsolve (Numeric, X, Pattern) ;
...
# 1232 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
static int do_step
(
    double omega [3],
    int step,
...
)
{
    ...
    nctau = 1000 * n * ((double)2.22044604925031308084726333618164062e-16L) 
# 1252 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
                                  ;
    ;
   
                              ;
# 1264 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
 ...
 { double r, ar, ai ; ar = (((((X [i]).component [0]) < 0.)) ? -((X [i]).component [0]) : ((X [i]).component [0])) ; ai = (((((X [i]).component [1]) < 0.)) ? -((X [i]).component [1]) : ((X [i]).component [1])) ; if (ar >= ai) { if (ar + ai == ar) { (xi) = ar ; } else { r = ai / ar ; (xi) = ar * sqrt (1.0 + r*r) ; } } else { if (ai + ar == ai) { (xi) = ai ; } else { r = ar / ai ; (xi) = ai * sqrt (1.0 + r*r) ; } } } ;
 if (((xi) != (xi)))
 {
     xnorm = xi ;
     break ;
 ...
 { double r, ar, ai ; ar = (((((W [i]).component [0]) < 0.)) ? -((W [i]).component [0]) : ((W [i]).component [0])) ; ai = (((((W [i]).component [1]) < 0.)) ? -((W [i]).component [1]) : ((W [i]).component [1])) ; if (ar >= ai) { if (ar + ai == ar) { (wi) = ar ; } else { r = ai / ar ; (wi) = ar * sqrt (1.0 + r*r) ; } } else { if (ai + ar == ai) { (wi) = ai ; } else { r = ar / ai ; (wi) = ai * sqrt (1.0 + r*r) ; } } } ;
 if (((d1) != (d1)))
 {
     omega [1] = d1 ;
     omega [2] = d1 ;
 ...
 return ((1)) ;
    ...
    if (omega [0] < ((double)2.22044604925031308084726333618164062e-16L)
# 1340 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_solve.c"
                              )
    {
 ;
