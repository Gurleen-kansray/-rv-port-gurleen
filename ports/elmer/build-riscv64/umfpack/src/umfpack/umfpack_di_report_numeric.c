...
)
{
 ...
 + (((((sizeof (double) * (n_inner+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
 ...
 + ((Numeric->scale != 0) ?
  (((((sizeof (double) * (n_row))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) : 0) ;
 ...
 (void) umfdi_report_vector (n_row, Numeric->Rs, (double *) 0,
     prl, (0), (1)) ;
    }
    else
    {
 ...
 return ((-3)) ;
    ...
    { if (prl >= (4)) { { (void) printf ("\ndiagonal of U: ") ; } ; } } ;
    (void) umfdi_report_vector (n_inner, (double *) Numeric->D, (double *) 0,
 prl, (0), (0)) ;
 ...
 *Lip, newLchain, llen, prl1, pos, lp, p, npiv, n1, *Li ;
 ...
 for (j = 0 ; j < deg ; j++)
 {
     ...
     if (prl >= 4) { if (((Lval [j]) != 0.)) { { (void) printf (" (%g)", (Lval [j])) ; } ; } else { { (void) printf (" (0)") ; } ; } } ;
     if (row <= k || row >= n_row)
     {
  return ((0)) ;
     }
 ...
 xp = (double *) (Numeric->Memory + p) ;
 if ((llen > 0 || deg > 0)
     && (p + (int) (((((sizeof (double) * (deg))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) > Numeric->size))
 {
     return ((0)) ;
 }
 if (llen > 0)
 ...
 for (j = 0 ; j < deg ; j++)
 {
     row = Pattern [j] ;
     { if (prl >= (4)) { { (void) printf ("\trow ""%d"" : ", (row)) ; } ; } } ;
     if (prl >= 4) { if (((*xp) != 0.)) { { (void) printf (" (%g)", (*xp)) ; } ; } else { { (void) printf (" (0)") ; } ; } } ;
     if (row <= k || row >= n_row)
     {
  return ((0)) ;
     }
 ...
 *Uip, n_col, ulen, p, newUchain, up, npiv, n1, *Ui ;
 ...
 xp = (double *) (Numeric->Memory + p) ;
 if (deg > 0 && (p + (int) (((((sizeof (double) * (deg))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) > Numeric->size))
 {
     return ((0)) ;
 }
 for (j = 0 ; j < deg ; j++)
 ...
 for (j = 0 ; j < deg ; j++)
 {
     col = Ui [j] ;
     { if (prl >= (4)) { { (void) printf ("\tcol ""%d"" : ", (col)) ; } ; } } ;
     if (prl >= 4) { if (((Uval [j]) != 0.)) { { (void) printf (" (%g)", (Uval [j])) ; } ; } else { { (void) printf (" (0)") ; } ; } } ;
     if (col <= k || col >= n_col)
     {
  return ((0)) ;
     }
