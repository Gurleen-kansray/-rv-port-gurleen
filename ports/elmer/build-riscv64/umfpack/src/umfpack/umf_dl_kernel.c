# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c"
# 20 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c"
...
# 21 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_kernel_init.h" 1
...
# 22 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_init_front.h" 1
 ...
 long umfdl_init_front
(
    NumericType *Numeric,
    WorkType *Work
) ;
# 23 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_start_front.h" 1
...
# 24 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_assemble.h" 1
...
(
 ...
 void umfdl_assemble_fixq
(
    NumericType *Numeric,
    WorkType *Work
) ;
# 25 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_scale_column.h" 1
 ...
 void umfdl_scale_column
(
    NumericType *Numeric,
    WorkType *Work
) ;
# 26 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_local_search.h" 1
...
# 27 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_create_element.h" 1
 ...
 long umfdl_create_element
(
    NumericType *Numeric,
    WorkType *Work,
    SymbolicType *Symbolic
) ;
# 28 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_extend_front.h" 1
 ...
 long umfdl_extend_front
(
    NumericType *Numeric,
    WorkType *Work
) ;
# 29 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_blas3_update.h" 1
 ...
 void umfdl_blas3_update
(
    WorkType *Work
) ;
# 30 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_store_lu.h" 1
...
(
 ...
 long umfdl_store_lu_drop
(
    NumericType *Numeric,
    WorkType *Work
) ;
# 31 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_kernel_wrapup.h" 1
 ...
 void umfdl_kernel_wrapup
(
    NumericType *Numeric,
    SymbolicType *Symbolic,
    WorkType *Work
) ;
# 32 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c" 2
...
# 105 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c"
 ...
 { if (! (umfdl_start_front (chain, Numeric, Work, Symbolic))) { return ((-1)) ; }} ;
 ...
 for (Work->frontid = f1 ; Work->frontid <= f2 ; Work->frontid++)
 {
  ...
  status = umfdl_local_search (Numeric, Work, Symbolic) ;
  if (status == (-11))
  {
  ...
  if (Work->do_update)
  {
      umfdl_blas3_update (Work) ;
      if (drop)
      {
   { if (! (umfdl_store_lu_drop (Numeric, Work))) { return ((-1)) ; }} ;
      }
      else
      {
   { if (! (umfdl_store_lu (Numeric, Work))) { return ((-1)) ; }} ;
      }
  }
  ...
  if (Work->do_extend)
  {
      ...
      { if (! (umfdl_extend_front (Numeric, Work))) { return ((-1)) ; }} ;
  }
  else
  {

      { if (! (umfdl_create_element (Numeric, Work, Symbolic))) { return ((-1)) ; }} ;
      { if (! (umfdl_init_front (Numeric, Work))) { return ((-1)) ; }} ;
  }
  ...
  if (fixQ)
  {
      umfdl_assemble_fixq (Numeric, Work) ;
  }
  else
  {
      umfdl_assemble (Numeric, Work) ;
  }
  ...
  umfdl_scale_column (Numeric, Work) ;
  ...
  if (evaporate)
  {
      ...
      (void) umfdl_create_element (Numeric, Work, Symbolic) ;
      Work->fnrows = 0 ;
      Work->fncols = 0 ;
  }
     }
 }
# 270 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_kernel.c"
 umfdl_blas3_update (Work) ;
 if (drop)
 {
     { if (! (umfdl_store_lu_drop (Numeric, Work))) { return ((-1)) ; }} ;
 ...
 Work->fncols = 0 ;
    ...
    umfdl_kernel_wrapup (Numeric, Symbolic, Work) ;
