...
# 52 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
    ...
    if (((!(((double) fnr_min * (double) fnc_min * sizeof (double)) * (1.0+1e-8) <= (double) 0x7fffffffffffffffL
# 84 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
       )) || (((double) fnr_min * (double) fnc_min * sizeof (double)) != ((double) fnr_min * (double) fnc_min * sizeof (double)))))
    {
 ...
 return ((0)) ;
    ...
    if (((!((s * sizeof (double)) * (1.0+1e-8) <= (double) 0x7fffffffffffffffL
# 110 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
 ...
 double a = 0.9 * sqrt ((0x7fffffffffffffffL 
# 115 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
 ...
 ;
 umfdl_mem_free_tail_block (Numeric, E [0]) ;
 E [0] = 0 ;
...
# 166 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_grow_front.c"
    ;
    eloc = umfdl_mem_alloc_tail_block (Numeric, (((((sizeof (double) * (newsize))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
 ...
 ;
 if (!umfdl_get_memory (Numeric, Work, 1 + (((((sizeof (double) * (newsize))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))),
 ...
 return ((0)) ;
    ...
    Work->Flublock = (double *) (Numeric->Memory + eloc) ;
