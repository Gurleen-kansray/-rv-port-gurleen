...
static void shift_pivot_row (double *Fd, double *Fs, double *Fe, int len, int d)
{
    int j ;
#pragma ivdep
    for (j = 0 ; j < len ; j++)
...
# 373 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_scale_column.c"
    ...
    umfdi_scale (fnrows, pivot_value, Fcol) ;





    umfdi_mem_free_tail_block (Numeric, Row_tuples [pivrow]) ;
    umfdi_mem_free_tail_block (Numeric, Col_tuples [pivcol]) ;
