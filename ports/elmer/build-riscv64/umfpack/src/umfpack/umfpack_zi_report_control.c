# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_control.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_control.c"
# 16 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_control.c"
...
# 17 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_control.c" 2
...
# 53 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_control.c"
    { (void) printf ("    Matrix entry defined as: double complex\n") ; } ;
    { (void) printf ("    Int (generic integer) defined as: int\n") ; } ;
# 65 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_control.c"
    { (void) printf ("\n    ""%d"": print level: ""%d""\n", (int) (0), prl) ; }
                                  ;
    ...
    { (void) printf ("    ""%d"": dense row parameter:    %g\n", (int) (1), drow) ; }
                                         ;
    { (void) printf ("        \"dense\" rows have    > max (16, (%g)*16*sqrt(n_col)" " entries)\n", drow) ; }
                       ;
    { (void) printf ("    ""%d"": dense column parameter: %g\n", (int) (2), dcol) ; }
                                         ;
    { (void) printf ("        \"dense\" columns have > max (16, (%g)*16*sqrt(n_row)" " entries)\n", dcol) ; }
                       ;
    ...
    { (void) printf ("    ""%d"": pivot tolerance: %g\n", (int) (3), relpt) ; }
                                                ;
    ...
    nb = (((1) > (nb)) ? (1) : (nb)) ;
    { (void) printf ("    ""%d"": block size for dense matrix kernels: ""%d""\n", (int) (4), nb) ; }
                                        ;
 ...
 strategy = 0 ;
    ...
    { (void) printf ("    ""%d"": strategy: ""%d", (int) (5), strategy) ; }
                                            ;
 ...
 { (void) printf (" (auto)\n") ; } ;
    ...
    if (alloc_init >= 0)
    {
 { (void) printf ("    ""%d"": initial allocation ratio: %g\n", (int) (6), alloc_init) ; }
                                                ;
    }
    else
    {
 s = -alloc_init ;
 s = (((1) > (s)) ? (1) : (s)) ;
 { (void) printf ("    ""%d"": initial allocation (in Units): ""%d""\n", (int) (6), s) ; }
                                       ;
    }
    ...
    irstep = ((Control != (double *) 0) ? (((Control [7]) != (Control [7])) ? 2 : Control [7]) : 2) ;
    irstep = (((0) > (irstep)) ? (0) : (irstep)) ;
    { (void) printf ("    ""%d"": max iterative refinement steps: ""%d""\n", (int) (7), irstep) ; }
                                        ;
    ...
    { (void) printf ("    ""%d"": 2-by-2 pivot tolerance: %g\n", (int) (12), tol) ; }
                                             ;
    ...
    { (void) printf ("    ""%d"": Q fixed during numerical factorization: %g ", (int) (13), force_fixQ) ; }
                                          ;
    if (force_fixQ > 0)
    {
 { (void) printf ("(yes)\n") ; } ;
 ...
 { (void) printf ("(auto)\n") ; } ;
    ...
    amd_alpha = ((Control != (double *) 0) ? (((Control [14]) != (Control [14])) ? 10.0 : Control [14]) : 10.0) ;
    { (void) printf ("    ""%d"": AMD dense row/col parameter:    %g\n", (int) (14), amd_alpha) ; }
                                              ;
    if (amd_alpha < 0)
    {
 { (void) printf ("       no \"dense\" rows/columns\n") ; } ;
    }
    else
    {
 { (void) printf ("       \"dense\" rows/columns have > max (16, (%g)*sqrt(n))" " entries\n", amd_alpha) ; }
                               ;
    }
    { (void) printf ("        Only used if the AMD ordering is used.\n") ; } ;
    ...
    { (void) printf ("    ""%d"": diagonal pivot tolerance: %g\n" "        Only used if diagonal pivoting is attempted.\n", (int) (15), relpt2) ; }
 ...
 scale = 1 ;
    ...
    { (void) printf ("    ""%d"": scaling: ""%d", (int) (16), scale) ; } ;
    if (scale == 0)
    {
 { (void) printf (" (no)") ; } ;
    }
    ...
    {
 { (void) printf (" (divide each row by sum of abs. values in each row)") ; } ;
    }
    else if (scale == 2)
    {
 { (void) printf (" (divide each row by max. abs. value in each row)") ; } ;
    }
    { (void) printf ("\n") ; } ;
    ...
    {
 { (void) printf ("    ""%d"": frontal matrix allocation ratio: %g\n", (int) (17), front_alloc_init) ; }
                                                            ;
    }
    else
    {
 s = -front_alloc_init ;
 s = (((1) > (s)) ? (1) : (s)) ;
 { (void) printf ("    ""%d"": initial frontal matrix size (# of Entry's): ""%d""\n", (int) (17), s) ; }
                                             ;
    }
    ...
    { (void) printf ("    ""%d"": drop tolerance: %g\n", (int) (18), droptol) ; }
                                          ;
    ...
    aggr = ((Control != (double *) 0) ? (((Control [19]) != (Control [19])) ? 1 : Control [19]) : 1) ;
    { (void) printf ("    ""%d"": AMD and COLAMD aggressive absorption: %g", (int) (19), aggr) ; }
                                          ;
    if (aggr != 0.0)
    {
 { (void) printf (" (yes)\n") ; } ;
 ...
 { (void) printf (" (no)\n") ; } ;
    ...
    { (void) printf ("    ""%d"": BLAS library used:  ", (int) (8)) ; }
                                            ;


    { (void) printf ("none.  UMFPACK will be slow.\n") ; } ;
# 337 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_control.c"
    { (void) printf ("    ""%d"": compiled for ANSI C" " (uses malloc, free, realloc, and printf)\n", (int) (9)) ; }

                                             ;
# 348 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_control.c"
    { (void) printf ("    ""%d"": CPU timer is POSIX times ( ) routine.\n", (int) (10)) ; }
                                                 ;
# 376 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_report_control.c"
    { (void) printf ("    ""%d"": compiled for normal operation (debugging disabled)\n", (int) (11)) ; }
                                                ;


    { (void) printf ("    computer/operating system: %s\n", "Linux") ; } ;
    { (void) printf ("    size of int: %g long: %g Int: %g pointer: %g" " double: %g Entry: %g (in bytes)\n\n", (double) sizeof (int), (double) sizeof (long), (double) sizeof (int), (double) sizeof (void *), (double) sizeof (double), (double) sizeof (DoubleComplex)) ; }
