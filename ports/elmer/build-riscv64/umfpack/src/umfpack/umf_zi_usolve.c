# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_usolve.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_usolve.c"
# 15 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_usolve.c"
...
# 16 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_usolve.c" 2
 ...
 *Uip, n, ulen, up, newUchain, npiv, n1, *Ui ;
    ...
    D = Numeric->D ;
    n1 = Numeric->n1 ;
# 62 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_usolve.c"
    for (k = n-1 ; k >= npiv ; k--)
    {
 ...
 { double r, den, ar, ai, br, bi ; br = (D [k]).component [0] ; bi = (D [k]).component [1] ; ar = (xk).component [0] ; ai = (xk).component [1] ; if (((((br) < 0.)) ? -(br) : (br)) >= ((((bi) < 0.)) ? -(bi) : (bi))) { r = bi / br ; den = br + r * bi ; (X [k]).component [0] = (ar + ai * r) / den ; (X [k]).component [1] = (ai - ar * r) / den ; } else { r = br / bi ; den = r * br + bi ; (X [k]).component [0] = (ar * r + ai) / den ; (X [k]).component [1] = (ai * r - ar) / den ; } } ;
    }
 ...
 { double r, den, ar, ai, br, bi ; br = (D [k]).component [0] ; bi = (D [k]).component [1] ; ar = (xk).component [0] ; ai = (xk).component [1] ; if (((((br) < 0.)) ? -(br) : (br)) >= ((((bi) < 0.)) ? -(bi) : (bi))) { r = bi / br ; den = br + r * bi ; (X [k]).component [0] = (ar + ai * r) / den ; (X [k]).component [1] = (ai - ar * r) / den ; } else { r = br / bi ; den = r * br + bi ; (X [k]).component [0] = (ar * r + ai) / den ; (X [k]).component [1] = (ai * r - ar) / den ; } } ;
# 140 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_usolve.c"
 if (k == n1) break ;
 ...
 { double r, den, ar, ai, br, bi ; br = (D [k]).component [0] ; bi = (D [k]).component [1] ; ar = (xk).component [0] ; ai = (xk).component [1] ; if (((((br) < 0.)) ? -(br) : (br)) >= ((((bi) < 0.)) ? -(bi) : (bi))) { r = bi / br ; den = br + r * bi ; (X [k]).component [0] = (ar + ai * r) / den ; (X [k]).component [1] = (ai - ar * r) / den ; } else { r = br / bi ; den = r * br + bi ; (X [k]).component [0] = (ar * r + ai) / den ; (X [k]).component [1] = (ai * r - ar) / den ; } } ;
# 213 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_usolve.c"
    }
# 225 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_usolve.c"
