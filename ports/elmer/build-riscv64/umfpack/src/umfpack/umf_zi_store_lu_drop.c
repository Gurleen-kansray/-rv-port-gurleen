...
# 258 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_store_lu.c"
 ...
 else
 {
     newLchain =
      ...
      (((((sizeof (DoubleComplex) * (lnz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (int) * (lnz))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
  <=

      (((((sizeof (DoubleComplex) * (lnz2x))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (int) * (lnz2i))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 }
 ...
 size = (((((sizeof (int) * (lnzi))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (DoubleComplex) * (lnzx))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
# 320 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_store_lu.c"
 ...
 if (!p)
 {
  ...
  c2 = (((fncols) > (Work->fncols_new + 1)) ? (fncols) : (Work->fncols_new + 1)) ;
     ...
     ;
     if (!umfzi_get_memory (Numeric, Work, size, r2, c2, (1)))
     {
  ;
  return ((0)) ;
     }
...
# 690 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_store_lu.c"
 ...
 else
 {
     newUchain =
      ...
      (((((sizeof (DoubleComplex) * (unz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (int) * (unz))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
  <=

      (((((sizeof (DoubleComplex) * (unz2x))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (int) * (unz2i))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
