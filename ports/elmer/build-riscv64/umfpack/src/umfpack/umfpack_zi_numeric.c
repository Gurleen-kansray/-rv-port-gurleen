# 0 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
# 22 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
...
# 23 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_valid_symbolic.h" 1
 ...
 int umfzi_valid_symbolic
(
    SymbolicType *Symbolic
) ;
# 24 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c" 2
...
# 25 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_kernel.h" 1
...
# 26 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c" 2
...
# 27 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c" 2
...
# 28 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c" 2
# 1 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/include/umf_realloc.h" 1
...
# 29 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c" 2





static int work_alloc
(
    WorkType *Work,
    SymbolicType *Symbolic
) ;
...
)
{
 ...
 front_alloc_init, stats [2] ;
    ...
    umfpack_tic (stats) ;
# 112 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
    relpt = ((Control != (double *) 0) ? (((Control [3]) != (Control [3])) ? 0.1 : Control [3]) : 0.1)
                                  ;
    relpt2 = ((Control != (double *) 0) ? (((Control [15]) != (Control [15])) ? 0.001 : Control [15]) : 0.001)
                                      ;
    alloc_init = ((Control != (double *) 0) ? (((Control [6]) != (Control [6])) ? 0.7 : Control [6]) : 0.7) ;
    front_alloc_init = ((Control != (double *) 0) ? (((Control [17]) != (Control [17])) ? 0.5 : Control [17]) : 0.5)
                                   ;
    scale = ((Control != (double *) 0) ? (((Control [16]) != (Control [16])) ? 1 : Control [16]) : 1) ;
    droptol = ((Control != (double *) 0) ? (((Control [18]) != (Control [18])) ? 0 : Control [18]) : 0) ;
 ...
 for (i = 0 ; i < 90 ; i++)
 {
    ...
    if (!umfzi_valid_symbolic (Symbolic))
    {
 Info [0] = (-4) ;
 return ((-4)) ;
    }
    ...
    if (Symbolic->ordering == 1 && alloc_init >= 0)
    {
 ...
 alloc_init *= (1.2) ;
    ...
    if (((!((Symbolic->dnum_mem_init_usage * sizeof (Unit)) * (1.0+1e-8) <= (double) 0x7fffffff
# 177 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
       )) || ((Symbolic->dnum_mem_init_usage * sizeof (Unit)) != (Symbolic->dnum_mem_init_usage * sizeof (Unit)))))
    {
 ...
 return ((-5)) ;
    ...
    Info [2] = Ap [n_col] ;
    *NumericHandle = (void *) 0 ;
# 216 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
    Work = &WorkSpace ;
    Work->n_row = n_row ;
    Work->n_col = n_col ;
 ...
 return ((-1)) ;
    ...
    ;
# 247 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
 ...
 return ((-1)) ;
    ...
    Numeric->scale = scale ;
                                               ...
                                               ;
# 288 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
    ;
    status = umfzi_kernel (Ap, Ai, Ax,
 ...
 Info [76] = Work->noff_diagonal ;
    ...
    npiv = Numeric->npiv ;
    ulen = Numeric->ulen ;
# 327 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
    ...
    ;
                                       ...
                                       ;
# 348 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
    if (npiv < n_row)
    {

 inew = (int *) umf_i_realloc (Numeric->Lpos, npiv+1, sizeof (int)) ;
 if (inew)
 {
     Numeric->Lpos = inew ;
 }
 inew = (int *) umf_i_realloc (Numeric->Uilen, npiv+1, sizeof (int)) ;
 if (inew)
 {
     Numeric->Uilen = inew ;
 }
 inew = (int *) umf_i_realloc (Numeric->Uip, npiv+1, sizeof (int)) ;
 if (inew)
 {
     Numeric->Uip = inew ;
 }
 ...
 inew = (int *) umf_i_realloc (Numeric->Upos, npiv+1, sizeof (int)) ;
 if (inew)
 {
     Numeric->Upos = inew ;
 }
 inew = (int *) umf_i_realloc (Numeric->Lilen, npiv+1, sizeof (int)) ;
 if (inew)
 {
     Numeric->Lilen = inew ;
 }
 inew = (int *) umf_i_realloc (Numeric->Lip, npiv+1, sizeof (int)) ;
 if (inew)
 {
     Numeric->Lip = inew ;
 }
    }
# 396 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
    ;
    ;
    if (ulen > 0 && ulen < n_col)
    {
 inew = (int *) umf_i_realloc (Numeric->Upattern, ulen+1, sizeof (int)) ;
 if (inew)
 {
     Numeric->Upattern = inew ;
 }
    }
# 416 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
    newsize = Numeric->ihead ;
    if (newsize < Numeric->size)
    {
 mnew = (Unit *) umf_i_realloc (Numeric->Memory, newsize, sizeof (Unit)) ;
 if (mnew)
 {
...
# 531 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
static int numeric_alloc
(
    NumericType **NumericHandle,
    SymbolicType *Symbolic,
...
)
{
    ...
    n_col = Symbolic->n_col ;
    n_inner = (((n_row) < (n_col)) ? (n_row) : (n_col)) ;
    *NumericHandle = (NumericType *) 0 ;



    Numeric = (NumericType *) umf_i_malloc (1, sizeof (NumericType)) ;
 ...
 return ((0)) ;
    ...
    *NumericHandle = Numeric ;
    ...
    Numeric->D = (DoubleComplex *) umf_i_malloc (n_inner+1, sizeof (DoubleComplex)) ;
    Numeric->Rperm = (int *) umf_i_malloc (n_row+1, sizeof (int)) ;
    Numeric->Cperm = (int *) umf_i_malloc (n_col+1, sizeof (int)) ;
    Numeric->Lpos = (int *) umf_i_malloc (n_row+1, sizeof (int)) ;
    Numeric->Lilen = (int *) umf_i_malloc (n_col+1, sizeof (int)) ;
    Numeric->Lip = (int *) umf_i_malloc (n_col+1, sizeof (int)) ;
    Numeric->Upos = (int *) umf_i_malloc (n_col+1, sizeof (int)) ;
    Numeric->Uilen = (int *) umf_i_malloc (n_row+1, sizeof (int)) ;
    Numeric->Uip = (int *) umf_i_malloc (n_row+1, sizeof (int)) ;
    ...
    {
 ;
 Numeric->Rs = (double *) umf_i_malloc (n_row, sizeof (double)) ;
    }
    else
    {
 ;
 ...
 nsize = (alloc_init * Symbolic->num_mem_usage_est) + 1 ;
    ...
    bsize = ((double) 0x7fffffff
# 623 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
                            ) / sizeof (Unit) - 1 ;
    ;
    ...
    while (trying)
    {
 Numeric->Memory = (Unit *) umf_i_malloc (Numeric->size, sizeof (Unit)) ;
 if (Numeric->Memory)
 {
     ;
     return ((1)) ;
...
# 661 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
static int work_alloc
(
    WorkType *Work,
    SymbolicType *Symbolic
)
{
    ...
    Work->Wx = (DoubleComplex *) umf_i_malloc (maxnrows + 1, sizeof (DoubleComplex)) ;
    Work->Wy = (DoubleComplex *) umf_i_malloc (maxnrows + 1, sizeof (DoubleComplex)) ;
    Work->Frpos = (int *) umf_i_malloc (n_row + 1, sizeof (int)) ;
    Work->Lpattern = (int *) umf_i_malloc (n_row + 1, sizeof (int)) ;
    Work->Fcpos = (int *) umf_i_malloc (n_col + 1, sizeof (int)) ;
    Work->Wp = (int *) umf_i_malloc (nn + 1, sizeof (int)) ;
    Work->Wrp = (int *) umf_i_malloc ((((n_col) > (maxnrows)) ? (n_col) : (maxnrows)) + 1, sizeof (int)) ;
    Work->Frows = (int *) umf_i_malloc (maxnrows + 1, sizeof (int)) ;
    Work->Wm = (int *) umf_i_malloc (maxnrows + 1, sizeof (int)) ;
    Work->Fcols = (int *) umf_i_malloc (maxncols + 1, sizeof (int)) ;
    Work->Wio = (int *) umf_i_malloc (maxncols + 1, sizeof (int)) ;
    Work->Woi = (int *) umf_i_malloc (maxncols + 1, sizeof (int)) ;
    Work->Woo = (int *) umf_i_malloc (maxnrc + 1, sizeof (int));
    Work->elen = (n_col - n1) + (n_row - n1) + (((n_col-n1) < (n_row-n1)) ? (n_col-n1) : (n_row-n1)) + 1 ;
    Work->E = (int *) umf_i_malloc (Work->elen, sizeof (int)) ;
    Work->Front_new1strow = (int *) umf_i_malloc (nfr + 1, sizeof (int)) ;
 ...
 && Work->E && Work->Front_new1strow && Work->Wx && Work->Wy) ;
    ...
    if (Symbolic->prefer_diagonal)
    {
 Work->Diagonal_map = (int *) umf_i_malloc (nn, sizeof (int)) ;
 Work->Diagonal_imap = (int *) umf_i_malloc (nn, sizeof (int)) ;
 ok = ok && Work->Diagonal_map && Work->Diagonal_imap ;
    }
    else
    {

 Work->Diagonal_map = (int *) 0 ;
 Work->Diagonal_imap = (int *) 0 ;
    }


    Work->Upattern = (int *) umf_i_malloc (n_col + 1, sizeof (int)) ;
    ok = ok && Work->Upattern ;


    Work->Flublock = (DoubleComplex *) 0 ;
    Work->Flblock = (DoubleComplex *) 0 ;
    Work->Fublock = (DoubleComplex *) 0 ;
    Work->Fcblock = (DoubleComplex *) 0 ;
...
)
{
 ...
 Work->Wx = (DoubleComplex *) umf_i_free ((void *) Work->Wx) ;
 Work->Wy = (DoubleComplex *) umf_i_free ((void *) Work->Wy) ;
 Work->Frpos = (int *) umf_i_free ((void *) Work->Frpos) ;
 Work->Fcpos = (int *) umf_i_free ((void *) Work->Fcpos) ;
 Work->Lpattern = (int *) umf_i_free ((void *) Work->Lpattern) ;
 Work->Upattern = (int *) umf_i_free ((void *) Work->Upattern) ;
 Work->Wp = (int *) umf_i_free ((void *) Work->Wp) ;
 Work->Wrp = (int *) umf_i_free ((void *) Work->Wrp) ;
 Work->Frows = (int *) umf_i_free ((void *) Work->Frows) ;
 Work->Fcols = (int *) umf_i_free ((void *) Work->Fcols) ;
 Work->Wio = (int *) umf_i_free ((void *) Work->Wio) ;
 Work->Woi = (int *) umf_i_free ((void *) Work->Woi) ;
 Work->Woo = (int *) umf_i_free ((void *) Work->Woo) ;
 Work->Wm = (int *) umf_i_free ((void *) Work->Wm) ;
 Work->E = (int *) umf_i_free ((void *) Work->E) ;
 Work->Front_new1strow =
     (int *) umf_i_free ((void *) Work->Front_new1strow) ;


 Work->Diagonal_map = (int *) umf_i_free ((void *) Work->Diagonal_map) ;
 Work->Diagonal_imap = (int *) umf_i_free ((void *) Work->Diagonal_imap) ;
    }
    ;
}
# 783 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
static void error
(
    NumericType **Numeric,
    WorkType *Work
