...
# 258 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_store_lu.c"
 ...
 else
 {
     newLchain =
      ...
      (((((sizeof (double) * (lnz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (long) * (lnz))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
  <=

      (((((sizeof (double) * (lnz2x))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (long) * (lnz2i))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 }
 ...
 size = (((((sizeof (long) * (lnzi))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (double) * (lnzx))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
# 320 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_store_lu.c"
 ...
 if (!p)
 {
  ...
  c2 = (((fncols) > (Work->fncols_new + 1)) ? (fncols) : (Work->fncols_new + 1)) ;
     ...
     ;
     if (!umfdl_get_memory (Numeric, Work, size, r2, c2, (1)))
     {
  ;
  return ((0)) ;
     }
...
# 690 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_store_lu.c"
 ...
 else
 {
     newUchain =
      ...
      (((((sizeof (double) * (unz))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (long) * (unz))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
  <=

      (((((sizeof (double) * (unz2x))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) + (((((sizeof (long) * (unz2i))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
