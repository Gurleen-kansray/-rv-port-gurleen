...
# 112 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umfpack_numeric.c"
 ...
 alloc_init *= (1.2) ;
    ...
    if (((!((Symbolic->dnum_mem_init_usage * sizeof (Unit)) * (1.0+1e-8) <= (double) 0x7fffffffffffffffL
...
)
{
 ...
 return ((0)) ;
    ...
    *NumericHandle = Numeric ;
    ...
    Numeric->D = (double *) umf_l_malloc (n_inner+1, sizeof (double)) ;
 ...
 nsize = (alloc_init * Symbolic->num_mem_usage_est) + 1 ;
    ...
    bsize = ((double) 0x7fffffffffffffffL
...
)
{
    ...
    Work->Wx = (double *) umf_l_malloc (maxnrows + 1, sizeof (double)) ;
    Work->Wy = (double *) umf_l_malloc (maxnrows + 1, sizeof (double)) ;
 ...
 Work->Diagonal_map = (long *) 0 ;
 Work->Diagonal_imap = (long *) 0 ;
    }
...
)
{
 ...
 Work->Wx = (double *) umf_l_free ((void *) Work->Wx) ;
 Work->Wy = (double *) umf_l_free ((void *) Work->Wy) ;
