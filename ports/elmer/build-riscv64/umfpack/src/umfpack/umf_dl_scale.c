...
)
{
    ...
    { (s) = ((((pivot) < 0.)) ? -(pivot) : (pivot)) ; } ;

    if (s < 1e-12 || ((pivot) != (pivot)))
    {
...
# 59 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_scale.c"
    ...
    {
# 93 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_scale.c"
     { (pivot) = 1.0 / (pivot) ; } ;
...
# 126 "/home/acer/risc-v-hpc/ports/elmer/umfpack/src/umfpack/umf_scale.c"
    }
}
